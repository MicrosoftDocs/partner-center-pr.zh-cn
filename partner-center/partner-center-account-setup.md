...
|**若要执行此操作**   |**阅读此内容**   |
|-----------------------|:-----------------------|
|确保你公司的档案是最新的   |[更新合作伙伴配置文件](update-your-partner-profile.md)|
|需要在合作伙伴中心协同工作，你公司中的每个人都必须分配角色。 每个角色都具备特定权限和任务。|[创建用户帐户并设置权限](create-user-accounts-and-set-permissions.md)|
