...
若要查看帐单，请转到**仪表板**菜单，然后选择**计费**。 此计费页显示你的计费历史记录和趋势、当前月份（或年份，如果按年计费）的结欠余额、指向发票和对帐文件的链接，以及你的最新付款。
...
<td>计费规则</td>
<td><ul>
<li>每月（或每年，如果按年计费）你将收到一张云解决方案提供商计划的发票。</li>
...
<li>应用信用或调整后，可在下一张每月（或每年）计费发票上看到调整和拖欠的信用。</li>
</ul></td>
</tr>
<tr class="even">
<td>税务</td>
...
<td>频率</td>
<td>
每月或每年可能会进行一次基于许可证的计费。 若要选择一项，请执行以下操作：
<ol>
<li>选择你的客户。</li>
<li>单击“添加订阅”。</li>
<li>在“计费频率”下面选择“每月”或“每年”。 （请注意：进行此项选择后将无法对其进行更改。）</li>
<li>从目录中选择订阅。</li>
</ol>
</ul></td>
</tr>
