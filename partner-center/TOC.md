...
## [获取工作电子邮件地址](buy-email-domain.md)
## 迁移到合作伙伴中心
### [从 PAC 迁移 - 概述](pac-to-pc-overview.md)
### [比较 PAC 和 PC 中的任务](moving-from-pac-to-pc.md)
### [在 PC 中执行 PAC 任务](o365-partner-admin-center-to-partner-center.md)
## 从 PMC 迁移
### [准备从 PMC 迁移](prepare-pmc-pc-migration.md)
### [从 PMC 迁移的指南](guide-to-migration.md)
### [比较 PMC 和 PC](move-pmc-pc-map.md)
### [迁移多个公司](move-multiple-companies.md)
...
## [成为 Azure 专家 MSP](azure-expert-msp.md)
## 优势
...
## 软件保障
### [程序概述](software-assurance-lp.md)
### [培训凭证 (SATV)](software-assurance-satv.md)
### [计划服务 (PS)](software-assurance-dps.md)
#### [资格要求](software-assurance-dps-requirements.md)
## 发票和税款
### [MPN 中的发票和税款](mpn-view-print-maps-invoice.md)
## [试用新功能](test-drive-new-features.md)

# [云解决方案提供商 (CSP)](csp-overview.md)
## [注册参与 CSP 计划](enrolling-in-the-csp-program.md)
## [Microsoft 合作伙伴协议 - CSP](microsoft-partner-agreement.md)
## [CSP 直接合作伙伴要求](direct-partner-new-requirements.md)
## [Microsoft 客户协议（按区域和语言排列）](agreements.md)
## [受限的直接计费访问权限](restricted-direct-bill-capabilities.md)
## [将 CSP 直接计费切换到间接经销商](transition-direct-to-indirect.md)
## [CSP 协议、价目表和产品/服务](csp-documents-and-learning-resources.md)
## [用于 CSP 的 Cloudyn 提供的 Azure 成本管理](azure-cost-management-app-for-csp-partners.md)
## [CSP 区域市场和货币](regional-authorization-overview.md)
...
### [常见问题解答 - Microsoft Cloud for US Government](faq-for-us-govt-cloud.md)
...
### [用于 Dynamics 365 CRM 的联合销售连接器 – 概述](connector-dynamics.md)
...
### [Office 365 合作伙伴咨询：云解决方案提供商计划中的 Microsoft 365 商务语音](o365-partner-advisory.md)
...
### [独立软件供应商的市场专供产品/服务](isv-opt-in.md)
...
## [通过云解决方案提供商计划销售本地软件](csp-on-premise-software.md)
