...
**适当的角色**：
- MPN 关联的全局管理员或 MPN 合作伙伴管理员，以激活你的技术支持权益。
- 任何 MPN 关联的用户帐户，用于在激活后查看访问 ID 和合同 ID。
- 为云产品创建代表客户支持的管理代理。
- 任何帐户 AAD 或 MSA，用于代表客户或贵组织创建本地支持请求。

## <a name="overview"></a>概述

[技术优势](https://partner.microsoft.com/dashboard/mpn/membership/benefits/technical)页显示了以下两个不同的优势的信息：

1. **技术产品支持事件-请参阅下文**
2. 技术售销售和部署服务 (TPD) - [详细信息](technical-benefits.md)

本文适用于需要了解如何激活其技术权益、查看访问 ID 和合同 ID、了解支持哪些产品和版本以及如何开始使用 MPN 合作伙伴权益创建技术支持事件/票证的 Microsoft 合作伙伴网络 (MPN) 成员

### <a name="steps"></a>步骤

1. 激活你的技术权益 (需要全局管理员或 MPN 合作伙伴管理员) 。 激活后，所有 MPN 用户帐户都可以查看访问 ID 和合同 ID，以将权益关联到其帐户

2. 查看技术支持权利和支持的产品，了解你的 MPN 权益是否可用于预期的产品和版本

3. Microsoft 产品支持 (适用于最新的本地产品) ：将支持业务用于本地产品支持

4.  (云产品的签名云支持) ：具有管理代理角色的用户选择 " **客户和服务管理** " 以创建请求。 请参阅以下有关每个步骤的详细信息：
...
技术支持为特定问题、错误消息或未按预期工作的功能提供了故障排除。 MPN 产品支持和签名云支持支持可用于特定的 Microsoft 产品和版本， (不是所有产品和版本都) 支持。
...
你可以使用 **Microsoft 产品支持** 获得最近的本地产品的技术支持。 最近的本地产品仅包括当前产品 (N) 和 (N-1) 的上一个产品版本。 以前的产品版本仅在 [主流支持](/lifecycle/policies/fixed)内受支持;基于 [N-1](https://aka.ms/n-1) 支持策略。 对于不支持的产品和版本，请使用相关付费支持选项或购买合作伙伴支持计划。
...
你只能从支持企业内部部署支持门户获取此信息。 遗憾的是，云门户 (例如，Azure、LCS 和其他) 不显示此信息。

你需要使用对业务的支持，并启动创建本地支持事件的过程。 我们不会创建支持请求，因为我们不会完成此过程。 我们所需的信息将在步骤2中显示。

1. 打开 [对企业的支持](https://support.serviceshub.microsoft.com/supportforbusiness/create) 并选择 windows 10 并输入虚拟信息

2. 如果你的支持合同已经关联到你的帐户，你应该会看到显示 "支持事件"。 对于本地支持，你应该看到显示的合作伙伴支持合同 (除非它不再有效) 包括开始日期、结束日期和剩余事件。

如果需要关联你的支持合同，请展开 "需要购买或添加更多支持计划"，然后选择 " **添加合同** " 按钮以输入你的访问 ID 和合同 id。 展开 " **是否要查看不可用的支持计划？**" 部分以查看合作伙伴签名信息。 仅在以下情况下才会看到 "合作伙伴支持" 显示在此处如果合同已过期、没有剩余的事件或选择了旧的本地产品 (参阅 [aka.ms/n-1](https://aka.ms/n-1) for Support products) 
