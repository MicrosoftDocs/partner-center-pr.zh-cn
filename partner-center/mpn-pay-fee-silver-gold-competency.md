...
如果已满足实现特定银或金牌能力的要求 (或者已经有银或金牌能力) ，可以快速检查该能力的费用。 只需选择 "合作伙伴中心" 中的 " [比较-产品](https://partner.microsoft.com/membership/compare-offers) " 选项卡即可。

否则，请按照以下步骤为银或金牌资格支付费用。 这些步骤假定你满足以下先决条件：

- 你是已 [加入](https://partner.microsoft.com/membership) Microsoft 合作伙伴网络的合作伙伴。
...
3. 在相关字段中输入信用卡详细信息和计费信息，然后选择 " **付费**"。
   ...
   > [!NOTE]
   > 请确保在此页上输入的地址对应信用卡上的地址。 如果法人地址不同于信用卡上的地址，请不要在此信用卡详细信息页上使用您的法律实体地址。 此外，请确保邮政编码正确，并对应于在此页上输入的地址。

收到信用卡信息并完成交易后，将立即激活你的银或金牌资格订阅。

### <a name="use-electronic-bank-transfer-as-your-payment-preference"></a>使用电子银行转帐作为付款首选项

按照以下步骤完成相关的银或金牌资格成员身份的电子银行传输。

1. 如果你选择了 " **电子银行传输** " 作为首选付款方式，你将看到 " **查看购买详细信息** " 页。
...
1. 选择该页面底部的 " **协议** " 链接，并查看 MPN 提供代表你的公司的购买条款和条件。 本协议提供有关计费帐户、续订、退款资格和税款的重要信息。

1. 查看所需的银行转帐详细信息。 

1. 在 " **所选购买** 区域" 中，记下由 Microsoft 支付的金额和特定的货币费用。 你需要从你的银行帐户传输该特定货币中的该金额。
...
1. 在 "详细信息" 页上，找到 " **付款证明** " 字段。 选择 " **浏览** "，找到证明文档并将其上传到合作伙伴中心。
...
付款成功完成后，在48和72小时后，你的购买通常会在到 Microsoft 银行帐户后显示为活动状态。 不过，整个过程可能需要长达 **一周** 的时间才能完成。 

如果你在线路传输参考详细信息中提供了必要的信息 (例如，订单号和 MPN ID) 并将付款证明上载到合作伙伴中心，则可以更快地激活付款。

如果付款流程在订单创建日期30天内未完全完成，则订单的状态将更改为 "已 **过期**"。 如果订单 **过期**，你将需要直接从合作伙伴中心创建新订单，而不必再发送一次付款。 

## <a name="switch-from-electronic-bank-transfer-payment-to-credit-card-payment-method"></a>从电子银行转帐支付转换为信用卡支付方法

稍后，你可能会决定更改与银或金牌资格成员相关的费用支付方法。 例如，你可以决定使用信用卡付款，而不是使用电子银行传输。 或者，您可能已在系统中创建了 unactioned 的电子银行传输订单。
...
5. 选择 " **下一步** " 以完成此产品/服务的购买并获得折扣。

## <a name="next-steps"></a>后续步骤

详细了解 [能力](https://partner.microsoft.com/membership/competencies)、其优点和独特要求