...
## <a name="questions-on-mpa-program-and-policy"></a>有关 MPA 计划和策略的问题

#### <a name="what-are-the-legal-implications-if-the-indirect-reseller-does-not-accept-the-mpa"></a>如果间接经销商不接受 MPA，会有什么法律含义？
 
**答案** 除非 (间接经销商) 接受 MPA，否则，将无法使用 CSP 计划中的间接提供程序 (分发服务器) 。 必须为要在其中执行业务的每个 [CSP 区域](regional-authorization-overview.md) 接受 MPA。 对于间接经销商，每个 CSP 区域至少需要一个 MPA 签名，才能遵从该 CSP 区域中任何间接提供程序执行 CSP 交易。 

#### <a name="is-mpa-available-in-local-languages"></a>MPA 是否以本地语言提供？
 
**答案** 不。 它仅以英语提供。 

#### <a name="my-reseller-believes-they-are-already-enrolled-as-an-indirect-reseller-because-they-have-been-able-to-resell-cloud-subscriptions-through-us-however-they-have-no-option-to-accept-the-mpa-why-is-that"></a>我的分销商认为他们已经注册为间接经销商，因为他们已可以通过我们的身份转售云订阅。 为什么会这样？
...
#### <a name="my-reseller-recently-changed-company-name-but-accepted-the-mpa-already-do-they-need-to-accept-again"></a>我的分销商最近更改了公司名称，但已接受 MPA。 是否需要再次接受？

**答案** 不

#### <a name="do-we-have-to-communicate-with-our-resellers-about-accepting-the-mpa-or-microsoft-will-work-with-resellers-directly-to-accept--mpa"></a>我们是否需要与我们的分销商沟通有关接受 MPA 的信息，或者 Microsoft 是否会直接与经销商合作来接受 MPA？
 
**答案** 作为间接提供商，你有责任清楚地与所有间接经销商进行沟通，并使他们知道不接受 MPA 的影响。 还需要为其提供相应的支持和指导，以接受 MPA。 对于不是由你可以解决的关键问题，你应将其重定向到 Microsoft。

#### <a name="are-there-any-documents-that-describe-how-resellers-can-accept-on-the-mpa-and-confirm-if-the-latest-mpa-was-accepted"></a>是否有任何文档描述分销商如何在 MPA 上接受并确认是否已接受最新的 MPA？ 

**答案** 下面是一些有用的公共链接，可帮助间接经销商接受 MPA 并符合要求。 

1.  [Microsoft 合作伙伴协议 (MPA) CSP](microsoft-partner-agreement.md) (包含迁移 MPN 帐户并在合作伙伴中心接受 MPA 的分步指导) 
2.  [在云解决方案提供商计划中与间接提供商合作](indirect-reseller-tasks-in-partner-center.md)
3.  [管理合作伙伴帐户中的位置](manage-locations.md)

## <a name="questions-about-your-mpn-and-csp-account-structure"></a>有关 MPN 和 CSP 帐户结构的问题
...
#### <a name="my-reseller-says-that-in-partner-center-they-dont-see-an-option-to-accept-the-mpa-how-can-i-best-support-them"></a>我的分销商说，在合作伙伴中心，他们不会看到接受 MPA 的选项。 如何最好地支持它们？

**答案**  如果经销商可以登录到合作伙伴中心，但看不到接受 MPA 的选项：
