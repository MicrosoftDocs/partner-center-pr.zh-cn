<a name="-head"></a><<<<<<< 标头
---
标题：常见计费场景 | 合作伙伴中心 说明：本主题介绍了在添加新订阅、调整订阅中的许可证数或取消订阅后，你应该会在帐单上看到的内容。 基于使用情况和基于许可证的订阅受到的影响有所不同。
ms.assetid：E4BBD3E7-AFE2-4998-950D-0D27D1178160 作者：MaggiePucciEvans 关键字：计费, 付款, 订单, 使用情况, 基于许可证的计费, 周年日期, 免费时段, 期限, 取消, 续订, 价格公式, 对帐文件
---

# <a name="common-billing-scenarios"></a>常见计费场景
...
## <a href="" id="licensebasedmonthly"></a>按月计费场景
...
## <a name="annual-billing-scenarios"></a>按年计费场景
