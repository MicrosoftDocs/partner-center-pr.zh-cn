...
### <a name="maximum-pci-indicator-scores-for-this-competency"></a>此能力的最高 PCI 指示器分数

每个指示器都提供添加到总计的分数。 下面是每个指示器获得的最高分数，以便通过 Cloud Business Applications SMB 选项获得 Silver 或 Gold Small and Midmarket 云解决方案资格：
...
| PCI 指标 | 性能指标：净新收入 | 性能指标：净客户添加 | 功能指示器：职能顾问 | 功能指示器：开发人员 | 客户成功指标：新部署 | 客户成功指标：月度活跃用户增长 |
|---|:---:|:---:|:------:|:---:|:---:|:----:|
| **最大点数** | 10 个点 | 10 个点 | 30 分 | 5 个点 | 20 个点 | 25 分 |
...
如果你具有下列合作伙伴对客户关联之一，则只能为给定客户的这些 PCI 指标收到信用额度：
- 你是云解决方案提供商 (CSP) 属于该客户租户的付费订阅
...
Net customer 添加是 [性能指标](partner-contribution-indicators-small-and-midmarket-cloud-business-option.md#pci-scoring-based-on-six-key-indicators)。 此指标的点按如下方式计算：

- Net customer 添加在尾随12个月内汇总。 

- 总共可以添加10个净客户，其中每个净顾客添加) 可能有10个点的最大收入 (一个点。
...
功能顾问是一种 [功能指示器](partner-contribution-indicators-small-and-midmarket-cloud-business-option.md#pci-scoring-based-on-six-key-indicators)。 此指标的点按如下方式计算：

- 功能顾问指示点基于当月快照，最大可能收益为30点。

- 功能顾问定义为持有当前活动的功能顾问关联认证的个人数量，如客户参与功能顾问认证或财务和运营功能顾问认证。

若要获得最多 **30** 个功能顾问点来达到此资格，合作伙伴必须有 **5** 个顾问，其中包含：
- 客户参与功能顾问认证
- 财务和运营功能顾问认证
- 业务中心功能顾问认证

若要访问五个顾问，合作伙伴可以混合并匹配包含三种认证类型中任意一种的顾问。

若要获得客户参与功能顾问关联认证，个人必须通过以下考试：
  - PL-200<br/>
  **以及** 以下一项考试：
...
- 若要获得此能力选项的最大积分，合作伙伴必须有 **10 个** 生产租户，其中每个租户都超过过去12个月的 **5** 个每月活动用户的阈值。

- 如果租户为，则将租户视为超过每月活动用户阈值：

  - 低于指定阈值 (租户) 12 个月之前的特定数量的生产实例，<br/> *and*
  - 在后续11个月内至少超过此阈值一次。
...
- 合作伙伴在订阅级别关联到租户。 订阅映射到以下合格的产品：
  - Dynamics 365 客户订婚资格产品包括：销售、市场营销、客户服务、现场服务、Project server、计划1、自动化、市场营销、Microsoft 关系销售
  - 金融和运营资格产品包括：业务中心、容量和存储、财务和运营 (包括欺诈保护、运营、零售、HR、计划 2) 、混合现实、团队成员

- 所有与租户中任何付费订阅关联的伙伴都将获得该租户下的所有生产实例的信用额度。 

### <a name="definitions-for-pci-metric-6---monthly-active-user-growth"></a>PCI 指标的定义 #6-每月活动用户增长

每月活动用户增长是 [客户成功指标](partner-contribution-indicators-small-and-midmarket-cloud-business-option.md#pci-scoring-based-on-six-key-indicators)。 此指标的点按如下方式计算：
