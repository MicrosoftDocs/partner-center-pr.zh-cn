...
- **网络的成员身份。** 核心成员身份级别（针对培训、支持和客户联系提供入门级权益）。 你必须是网络成员才能升级你的成员身份。

- **Microsoft Action Pack 订阅的成员身份。** 经济实惠型年度订阅（为中小型合作伙伴公司提供服务）。 包括基本网络成员身份附带的入门级权益，以及所分配的内部使用权限、服务订阅、软件许可证和支持。

- **Microsoft 的能力。** 一个展示公司能力的所获名称。 包括入门级权益、其他内部使用权限、合作伙伴奖励资格以及额外的支持和咨询时数。
...
> [!NOTE]  
> 此链接将转到另一个网站。 返回到此站点要 Action pack 订阅的合作伙伴中心站点。


### <a name="subscribe-to-microsoft-action-pack"></a>订阅 Microsoft Action Pack

1. 上**合作伙伴中心**菜单中，选择**合作关系 > 提供**。 **可用产品/服务**下面列出了 Microsoft Action Pack。 选择**立即订阅**。 

2. 选择**下一步**以同意 Microsoft 合作伙伴网络所授予的内部使用权限的[条款和条件](https://go.microsoft.com/fwlink/?linkid=842232)。  

3. 选择**下一步**以添加付款详细信息。 

4. 选择**开始 ！添加付费**如果你需要输入付款详细信息。 

5. 输入你的付款详细信息，然后选择**下一步**。

6. 查看你的订单详细信息，然后在你准备购买 Action Pack 时选择**确认购买**。 你的信用卡将被立即收费。
...
1. 上**合作伙伴中心**菜单中，选择**合作关系 > 提供**。 **已购买产品/服务**下面列出了 Microsoft Action Pack。
...
6. 选择**开始 ！添加付费**如果你需要输入付款详细信息。 

7. 输入你的付款详细信息，然后选择**下一步**。

8. 查看你的订单详细信息，然后在你准备购买 Action Pack 时选择**确认购买**。 你的信用卡将被立即收费。
