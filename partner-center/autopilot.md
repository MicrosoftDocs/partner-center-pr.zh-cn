...
- [<span data-ttu-id="87409-112">Autopilot 部署参考指南</span><span class="sxs-lookup"><span data-stu-id="87409-112">Autopilot deployment reference guide</span></span>](https://assetsprod.microsoft.com/autopilot-deployment-program-reference-guide-csp.docx)  
