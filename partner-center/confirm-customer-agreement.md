...
可以从[此处](https://aka.ms/customeragreement)手动下载最新版 Microsoft 客户协议模板。 请注意，Microsoft 客户协议特定于国家/地区。 在请求 Microsoft 客户协议模板时，请确保根据客户的位置选择正确的国家/地区。 

## <a name="option-1-confirm-customer-acceptance-using-partner-center-apisdk"></a>选项 1：使用合作伙伴中心 API/SDK 确认客户接受协议
