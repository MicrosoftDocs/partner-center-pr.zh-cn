...
|:----------------|:--------------|:--------------|:--------------|:--------------|:--------------|
|基于许可证和基于使用情况的订阅的定期费用 |[在线服务目录](https://partner.microsoft.com/commerce/preferredoffers/list)中的所有产品。 例如，Office 365、Microsoft 365、Azure Active Directory、Azure（即用即付）、Dynamics 365、PowerBI Pro |创建合作伙伴中心帐户时选择的日期 |计费日期之前的那个月。 |你所在国家/地区的货币。 例如，如果你的公司位于英国，我们将按英国英镑 (GBP) 向你收费。 如果你的公司位于印度，我们将按印度卢比 (INR) 向你收费。  |无 |
...
- **收费服务期间**：费用将与日历月对齐。 例如，如果在10/15 上通过 Azure 计划添加了 Azure 服务，而客户开始使用10/15 上的 Azure 服务，则计费合作伙伴将在11/8 上收到用于服务期 10/15-10/31 的客户消耗的发票/侦测。 要在12/8 上生成的下个月的发票包含服务时间 11/1-11/31 的所有费用。

- **发票付款期**：净60天。

- **发票币种**：合作伙伴将继续按客户的 country's 分配的货币进行计费。 例如，如果在爱尔兰与英国、挪威和德国的客户合作，则计费合作伙伴将收到 GBP、NOK 和 EUR invoice/侦测。
