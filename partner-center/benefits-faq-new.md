...
答：你的公司可以续订合作伙伴中心的资格。 您需要满足能力性能要求，每年验证所需的考试和技能，并在续订时间范围内支付每年费用，以保留资格状态并获得相关权益。
...
## <a name="product-licenses"></a>产品许可证

**问：对于 Microsoft 合作伙伴网络产品许可证的合作伙伴，当前提供了哪些服务？**

答：产品许可证 (也称为内部使用许可或内部使用权利) 包含在获得能力或购买 Microsoft Action Pack 的合作伙伴权益中。 从 [Microsoft 合作伙伴网络收视指南](https://aka.ms/partner-benefits-use-guide)获取产品许可证的最新列表。

**问：是否可以使用单个令牌解锁多个订阅？**

答：不可以，不能将令牌拆分为解锁多个订阅。 必须使用提供的格式的令牌。 例如，不能将25个座位的令牌拆分成5个不同的5个座位标记。

有关其他信息，请查看 Microsoft 合作伙伴计划指南 [aka.ms/partner-benefits-use-guide](https://aka.ms/partner-benefits-use-guide)

**问：** **如果我们在错误的租户上激活了云服务的令牌，或者添加了座位而不是扩展，我们是否可以获取更换令牌？**

答：在激活原始令牌后的30天内，可以一次性颁发云服务激活的替代令牌，并将其用于在现有订阅上错误添加的座位。

有关其他信息，请查看 Microsoft 合作伙伴计划指南 [aka.ms/partner-benefits-use-guide](https://aka.ms/partner-benefits-use-guide)

**问：对于本地软件产品许可证，我们是否需要安装产品密钥？**

答：并非所有产品都需要产品密钥。 Windows server 和客户端操作系统以及所有 Microsoft Office 客户端应用程序都需要产品激活。
...
A. 我们在 Microsoft 合作伙伴网络中包括了合作伙伴的产品许可证，他们获得一个或多个能力，或者购买 Microsoft Action Pack 来帮助他们构建创新的解决方案，并熟悉 Microsoft 产品和技术。 [Microsoft 合作伙伴网络计划指南](https://aka.ms/partner-benefits-use-guide)中介绍了与胜任度和 Action Pack 一起提供的产品许可证的使用条款。

**Q.** **对于我们****的公司如何使用通过胜任度或 Action Pack 提供的产品许可证**，我们是否有任何限制？

A. 是的，存在一些限制。 产品许可使用条款不同于通过 Microsoft 许可计划获得的商业许可证。 有关详细信息，请参阅 [产品许可使用条款](https://www.microsoft.com/licensing)。
产品许可证不包括软件保障，对产品许可证有一些限制。 可以在 [Microsoft 合作伙伴网络计划指南](https://aka.ms/partner-benefits-use-guide)中查看产品许可证的使用条款。

**Q.** **如何将更多的产品许可证添加到合作伙伴中心列出的内容，以便****涵盖公司？**

A. 胜任度和 Action Pack 中包含的产品许可证的使用条款不同于通过 Microsoft 许可计划获得的商业许可证。 建议查看你的选项以满足你公司的 [Microsoft 许可](https://www.microsoft.com/licensing)的许可要求。
