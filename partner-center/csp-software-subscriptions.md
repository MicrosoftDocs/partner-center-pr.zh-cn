...
>[!IMPORTANT]
>取消订单后，将显示一条确认取消的消息。 不过，在取消显示在合作伙伴中心面板上之前，可能会有多达 15 分钟的延迟。 

### <a name="post-cancellation-details"></a>取消后的详细信息
...
1. 从“取消购买”窗口中选择“客户支持请求”链接时，“通过合作伙伴中心报告问题”页随即将打开 。
...
- [使用合作伙伴中心销售商业市场产品的客户订阅](sell-marketplace-products.md)
 
- [将 Azure 订阅分配给合作伙伴中心的客户](assign-azure-subscriptions.md)