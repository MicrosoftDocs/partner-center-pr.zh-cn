...
PCI 为合作伙伴的技术功能提供了一种复杂的视图，它能够提高客户的成功率和实现销售绩效。 为帮助合作伙伴获得银或金牌云 Business Applications 资格，PCI 将衡量你的公司在过去7个关键指标内的前一年性能：
...
如果有特定的合作伙伴与客户之间的关联，某些合作伙伴贡献指标只允许获得给定客户的信用额度。 受这些先决条件影响的指示器或 PCI 指标如下：
...
- 可以为 net customer 添加的最大和部分分数。 下面显示了为给定能力获得最大积分的要求：

  | 对于此通道 | Net customer 添加以获得最多10个分数 |
  |---------------------|----------------------------|
  | Customer Engagement | -10 net customer 为 *开发* 市场) 中的合作伙伴增加 (;</br>-5 net customer 为合作伙伴添加了 (以 *开发* 市场)   |
  | Finance and Operations | -3 net customer 向 *开发* 市场) 中的合作伙伴添加 (;</br>-1 新客户在 *开发* 市场) 为合作伙伴添加 ( |
...
功能顾问的增长是 [功能指示器](partner-contribution-indicators.md#pci-scoring-based-on-seven-key-indicators)。 此指标的点按以下方式为云 Business Applications 胜任度计算：

合作伙伴可以使用以下两个选项之一来实现 (15 或0点) 的全部或无点可用于此指标。 不会对部分内容进行奖励。
...
新的大型部署是 [客户成功指标](partner-contribution-indicators.md#pci-scoring-based-on-seven-key-indicators)。 此指标的点按以下方式为云 Business Applications 胜任度计算：

- 新的大型部署在尾随12个月内汇总，最多可有20个点数。

- 对于客户参与与财务和运营以及在 *开发* 市场与 *开发* 市场进行合作的合作伙伴，新的大型部署定义方式不同：
