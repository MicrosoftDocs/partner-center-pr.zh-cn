...
### <a name="impacted-audience"></a><span data-ttu-id="3491f-110">影响受众</span><span class="sxs-lookup"><span data-stu-id="3491f-110">Impacted audience</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="3491f-128">后续步骤</span><span class="sxs-lookup"><span data-stu-id="3491f-128">Next steps</span></span>
...
- <span data-ttu-id="3491f-138">日期:2020-09-30</span><span class="sxs-lookup"><span data-stu-id="3491f-138">Date: 2020-09-30</span></span>
...
### <a name="questions"></a><span data-ttu-id="3491f-155">是否有任何问题?</span><span class="sxs-lookup"><span data-stu-id="3491f-155">Questions?</span></span>
...
### <a name="summary"></a><span data-ttu-id="3491f-168">总结</span><span class="sxs-lookup"><span data-stu-id="3491f-168">Summary</span></span>
...
- <span data-ttu-id="3491f-196">用户界面增强功能也将支持准确的数据输入并改进 Microsoft 的教育客户验证流程。</span><span class="sxs-lookup"><span data-stu-id="3491f-196">User interface enhancements also will support accurate data entry and improve the Education customer validation process by Microsoft.</span></span> 
...
## <a name="next-steps"></a><span data-ttu-id="3491f-210">后续步骤</span><span class="sxs-lookup"><span data-stu-id="3491f-210">Next steps</span></span>
...
<span data-ttu-id="3491f-222">合作伙伴中心内参与云解决方案提供商 (CSP) 计划的所有合作伙伴。</span><span class="sxs-lookup"><span data-stu-id="3491f-222">All partners transacting through the Cloud Solution Provider (CSP) program on Partner Center.</span></span> 
...
### <a name="next-steps"></a><span data-ttu-id="3491f-245">后续步骤：</span><span class="sxs-lookup"><span data-stu-id="3491f-245">Next Steps:</span></span>
...
<span data-ttu-id="3491f-258">**请注意，按照上述更改，MIOL 将向俄罗斯境内的所有非有形的 Microsoft 产品添加根据适用法律规定的费率收取的增值税。**</span><span class="sxs-lookup"><span data-stu-id="3491f-258">**Please be informed that following the above changes, the VAT at the rate defined by applicable laws will be added by MIOL to all non-tangible Microsoft products in Russia.**</span></span>
...
### <a name="impacted-audience"></a><span data-ttu-id="3491f-272">影响受众</span><span class="sxs-lookup"><span data-stu-id="3491f-272">Impacted audience</span></span>
...
### <a name="details"></a><span data-ttu-id="3491f-299">详细信息</span><span class="sxs-lookup"><span data-stu-id="3491f-299">Details</span></span>
...
### <a name="details"></a><span data-ttu-id="3491f-345">详细信息</span><span class="sxs-lookup"><span data-stu-id="3491f-345">Details</span></span>
...
#### <a name="updated-api"></a><span data-ttu-id="3491f-374">更新的 API</span><span class="sxs-lookup"><span data-stu-id="3491f-374">Updated API</span></span>
...
- [<span data-ttu-id="3491f-390">9 月 22 日上午 8:30（太平洋时间）</span><span class="sxs-lookup"><span data-stu-id="3491f-390">September 22 at 8:30 AM Pacific Time</span></span>](https://teams.microsoft.com/l/meetup-join/19%3ameeting_ODcyODcxYTAtM2M2Mi00NGFkLWIyMDUtNWYwZDc4YjkyOTkz%40thread.v2/0?context=%7b%22Tid%22%3a%2272f988bf-86f1-41af-91ab-2d7cd011db47%22%2c%22Oid%22%3a%227014dada-1df3-405c-93ee-588d8ae65a53%22%2c%22IsBroadcastMeeting%22%3atrue%7d)
...
### <a name="categories"></a><span data-ttu-id="3491f-401">类别</span><span class="sxs-lookup"><span data-stu-id="3491f-401">Categories</span></span>
...
<span data-ttu-id="3491f-414">你将能够向个人和团队提供你的服务，而无需通过集中的 IT 购买流程获取必要的许可证。</span><span class="sxs-lookup"><span data-stu-id="3491f-414">You’ll be able to offer your services to individuals and teams without needing to go through a centralized IT procurement process to obtain required licenses.</span></span> <span data-ttu-id="3491f-415">基于 Microsoft 365 和 Power Platform 集成方案，你的服务可以跨 Project 和 Visio。</span><span class="sxs-lookup"><span data-stu-id="3491f-415">Your services can span Project and Visio, based on integration scenarios with Microsoft 365 and Power Platform.</span></span> <span data-ttu-id="3491f-416">客户还可以在购买前试用 Visio 和 Project 试用版，现提供 [Visio 计划 1 和 Visio 计划 2](https://partner.microsoft.com/resources/collection/visio-availability-announcing-trial-offers#/) 以及 [Project 计划 1](https://www.microsoft.com/microsoft-365/project/compare-microsoft-project-management-software) 试用版。</span><span class="sxs-lookup"><span data-stu-id="3491f-416">Customers can also try before they buy with Visio and Project trials, available now for [Visio Plan 1 and Visio Plan 2](https://partner.microsoft.com/resources/collection/visio-availability-announcing-trial-offers#/), and [Project Plan 1](https://www.microsoft.com/microsoft-365/project/compare-microsoft-project-management-software).</span></span>


### <a name="next-steps"></a><span data-ttu-id="3491f-417">后续步骤</span><span class="sxs-lookup"><span data-stu-id="3491f-417">Next steps</span></span>

- <span data-ttu-id="3491f-418">查看操作准备资源库中的所有准备资源：[客户自助购买功能](https://partner.microsoft.com/resources/collection/customer-self-serve-purchase#/)。</span><span class="sxs-lookup"><span data-stu-id="3491f-418">Review all readiness resources in the Operations Readiness resources gallery: [Customer self-serve purchase capability](https://partner.microsoft.com/resources/collection/customer-self-serve-purchase#/).</span></span> <span data-ttu-id="3491f-419">-通过 Microsoft Inspire 大会的[通过 Microsoft Visio 和 Power Platform 重新构建和重新构思业务](https://www.microsoft.com/microsoft-365/partners/videos/inspire-visio-power-platform)研讨会，详细了解 Visio 和 Power Platform 解决方案为合作伙伴带来的机会。</span><span class="sxs-lookup"><span data-stu-id="3491f-419">-Learn more about partner opportunities with Visio and Power Platform solutions in the Microsoft Inspire session [Rebuild and reimagine business with Microsoft Visio and Power Platform](https://www.microsoft.com/microsoft-365/partners/videos/inspire-visio-power-platform).</span></span>
- <span data-ttu-id="3491f-420">请参阅[自助服务管理指南](/microsoft-365/commerce/subscriptions/manage-self-service-purchases-admins?preserve-view=true&view=o365-worldwide)以了解其他信息。</span><span class="sxs-lookup"><span data-stu-id="3491f-420">Refer to the [self-service admin guide](/microsoft-365/commerce/subscriptions/manage-self-service-purchases-admins?preserve-view=true&view=o365-worldwide) for additional information.</span></span>

________________

## <a name="new-skus-bring-the-power-of-project-cortex-and-more-to-customers"></a><a name="5"></a><span data-ttu-id="3491f-421">新的 SKU 将 Project Cortex 等内容的强大功能带给客户</span><span class="sxs-lookup"><span data-stu-id="3491f-421">New SKUs bring the power of Project Cortex and more to customers</span></span>

### <a name="categories"></a><span data-ttu-id="3491f-422">类别</span><span class="sxs-lookup"><span data-stu-id="3491f-422">Categories</span></span>

- <span data-ttu-id="3491f-423">日期:2020-09-08</span><span class="sxs-lookup"><span data-stu-id="3491f-423">Date: 2020-09-08</span></span>
- <span data-ttu-id="3491f-424">产品/市场</span><span class="sxs-lookup"><span data-stu-id="3491f-424">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="3491f-425">影响受众</span><span class="sxs-lookup"><span data-stu-id="3491f-425">Impacted audience</span></span>

<span data-ttu-id="3491f-426">参与云解决方案提供商 (CSP) 计划的所有合作伙伴</span><span class="sxs-lookup"><span data-stu-id="3491f-426">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="summary"></a><span data-ttu-id="3491f-427">摘要</span><span class="sxs-lookup"><span data-stu-id="3491f-427">Summary</span></span>

<span data-ttu-id="3491f-428">新的 SKU 将自 2020 年 10 月 1 日起可用于交易，它们可帮助客户利用 [Project Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) 和 [Project Turing](https://msturing.org/) 的强大功能。</span><span class="sxs-lookup"><span data-stu-id="3491f-428">New SKUs to help customers harness the power of [Project Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) and [Project Turing](https://msturing.org/) will be available to transact from October 1, 2020.</span></span>

### <a name="details"></a><span data-ttu-id="3491f-429">详细信息</span><span class="sxs-lookup"><span data-stu-id="3491f-429">Details</span></span>

<span data-ttu-id="3491f-430">我们很高兴将于 2020 年 10 月 1 日推出新的 SKU，其中包括 [Project Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/)（智能内容服务）和 Microsoft 搜索（例如用于搜索的 Microsoft Graph 连接器等），它们可帮助用户更高效地查找和管理信息。</span><span class="sxs-lookup"><span data-stu-id="3491f-430">We’re excited to announce the October 1, 2020 availability of new SKUs including [Project Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) (Intelligent Content Services) and Microsoft Search (including Microsoft Graph Connectors for Search) that will enable users to find and manage information more efficiently.</span></span>  

#### <a name="intelligent-content-services"></a><span data-ttu-id="3491f-431">智能内容服务</span><span class="sxs-lookup"><span data-stu-id="3491f-431">Intelligent Content Services</span></span>
  
<span data-ttu-id="3491f-432">智能内容服务使用高级 AI 来实现内容捕获、标记和管理的自动化。</span><span class="sxs-lookup"><span data-stu-id="3491f-432">Intelligent Content Services uses advanced AI to automate the capture, tagging, and management of content.</span></span> <span data-ttu-id="3491f-433">它构建在 SharePoint 的基础之上，用于大容量内容处理、提取元数据进行流程自动化，以及精细的安全性和符合性。</span><span class="sxs-lookup"><span data-stu-id="3491f-433">It builds on SharePoint for high-volume content processing, extracting metadata for process automation, and fine-grained security and compliance.</span></span> <span data-ttu-id="3491f-434">智能内容服务可向你的知识网络推送更准确、更精确的内容，从而改进知识特选和管理体验。</span><span class="sxs-lookup"><span data-stu-id="3491f-434">Intelligent content services improve knowledge curation and discovery experiences by pushing more accurate and precise content into your knowledge network.</span></span> <span data-ttu-id="3491f-435">新的智能内容服务 SKU 将在 10 月 1 日的价格列表（和 9 月 1 日的价格列表预览版）上提供。</span><span class="sxs-lookup"><span data-stu-id="3491f-435">New Intelligent Content Services SKUs will be available on the **October 1 price list** (and on the September 1 price list preview).</span></span> 
 
<span data-ttu-id="3491f-436">**注意：** 智能内容服务是占位符中填写的该产品名称，它可能会在 2020 年 10 月 1 日改名。</span><span class="sxs-lookup"><span data-stu-id="3491f-436">**Note:** Intelligent Content Services is a placeholder name for this product, which is likely to be rebranded after October 1, 2020.</span></span>
 
<span data-ttu-id="3491f-437">**用于 Microsoft 搜索的 Microsoft Graph 连接器**：通过 Microsoft Graph 连接器，客户可将外部存储库中的项目编入索引，从而包含在 Microsoft 搜索结果中。</span><span class="sxs-lookup"><span data-stu-id="3491f-437">**Microsoft Graph connectors for Microsoft Search** Microsoft Graph connectors enable customers to index items in external repositories for inclusion in Microsoft Search results.</span></span> 

<span data-ttu-id="3491f-438">自 2020 年 10 月 1 日起：</span><span class="sxs-lookup"><span data-stu-id="3491f-438">From October 1, 2020:</span></span> 

- <span data-ttu-id="3491f-439">Microsoft 365 E5 和 Office 365 E5 将包含通过用于 Microsoft 搜索的 Microsoft Graph 连接器对项目编制索引（项目数不超过 500）的功能 - A5 中不提供该功能。</span><span class="sxs-lookup"><span data-stu-id="3491f-439">Microsoft 365 E5 and Office 365 E5 will include the ability to index up to 500 items using Microsoft Graph connectors for Microsoft Search (not included with A5).</span></span>  
- <span data-ttu-id="3491f-440">如果用户具有成套许可证或独立许可证，且此类许可证包含 SharePoint 或 OneDrive 计划，那么这些用户将能够看到来自用于 Microsoft 搜索的 Microsoft Graph 连接器的搜索结果。</span><span class="sxs-lookup"><span data-stu-id="3491f-440">Any user with a suite or standalone license that includes a SharePoint or OneDrive plan will be able to see search results from Microsoft Graph connectors for Microsoft Search.</span></span> 
- <span data-ttu-id="3491f-441">新的额外 Graph 连接器容量 SKU 将可用于对另外多达 100 万个项目编制索引。</span><span class="sxs-lookup"><span data-stu-id="3491f-441">A new **Extra Graph Connector Capacity SKU** will be available for indexing up to 1 million additional items.</span></span>  

#### <a name="offer-details"></a><span data-ttu-id="3491f-442">产品/服务详细信息</span><span class="sxs-lookup"><span data-stu-id="3491f-442">Offer details</span></span>

   |<span data-ttu-id="3491f-443">**产品/服务名称**</span><span class="sxs-lookup"><span data-stu-id="3491f-443">**Offer name**</span></span>|<span data-ttu-id="3491f-444">**产品/服务 ID**</span><span class="sxs-lookup"><span data-stu-id="3491f-444">**Offer ID**</span></span>|<span data-ttu-id="3491f-445">**材料 ID**</span><span class="sxs-lookup"><span data-stu-id="3491f-445">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="3491f-446">智能内容服务</span><span class="sxs-lookup"><span data-stu-id="3491f-446">Intelligent Content Services</span></span>|<span data-ttu-id="3491f-447">2e969027-6eca-44a3-88fb-e7923e2c147f</span><span class="sxs-lookup"><span data-stu-id="3491f-447">2e969027-6eca-44a3-88fb-e7923e2c147f</span></span>|<span data-ttu-id="3491f-448">5YI-00004</span><span class="sxs-lookup"><span data-stu-id="3491f-448">5YI-00004</span></span>|
   |<span data-ttu-id="3491f-449">智能内容服务（非营利性组织员工价格）</span><span class="sxs-lookup"><span data-stu-id="3491f-449">Intelligent Content Services (Nonprofit Staff Pricing)</span></span>|<span data-ttu-id="3491f-450">48db24e2-0aac-47bd-bd74-40bde9ff7748</span><span class="sxs-lookup"><span data-stu-id="3491f-450">48db24e2-0aac-47bd-bd74-40bde9ff7748</span></span>|<span data-ttu-id="3491f-451">5YI-00005</span><span class="sxs-lookup"><span data-stu-id="3491f-451">5YI-00005</span></span>|
   |<span data-ttu-id="3491f-452">智能内容服务（教职员工）</span><span class="sxs-lookup"><span data-stu-id="3491f-452">Intelligent Content Services for faculty</span></span>|<span data-ttu-id="3491f-453">4a8f9036-791e-4ce4-a788-6c5af859fd82</span><span class="sxs-lookup"><span data-stu-id="3491f-453">4a8f9036-791e-4ce4-a788-6c5af859fd82</span></span>|<span data-ttu-id="3491f-454">5Z1-00005</span><span class="sxs-lookup"><span data-stu-id="3491f-454">5Z1-00005</span></span>|
   |<span data-ttu-id="3491f-455">额外 Graph 连接器容量</span><span class="sxs-lookup"><span data-stu-id="3491f-455">Extra Graph Connector Capacity</span></span>|<span data-ttu-id="3491f-456">9c8b008f-d84f-46cd-a588-fea84947161d</span><span class="sxs-lookup"><span data-stu-id="3491f-456">9c8b008f-d84f-46cd-a588-fea84947161d</span></span>|<span data-ttu-id="3491f-457">1LA-00002</span><span class="sxs-lookup"><span data-stu-id="3491f-457">1LA-00002</span></span>|
   |<span data-ttu-id="3491f-458">额外 Graph 连接器容量（教职员工）</span><span class="sxs-lookup"><span data-stu-id="3491f-458">Extra Graph Connector Capacity for faculty</span></span>|<span data-ttu-id="3491f-459">0e0eb210-86e7-4038-9905-4fd5bf71c4bd</span><span class="sxs-lookup"><span data-stu-id="3491f-459">0e0eb210-86e7-4038-9905-4fd5bf71c4bd</span></span>|<span data-ttu-id="3491f-460">1TL-00003</span><span class="sxs-lookup"><span data-stu-id="3491f-460">1TL-00003</span></span>|

### <a name="next-steps"></a><span data-ttu-id="3491f-461">后续步骤</span><span class="sxs-lookup"><span data-stu-id="3491f-461">Next steps</span></span>

- <span data-ttu-id="3491f-462">查看本主题的资源，并与组织中相应的利益干系人分享。</span><span class="sxs-lookup"><span data-stu-id="3491f-462">Review the resources for this topic and share them with the appropriate stakeholders in your organization.</span></span>
- <span data-ttu-id="3491f-463">如果对这些产品/服务有任何疑问，请访问相关的 Yammer 社区。</span><span class="sxs-lookup"><span data-stu-id="3491f-463">If you have any questions about these offers, check your relevant Yammer communities.</span></span>

________________

## <a name="enhanced-incentives-support-experience-and-ticket-creation-process"></a><a name="4"></a><span data-ttu-id="3491f-464">增强的激励支持体验和票证创建过程</span><span class="sxs-lookup"><span data-stu-id="3491f-464">Enhanced Incentives support experience and ticket creation process</span></span>

### <a name="categories"></a><span data-ttu-id="3491f-465">类别</span><span class="sxs-lookup"><span data-stu-id="3491f-465">Categories</span></span>

- <span data-ttu-id="3491f-466">日期:2020-09-02</span><span class="sxs-lookup"><span data-stu-id="3491f-466">Date: 2020-09-02</span></span>
- <span data-ttu-id="3491f-467">功能</span><span class="sxs-lookup"><span data-stu-id="3491f-467">Capabilities</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="3491f-468">影响受众</span><span class="sxs-lookup"><span data-stu-id="3491f-468">Impacted audience</span></span>

<span data-ttu-id="3491f-469">所有合作伙伴</span><span class="sxs-lookup"><span data-stu-id="3491f-469">All partners</span></span>

### <a name="summary"></a><span data-ttu-id="3491f-470">总结</span><span class="sxs-lookup"><span data-stu-id="3491f-470">Summary</span></span>

<span data-ttu-id="3491f-471">合作伙伴激励支持体验已经过强化，改进了自助式内容可发现性，还简化了在线票证提交流程。</span><span class="sxs-lookup"><span data-stu-id="3491f-471">The Partner Incentives support experience has been enhanced with improved self-help content discoverability and a streamlined online ticket submission process.</span></span>

### <a name="details"></a><span data-ttu-id="3491f-472">详细信息</span><span class="sxs-lookup"><span data-stu-id="3491f-472">Details</span></span>

<span data-ttu-id="3491f-473">已经对合作伙伴激励计划添加了增强功能，目的是通过更好的自助式内容可发现性和更简单的票证提交流程来改进你的整体支持体验，其中简化的流程减少了支持过程中的往返数据收集次数。</span><span class="sxs-lookup"><span data-stu-id="3491f-473">Enhancements have been added for Partner Incentives to improve your overall support experience through better self-help content discoverability and a streamlined ticket submission process that reduces back-and-forth data collection during the support process.</span></span>

#### <a name="new-capabilities"></a><span data-ttu-id="3491f-474">新功能</span><span class="sxs-lookup"><span data-stu-id="3491f-474">New capabilities</span></span>

- <span data-ttu-id="3491f-475">新的基于搜索的自助式体验可在[合作伙伴中心](https://aka.ms/IncentivesSupport)和 [Microsoft 合作伙伴网络](https://partner.microsoft.com/support/?stage=1)中获取，后者面向的是非合作伙伴中心帐户。</span><span class="sxs-lookup"><span data-stu-id="3491f-475">New search-based self-help experience is accessible within [Partner Center](https://aka.ms/IncentivesSupport) and on [Microsoft Partner Network](https://partner.microsoft.com/support/?stage=1) for non-Partner Center accounts.</span></span> <span data-ttu-id="3491f-476">新体验包含新的疑难解答步骤、常见问题解答和相关自助文章的链接，还包括 Microsoft 合作伙伴网络支持页面上的此类内容。</span><span class="sxs-lookup"><span data-stu-id="3491f-476">The new experience includes new troubleshooting steps, FAQs, and links to relevant self-help articles as well as on the Microsoft Partner Network Support page.</span></span>
- <span data-ttu-id="3491f-477">可直接在合作伙伴中心发起新的支持请求。</span><span class="sxs-lookup"><span data-stu-id="3491f-477">Initiate a new support request directly in Partner Center.</span></span> <span data-ttu-id="3491f-478">查看可用的主题特定帮助后，如果你仍然需要协助，则只能直接通过合作伙伴中心创建票证。</span><span class="sxs-lookup"><span data-stu-id="3491f-478">After viewing the available topic-specific help, if you still need assistance, you can only create a ticket directly from Partner Center.</span></span>
- <span data-ttu-id="3491f-479">向每个自助主题提供了不超过提问范畴的新问题。</span><span class="sxs-lookup"><span data-stu-id="3491f-479">New problem-scoping questions are available for every self-help topic.</span></span> <span data-ttu-id="3491f-480">完成这些问题可预先向专员提供很多重要的详细信息，从而大幅减少在支持票证的起初往返沟通的次数。</span><span class="sxs-lookup"><span data-stu-id="3491f-480">Completing these questions reduces much of the back-and-forth at the beginning of the support ticket by providing the agent with many of the important details up front.</span></span>


### <a name="next-steps"></a><span data-ttu-id="3491f-481">后续步骤</span><span class="sxs-lookup"><span data-stu-id="3491f-481">Next steps</span></span>

- <span data-ttu-id="3491f-482">请与你组织中的其他人共享此信息。</span><span class="sxs-lookup"><span data-stu-id="3491f-482">Share this information with others in your organization.</span></span> 
- <span data-ttu-id="3491f-483">通过[合作伙伴中心](https://aka.ms/IncentivesSupport)或 [Microsoft 合作伙伴网络](https://partner.microsoft.com/support/?stage=1)使用新的支持体验来满足你的所有激励支持要求。</span><span class="sxs-lookup"><span data-stu-id="3491f-483">Use the new support experience via [Partner Center](https://aka.ms/IncentivesSupport) or on [Microsoft Partner Network](https://partner.microsoft.com/support/?stage=1) for all your Incentives support requirements.</span></span> 

<span data-ttu-id="3491f-484">**注意：** 此功能已被停用，因此将不接受直接通过电子邮件发送的支持请求。</span><span class="sxs-lookup"><span data-stu-id="3491f-484">**Note:** Support requests will not be accepted through direct email, as this function is retired.</span></span>

________________

## <a name="upcoming-new-microsoft-dynamics-365-offers"></a><a name="3"></a><span data-ttu-id="3491f-485">即将推出新的 Microsoft Dynamics 365 产品/服务</span><span class="sxs-lookup"><span data-stu-id="3491f-485">Upcoming new Microsoft Dynamics 365 offers</span></span>

### <a name="categories"></a><span data-ttu-id="3491f-486">类别</span><span class="sxs-lookup"><span data-stu-id="3491f-486">Categories</span></span>

- <span data-ttu-id="3491f-487">日期:2020-09-01</span><span class="sxs-lookup"><span data-stu-id="3491f-487">Date: 2020-09-01</span></span>
- <span data-ttu-id="3491f-488">产品/市场</span><span class="sxs-lookup"><span data-stu-id="3491f-488">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="3491f-489">影响受众</span><span class="sxs-lookup"><span data-stu-id="3491f-489">Impacted audience</span></span>

<span data-ttu-id="3491f-490">进行 Microsoft Dynamics 365 交易的合作伙伴</span><span class="sxs-lookup"><span data-stu-id="3491f-490">Partners transacting Microsoft Dynamics 365</span></span>

### <a name="summary"></a><span data-ttu-id="3491f-491">摘要</span><span class="sxs-lookup"><span data-stu-id="3491f-491">Summary</span></span>

<span data-ttu-id="3491f-492">即将推出的适用于 Microsoft Dynamics 365 客户的产品/服务包括 Microsoft Project Operations 发行版和 Business Central 的其他环境。</span><span class="sxs-lookup"><span data-stu-id="3491f-492">Upcoming offers for Microsoft Dynamics 365 customers include the release of Microsoft Project Operations, and additional environments for Business Central.</span></span>

### <a name="details"></a><span data-ttu-id="3491f-493">详细信息</span><span class="sxs-lookup"><span data-stu-id="3491f-493">Details</span></span>

<span data-ttu-id="3491f-494">2020 年 10 月 1 日将提供以下新产品/服务。</span><span class="sxs-lookup"><span data-stu-id="3491f-494">The following new offers will be available on October 1, 2020.</span></span>

#### <a name="project-operations"></a><span data-ttu-id="3491f-495">项目操作</span><span class="sxs-lookup"><span data-stu-id="3491f-495">Project Operations</span></span>

<span data-ttu-id="3491f-496">2020 年 10 月 1 日，Microsoft 将发布 Dynamics 365 Project Operations 产品/服务，并删除云解决方案提供商 (CSP) 计划的 Dynamics 365 Project Service Automation (PSA)。</span><span class="sxs-lookup"><span data-stu-id="3491f-496">On October 1, 2020, Microsoft will release Dynamics 365 Project Operations offers and remove Dynamics 365 Project Service Automation (PSA) for the Cloud Solution Provider (CSP) program.</span></span> <span data-ttu-id="3491f-497">新客户必须购买 Dynamics 365 Project Operations。</span><span class="sxs-lookup"><span data-stu-id="3491f-497">New customers must purchase Dynamics 365 Project Operations.</span></span> 

<span data-ttu-id="3491f-498">对于具有 PSA 的现有 Dynamics 365 客户：</span><span class="sxs-lookup"><span data-stu-id="3491f-498">For existing Dynamics 365 customers with PSA:</span></span>

- <span data-ttu-id="3491f-499">继续使用 Dynamics 365 PSA 至 2020 年 10 月 1 日，或截至最近的合同或续订结束时间（以先发生者为准）。</span><span class="sxs-lookup"><span data-stu-id="3491f-499">Continue to use Dynamics 365 PSA until October 1, 2020, or until the end of their most recent contract or renewal, whichever occurs first.</span></span>
- <span data-ttu-id="3491f-500">Dynamics 365 PSA 将在 CSP 中自动续订一年的时间，直到 2021 年 10 月 1 日，并允许合同持续到 2022 年 10 月 1 日。</span><span class="sxs-lookup"><span data-stu-id="3491f-500">Dynamics 365 PSA will autorenew for one year until October 1, 2021 in CSP, allowing contracts to continue until October 1, 2022.</span></span>
- <span data-ttu-id="3491f-501">Dynamics 365 PSA 许可证会在 2020 年 12 月 31 日之前自动接收 Project Operations 作为其当前许可证的一部分。</span><span class="sxs-lookup"><span data-stu-id="3491f-501">Dynamics 365 PSA licenses will automatically receive Project Operations as part of their current licenses by December 31, 2020.</span></span>
- <span data-ttu-id="3491f-502">在 Dynamics 365 PSA 合同结束时，客户需要转换到 Project Operations，这种方法的用户最小 PSA 转换 SKU 为零。</span><span class="sxs-lookup"><span data-stu-id="3491f-502">At the end of Dynamics 365 PSA contracts, customers need to transition to Project Operations, which will have a zero user minimum PSA transition SKU.</span></span>

<span data-ttu-id="3491f-503">查看 [Dynamics CSP 产品/服务 - 2020 年 10 月 Excel 文档](https://partner.microsoft.com/resources/detail/microsoft-dynamics-365-new-ids-offers-csp-october-2020-xls)中的“Project Operations”选项卡，了解产品/服务 ID 详细信息。</span><span class="sxs-lookup"><span data-stu-id="3491f-503">Review the Project Operations tab in the [Dynamics CSP Offers-October 2020 Excel document](https://partner.microsoft.com/resources/detail/microsoft-dynamics-365-new-ids-offers-csp-october-2020-xls) for the offer ID details.</span></span>

#### <a name="additional-resources"></a><span data-ttu-id="3491f-504">其他资源</span><span class="sxs-lookup"><span data-stu-id="3491f-504">Additional resources</span></span>

- <span data-ttu-id="3491f-505">用于 PSA 的[转换资源](https://partner.microsoft.com/asset/collection/psa-transition-resources#/)</span><span class="sxs-lookup"><span data-stu-id="3491f-505">[Transition resources](https://partner.microsoft.com/asset/collection/psa-transition-resources#/) for PSA</span></span>
- <span data-ttu-id="3491f-506">[Microsoft Dynamics 365 Project Service Automation 简介](https://cloudblogs.microsoft.com/dynamics365/bdm/2020/02/20/introducing-microsoft-dynamics-365-project-operations/)博客</span><span class="sxs-lookup"><span data-stu-id="3491f-506">[Introducing Microsoft Dynamics 365 Project Service Automation](https://cloudblogs.microsoft.com/dynamics365/bdm/2020/02/20/introducing-microsoft-dynamics-365-project-operations/) blog</span></span>
- <span data-ttu-id="3491f-507">[Microsoft Dynamics 365 Project Service Automation 中即将推出的内容](https://assetsprod.microsoft.com/mpn/what-is-coming-in-d365-project-service-automation-dyn767pal.pdf)培训材料</span><span class="sxs-lookup"><span data-stu-id="3491f-507">[What is coming in Microsoft Dynamics 365 Project Service Automation](https://assetsprod.microsoft.com/mpn/what-is-coming-in-d365-project-service-automation-dyn767pal.pdf) training material</span></span>

#### <a name="expansion-of-business-central-offers-into-additional-countries"></a><span data-ttu-id="3491f-508">向其他国家/地区扩展 Business Central 产品/服务</span><span class="sxs-lookup"><span data-stu-id="3491f-508">Expansion of Business Central offers into additional countries</span></span>

<span data-ttu-id="3491f-509">2020 年 10 月 1 日，Microsoft 会将 Business Central 云产品/服务扩展到巴西、爱尔兰、立陶宛、法罗群岛和格陵兰。</span><span class="sxs-lookup"><span data-stu-id="3491f-509">On October 1, 2020, Microsoft is expanding Business Central Cloud offers into Brazil, Ireland, Lithuania, the Faroe Islands, and Greenland.</span></span>

#### <a name="business-central-additional-environments"></a><span data-ttu-id="3491f-510">Business Central 其他环境</span><span class="sxs-lookup"><span data-stu-id="3491f-510">Business Central additional environments</span></span>

<span data-ttu-id="3491f-511">2020 年 10 月 1 日，将为 Business Central 云产品/服务提供新的附加产品/服务，使客户能够添加额外的环境。</span><span class="sxs-lookup"><span data-stu-id="3491f-511">On October 1, 2020, new add-on offers for Business Central Cloud offers will be available to enable customers to add extra environments.</span></span> 

<span data-ttu-id="3491f-512">查看 [Dynamics CSP 产品/服务 - 2020 年 10 月 Excel 文档](https://partner.microsoft.com/resources/detail/microsoft-dynamics-365-new-ids-offers-csp-october-2020-xls)中的“其他环境”选项卡，了解产品/服务 ID 详细信息。</span><span class="sxs-lookup"><span data-stu-id="3491f-512">Review the **Additional Environments** tab in the [Dynamics CSP Offers-October 2020 Excel document](https://partner.microsoft.com/resources/detail/microsoft-dynamics-365-new-ids-offers-csp-october-2020-xls) for the offer ID details.</span></span>

### <a name="next-steps"></a><span data-ttu-id="3491f-513">后续步骤</span><span class="sxs-lookup"><span data-stu-id="3491f-513">Next steps</span></span>

<span data-ttu-id="3491f-514">与组织中的相关联系人共享此更新。</span><span class="sxs-lookup"><span data-stu-id="3491f-514">Share this update with the relevant contacts in your organization.</span></span>

________________

## <a name="office-365-calling-plan-will-be-available-in-new-markets-on-october-1-2020"></a><a name="2"></a><span data-ttu-id="3491f-515">Office 365 通话套餐将于 2020 年 10 月 1 日在新的市场中推出</span><span class="sxs-lookup"><span data-stu-id="3491f-515">Office 365 Calling Plan will be available in new markets on October 1, 2020</span></span>

### <a name="categories"></a><span data-ttu-id="3491f-516">类别</span><span class="sxs-lookup"><span data-stu-id="3491f-516">Categories</span></span>

- <span data-ttu-id="3491f-517">日期:2020-09-01</span><span class="sxs-lookup"><span data-stu-id="3491f-517">Date: 2020-09-01</span></span>
- <span data-ttu-id="3491f-518">产品/市场</span><span class="sxs-lookup"><span data-stu-id="3491f-518">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="3491f-519">影响受众</span><span class="sxs-lookup"><span data-stu-id="3491f-519">Impacted audience</span></span>

<span data-ttu-id="3491f-520">云解决方案提供商 (CSP) 合作伙伴，包括直接提供商、间接提供商和间接经销商</span><span class="sxs-lookup"><span data-stu-id="3491f-520">Cloud Solution Provider (CSP) partners, including direct providers, indirect providers, and indirect resellers</span></span>

### <a name="summary"></a><span data-ttu-id="3491f-521">总结</span><span class="sxs-lookup"><span data-stu-id="3491f-521">Summary</span></span>

<span data-ttu-id="3491f-522">Microsoft 很高兴地宣布，通话套餐将于 2020 年 10 月 1 日在以下新的市场中推出：奥地利、丹麦、意大利、葡萄牙、瑞典和瑞士。</span><span class="sxs-lookup"><span data-stu-id="3491f-522">Microsoft is excited to announce that Calling Plan will be available in the following new markets on October 1, 2020: Austria, Denmark, Italy, Portugal, Sweden, and Switzerland.</span></span> 

### <a name="details"></a><span data-ttu-id="3491f-523">详细信息</span><span class="sxs-lookup"><span data-stu-id="3491f-523">Details</span></span>

<span data-ttu-id="3491f-524">Microsoft 365 通话套餐将于 2020 年 10 月 1 日在以下新的市场中推出：奥地利、丹麦、意大利、葡萄牙、瑞典和瑞士。</span><span class="sxs-lookup"><span data-stu-id="3491f-524">Microsoft 365 Calling Plan will be available in the following new markets on October 1, 2020: Austria, Denmark, Italy, Portugal, Sweden, and Switzerland.</span></span> <span data-ttu-id="3491f-525">新的地区可用性将通过企业协议 (EA) 或企业协议订阅 (EAS)、教育解决方案合约 (EES)、Web Direct 和 CSP 在商业、全球公共部门、非盈利和政府社区云中启动。</span><span class="sxs-lookup"><span data-stu-id="3491f-525">The new geo availability will launch in Commercial, Worldwide Public Sector, Nonprofit, and Government Community Cloud via Enterprise Agreement (EA) or Enterprise Agreement Subscription (EAS), Enrollment for Education Solutions (EES), Web Direct, and CSP.</span></span> 

<span data-ttu-id="3491f-526">所有通话套餐功能都可用于 Microsoft 的国内和国际通话套餐，包括每个用户每月 120、240 和 1,200 分钟 (p/u/m) 国内套餐，以及含 1,200 分钟国内通话 p/u/m 和 600 分钟国际通话 p/u/m 的国际套餐。</span><span class="sxs-lookup"><span data-stu-id="3491f-526">All Calling Plan features will be available for Microsoft’s Domestic and International Calling Plans, including the 120, 240, and 1,200 minutes per user per month (p/u/m) Domestic plans, and the International Plan with 1,200 domestic minutes p/u/m and 600 international minutes p/u/m.</span></span> 

<span data-ttu-id="3491f-527">在[新式工作许可常见问题解答](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements)的“通话套餐”部分，查找通话套餐、超额使用和通信积分的其他详细信息。</span><span class="sxs-lookup"><span data-stu-id="3491f-527">Find additional details for Calling Plans, excessive usage, and communications credits in the Calling Plan section of the [Modern Work Licensing FAQ](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements).</span></span>

<span data-ttu-id="3491f-528">通话套餐当前适用于比利时、加拿大、法国、德国、爱尔兰、荷兰、波多黎各（渠道可用性仅限于 EA 和 EES）、西班牙、英国和美国（澳大利亚和日本的第三方通话套餐可用性）。</span><span class="sxs-lookup"><span data-stu-id="3491f-528">Calling Plan is currently available in Belgium, Canada, France, Germany, Ireland, Netherlands, Puerto Rico (channel availability limited to EA and EES only), Spain, the United Kingdom, and the United States (third-party Calling Plan availability in Australia and Japan).</span></span>

#### <a name="offer-details"></a><span data-ttu-id="3491f-529">产品/服务详细信息</span><span class="sxs-lookup"><span data-stu-id="3491f-529">Offer details</span></span>

   |<span data-ttu-id="3491f-530">**产品/服务名称**</span><span class="sxs-lookup"><span data-stu-id="3491f-530">**Offer name**</span></span>|<span data-ttu-id="3491f-531">**产品/服务 ID**</span><span class="sxs-lookup"><span data-stu-id="3491f-531">**Offer ID**</span></span>|<span data-ttu-id="3491f-532">**材料 ID**</span><span class="sxs-lookup"><span data-stu-id="3491f-532">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="3491f-533">Microsoft 365 国内通话套餐</span><span class="sxs-lookup"><span data-stu-id="3491f-533">Microsoft 365 Domestic Calling Plan</span></span>|<span data-ttu-id="3491f-534">52b01454-aa44-4e03-8049-c4d57496a430</span><span class="sxs-lookup"><span data-stu-id="3491f-534">52b01454-aa44-4e03-8049-c4d57496a430</span></span>|<span data-ttu-id="3491f-535">4ID-00002</span><span class="sxs-lookup"><span data-stu-id="3491f-535">4ID-00002</span></span>|
   |<span data-ttu-id="3491f-536">Microsoft 365 国内通话套餐</span><span class="sxs-lookup"><span data-stu-id="3491f-536">Microsoft 365 Domestic Calling Plan</span></span>|<span data-ttu-id="3491f-537">0f598efe-f330-4d79-b79f-c9480bb7ce3e</span><span class="sxs-lookup"><span data-stu-id="3491f-537">0f598efe-f330-4d79-b79f-c9480bb7ce3e</span></span>|<span data-ttu-id="3491f-538">AAA-13706</span><span class="sxs-lookup"><span data-stu-id="3491f-538">AAA-13706</span></span>|
   |<span data-ttu-id="3491f-539">Microsoft 365 国内通话套餐（政府定价）</span><span class="sxs-lookup"><span data-stu-id="3491f-539">Microsoft 365 Domestic Calling Plan (Government Pricing)</span></span>|<span data-ttu-id="3491f-540">96b96fd8-b77d-41a4-ae5d-0a6652f454b7</span><span class="sxs-lookup"><span data-stu-id="3491f-540">96b96fd8-b77d-41a4-ae5d-0a6652f454b7</span></span>|<span data-ttu-id="3491f-541">AAA-13707</span><span class="sxs-lookup"><span data-stu-id="3491f-541">AAA-13707</span></span>|
   |<span data-ttu-id="3491f-542">面向学生的 Microsoft 365 国内通话套餐</span><span class="sxs-lookup"><span data-stu-id="3491f-542">Microsoft 365 Domestic Calling Plan for students</span></span>|<span data-ttu-id="3491f-543">da2034e1-c147-4aae-afab-9c15acf16ea5</span><span class="sxs-lookup"><span data-stu-id="3491f-543">da2034e1-c147-4aae-afab-9c15acf16ea5</span></span>|<span data-ttu-id="3491f-544">AAA-22335</span><span class="sxs-lookup"><span data-stu-id="3491f-544">AAA-22335</span></span>|
   |<span data-ttu-id="3491f-545">面向教职员工的 Microsoft 365 国内通话套餐</span><span class="sxs-lookup"><span data-stu-id="3491f-545">Microsoft 365 Domestic Calling Plan for faculty</span></span>|<span data-ttu-id="3491f-546">5e8853ed-611c-4f9c-af21-540ba351a636</span><span class="sxs-lookup"><span data-stu-id="3491f-546">5e8853ed-611c-4f9c-af21-540ba351a636</span></span>|<span data-ttu-id="3491f-547">AAA-22334</span><span class="sxs-lookup"><span data-stu-id="3491f-547">AAA-22334</span></span>|
   |<span data-ttu-id="3491f-548">面向 GCC 的 Microsoft 365 国内通话套餐</span><span class="sxs-lookup"><span data-stu-id="3491f-548">Microsoft 365 Domestic Calling Plan for GCC</span></span>|<span data-ttu-id="3491f-549">7099743e-f474-48be-97bc-d4fb22f059bf</span><span class="sxs-lookup"><span data-stu-id="3491f-549">7099743e-f474-48be-97bc-d4fb22f059bf</span></span>|<span data-ttu-id="3491f-550">AAD-25690</span><span class="sxs-lookup"><span data-stu-id="3491f-550">AAD-25690</span></span>|
   |<span data-ttu-id="3491f-551">Microsoft 365 国内和国际通话套餐</span><span class="sxs-lookup"><span data-stu-id="3491f-551">Microsoft 365 Domestic and International Calling Plan</span></span>|<span data-ttu-id="3491f-552">ded34535-507f-4246-8370-f9180318c537</span><span class="sxs-lookup"><span data-stu-id="3491f-552">ded34535-507f-4246-8370-f9180318c537</span></span>|<span data-ttu-id="3491f-553">AAA-13708</span><span class="sxs-lookup"><span data-stu-id="3491f-553">AAA-13708</span></span>|
   |<span data-ttu-id="3491f-554">Microsoft 365 国内和国际通话套餐（政府定价）</span><span class="sxs-lookup"><span data-stu-id="3491f-554">Microsoft 365 Domestic and International Calling Plan (Government Pricing)</span></span>|<span data-ttu-id="3491f-555">d97b23b4-627c-41db-8f55-ce342b0db656</span><span class="sxs-lookup"><span data-stu-id="3491f-555">d97b23b4-627c-41db-8f55-ce342b0db656</span></span>|<span data-ttu-id="3491f-556">AAA-13709</span><span class="sxs-lookup"><span data-stu-id="3491f-556">AAA-13709</span></span>|
   |<span data-ttu-id="3491f-557">面向学生的 Microsoft 365 国内和国际通话套餐</span><span class="sxs-lookup"><span data-stu-id="3491f-557">Microsoft 365 Domestic and International Calling Plan for students</span></span>|<span data-ttu-id="3491f-558">64ed3fb4-9f46-4e8a-b287-7a3662245c37</span><span class="sxs-lookup"><span data-stu-id="3491f-558">64ed3fb4-9f46-4e8a-b287-7a3662245c37</span></span>|<span data-ttu-id="3491f-559">AAA-22337</span><span class="sxs-lookup"><span data-stu-id="3491f-559">AAA-22337</span></span>|
   |<span data-ttu-id="3491f-560">面向教职员工的 Microsoft 365 国内和国际通话套餐</span><span class="sxs-lookup"><span data-stu-id="3491f-560">Microsoft 365 Domestic and International Calling Plan for faculty</span></span>|<span data-ttu-id="3491f-561">492b8a14-381c-4536-bf63-bd5785c14734</span><span class="sxs-lookup"><span data-stu-id="3491f-561">492b8a14-381c-4536-bf63-bd5785c14734</span></span>|<span data-ttu-id="3491f-562">AAA-22336</span><span class="sxs-lookup"><span data-stu-id="3491f-562">AAA-22336</span></span>|
   |<span data-ttu-id="3491f-563">面向 GCC 的 Microsoft 365 国内和国际通话套餐</span><span class="sxs-lookup"><span data-stu-id="3491f-563">Microsoft 365 Domestic and International Calling Plan for GCC</span></span>|<span data-ttu-id="3491f-564">0cf5df85-ecf5-43f5-93b0-04a950e906a3</span><span class="sxs-lookup"><span data-stu-id="3491f-564">0cf5df85-ecf5-43f5-93b0-04a950e906a3</span></span>|<span data-ttu-id="3491f-565">AAD-25680</span><span class="sxs-lookup"><span data-stu-id="3491f-565">AAD-25680</span></span>|
   |<span data-ttu-id="3491f-566">Microsoft 365 国内通话套餐（120 分钟）</span><span class="sxs-lookup"><span data-stu-id="3491f-566">Microsoft 365 Domestic Calling Plan (120 min)</span></span>|<span data-ttu-id="3491f-567">40d28d55-0006-4bb0-8f41-37ac05df5dc7</span><span class="sxs-lookup"><span data-stu-id="3491f-567">40d28d55-0006-4bb0-8f41-37ac05df5dc7</span></span>|<span data-ttu-id="3491f-568">AAD-11639</span><span class="sxs-lookup"><span data-stu-id="3491f-568">AAD-11639</span></span>|
   |<span data-ttu-id="3491f-569">面向学生的 Microsoft 365 国内通话套餐（120 分钟）</span><span class="sxs-lookup"><span data-stu-id="3491f-569">Microsoft 365 Domestic Calling Plan (120 min) for students</span></span>|<span data-ttu-id="3491f-570">353d7f89-2e6f-4deb-9145-80f281a782ab</span><span class="sxs-lookup"><span data-stu-id="3491f-570">353d7f89-2e6f-4deb-9145-80f281a782ab</span></span>|<span data-ttu-id="3491f-571">AAD-11641</span><span class="sxs-lookup"><span data-stu-id="3491f-571">AAD-11641</span></span>|
   |<span data-ttu-id="3491f-572">面向教职员工的 Microsoft 365 国内通话套餐（120 分钟）</span><span class="sxs-lookup"><span data-stu-id="3491f-572">Microsoft 365 Domestic Calling Plan (120 min) for faculty</span></span>|<span data-ttu-id="3491f-573">80fc6c74-cc94-478d-97b0-8455593a5987</span><span class="sxs-lookup"><span data-stu-id="3491f-573">80fc6c74-cc94-478d-97b0-8455593a5987</span></span>|<span data-ttu-id="3491f-574">AAD-11640</span><span class="sxs-lookup"><span data-stu-id="3491f-574">AAD-11640</span></span>|

### <a name="next-steps"></a><span data-ttu-id="3491f-575">后续步骤</span><span class="sxs-lookup"><span data-stu-id="3491f-575">Next steps</span></span>

<span data-ttu-id="3491f-576">查看有关本主题的资源，并与组织内部的相关利益干系人共享此信息。</span><span class="sxs-lookup"><span data-stu-id="3491f-576">Review the resources about this topic, and share this information with the appropriate stakeholders in your organization.</span></span>

________________

## <a name="microsoft-defender-advanced-threat-protection-atp-for-servers-for-education-is-now-available"></a><a name="1"></a><span data-ttu-id="3491f-577">面向教育服务器的 Microsoft Defender 高级威胁防护 (ATP) 现已推出</span><span class="sxs-lookup"><span data-stu-id="3491f-577">Microsoft Defender Advanced Threat Protection (ATP) for Servers for Education is now available</span></span>

### <a name="categories"></a><span data-ttu-id="3491f-578">类别</span><span class="sxs-lookup"><span data-stu-id="3491f-578">Categories</span></span>

- <span data-ttu-id="3491f-579">日期:2020-09-01</span><span class="sxs-lookup"><span data-stu-id="3491f-579">Date: 2020-09-01</span></span>
- <span data-ttu-id="3491f-580">产品/市场</span><span class="sxs-lookup"><span data-stu-id="3491f-580">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="3491f-581">影响受众</span><span class="sxs-lookup"><span data-stu-id="3491f-581">Impacted audience</span></span>

<span data-ttu-id="3491f-582">参与 CSP 计划的所有合作伙伴</span><span class="sxs-lookup"><span data-stu-id="3491f-582">All partners participating in the CSP program</span></span> 

### <a name="details"></a><span data-ttu-id="3491f-583">详细信息</span><span class="sxs-lookup"><span data-stu-id="3491f-583">Details</span></span>

<span data-ttu-id="3491f-584">面向教育服务器的 Microsoft Defender 高级威胁防护 (ATP) 现已于 2020 年 9 月 1 日在云解决方案提供商 (CSP) 计划中推出。</span><span class="sxs-lookup"><span data-stu-id="3491f-584">Microsoft Defender Advanced Threat Protection (ATP) for Servers for Education is now available, as of September 1, 2020 in the Cloud Solution Provider (CSP) program.</span></span>  
<span data-ttu-id="3491f-585">产品/服务详细信息：</span><span class="sxs-lookup"><span data-stu-id="3491f-585">Product Offer Details:</span></span>

- <span data-ttu-id="3491f-586">产品/服务名称：用于教育服务器的 Microsoft Defender ATP</span><span class="sxs-lookup"><span data-stu-id="3491f-586">Offer name: Microsoft Defender ATP for Servers for Education</span></span>
- <span data-ttu-id="3491f-587">产品/服务 ID：c7b9ab7e-8f80-4b4b-8aed-dcad61f2899</span><span class="sxs-lookup"><span data-stu-id="3491f-587">Offer ID: c7b9ab7e-8f80-4b4b-8aed-dcad61f2899</span></span>

### <a name="next-steps"></a><span data-ttu-id="3491f-588">后续步骤</span><span class="sxs-lookup"><span data-stu-id="3491f-588">Next steps</span></span>

- <span data-ttu-id="3491f-589">请与贵组织中的相应联系人共享此信息。</span><span class="sxs-lookup"><span data-stu-id="3491f-589">Share this information with the appropriate contacts in your organization.</span></span>
- <span data-ttu-id="3491f-590">有关产品的详细信息，请阅读 [Microsoft Defender ATP 文档](/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection)。</span><span class="sxs-lookup"><span data-stu-id="3491f-590">Read the [Microsoft Defender ATP documentation](/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection) for more information about the product.</span></span>
