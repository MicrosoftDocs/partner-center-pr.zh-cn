...
________________
## <a name="announcement-of-customer-discount-transparency"></a><a name="4"></a>客户折扣透明度公告
...
作为我们帮助合作伙伴和客户以信任为基础开展业务的承诺的一部分，7 月 7 日，Microsoft 将保留直接向[政府](../faq-for-us-govt-cloud.yml)、[国有实体](https://www.microsoft.com/legal/compliance/anticorruption/criteria)和[教育机构](../sell-to-education-customers.md)客户披露客户折扣信息的权利。 若要了解有关 Microsoft 合作伙伴合同要求的详细信息，包括客户折扣传递和透明度，请查看[此处](https://partner.microsoft.com/training/assets/collection/microsoft-contract-requirements-and-compliance-18552#/)的内容和视频。
