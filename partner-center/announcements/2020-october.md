...
### <a name="impacted-audience"></a><span data-ttu-id="06e2c-110">影响受众</span><span class="sxs-lookup"><span data-stu-id="06e2c-110">Impacted audience</span></span>
...
### <a name="impacted-audience"></a><span data-ttu-id="06e2c-136">影响受众</span><span class="sxs-lookup"><span data-stu-id="06e2c-136">Impacted audience</span></span>
...
- <span data-ttu-id="06e2c-148">通知符合资格的客户并指导他们逐步完成流程。</span><span class="sxs-lookup"><span data-stu-id="06e2c-148">Notify your eligible customers and guide them through the step-by-step process.</span></span>
...
### <a name="categories"></a><span data-ttu-id="06e2c-176">类别</span><span class="sxs-lookup"><span data-stu-id="06e2c-176">Categories</span></span>
...
### <a name="additional-resources"></a><span data-ttu-id="06e2c-193">其他资源</span><span class="sxs-lookup"><span data-stu-id="06e2c-193">Additional resources</span></span>
...
<span data-ttu-id="06e2c-219">1. 新的收入业绩要求</span><span class="sxs-lookup"><span data-stu-id="06e2c-219">1. **New revenue performance requirement**</span></span>
...
### <a name="categories"></a><span data-ttu-id="06e2c-246">类别</span><span class="sxs-lookup"><span data-stu-id="06e2c-246">Categories</span></span>
...
<span data-ttu-id="06e2c-268">应忽略以下 11 月价目表预览版产品/服务 ID 信息。</span><span class="sxs-lookup"><span data-stu-id="06e2c-268">The following November price list preview Offer ID information should be disregarded.</span></span> 
...
### <a name="details"></a><span data-ttu-id="06e2c-286">详细信息</span><span class="sxs-lookup"><span data-stu-id="06e2c-286">Details</span></span>
...
<span data-ttu-id="06e2c-299">直接提供商、间接提供商和间接经销商</span><span class="sxs-lookup"><span data-stu-id="06e2c-299">Direct providers, indirect providers, and indirect resellers</span></span>
...
<span data-ttu-id="06e2c-333">从 2020 年 11 月 1 日到 2021 年 4 月 30 日，含通话套餐的 Microsoft 365 商务语音和不含通话套餐的 Microsoft 365 商务语音的新订阅和续订都将享受折扣定价。</span><span class="sxs-lookup"><span data-stu-id="06e2c-333">From November 1, 2020 through April 30, 2021, new and renewal subscriptions of Microsoft 365 Business Voice with Calling Plan and Microsoft 365 Business Voice without Calling Plan will be subject to discount pricing.</span></span> <span data-ttu-id="06e2c-334">含通话套餐的 Microsoft 365 商务语音将享有 12 个月的 25% 折扣，不含通话套餐的 Microsoft 365 商务语音将享有 12 个月的 33% 折扣。</span><span class="sxs-lookup"><span data-stu-id="06e2c-334">Microsoft 365 Business Voice with Calling Plan will be subject to a 25 percent discount for 12 months, and Microsoft 365 Business Voice without Calling Plan will be subject to a 33 percent discount for 12 months.</span></span>
...
- <span data-ttu-id="06e2c-363">请访问 [Microsoft 365 商务语音合作伙伴页](https://www.microsoft.com/microsoft-365/partners/businessvoice)，详细了解商务语音。</span><span class="sxs-lookup"><span data-stu-id="06e2c-363">Visit the [Microsoft 365 Business Voice Partner Page](https://www.microsoft.com/microsoft-365/partners/businessvoice) to learn more about Business Voice.</span></span> 
...
### <a name="summary"></a><span data-ttu-id="06e2c-376">摘要</span><span class="sxs-lookup"><span data-stu-id="06e2c-376">Summary</span></span> 
...
### <a name="next-steps"></a><span data-ttu-id="06e2c-392">后续步骤</span><span class="sxs-lookup"><span data-stu-id="06e2c-392">Next steps</span></span>
...
#### <a name="offer-details"></a><span data-ttu-id="06e2c-440">产品/服务详细信息</span><span class="sxs-lookup"><span data-stu-id="06e2c-440">Offer details</span></span>
   ...
   |<span data-ttu-id="06e2c-447">Teams 会议室高级版（美国和加拿大）</span><span class="sxs-lookup"><span data-stu-id="06e2c-447">Teams Rooms Premium (USA and CAN)</span></span>|<span data-ttu-id="06e2c-448">03070f91-cc77-4c2e-b269-4a214b3698ab</span><span class="sxs-lookup"><span data-stu-id="06e2c-448">03070f91-cc77-4c2e-b269-4a214b3698ab</span></span>|<span data-ttu-id="06e2c-449">6XB-00008</span><span class="sxs-lookup"><span data-stu-id="06e2c-449">6XB-00008</span></span>|
   |<span data-ttu-id="06e2c-450">Teams 会议室高级版（教职员工）</span><span class="sxs-lookup"><span data-stu-id="06e2c-450">Teams Rooms Premium for faculty</span></span>|<span data-ttu-id="06e2c-451">d0c9a9a9-c9b6-41d7-9148-b60115c36c95</span><span class="sxs-lookup"><span data-stu-id="06e2c-451">d0c9a9a9-c9b6-41d7-9148-b60115c36c95</span></span>|<span data-ttu-id="06e2c-452">6Y5-00005</span><span class="sxs-lookup"><span data-stu-id="06e2c-452">6Y5-00005</span></span>|

<span data-ttu-id="06e2c-453">为了帮助你熟悉新的产品/服务和地理位置的可用性，请访问[常见问题解答(FAQ)](https://partner.microsoft.com/resources/detail/faq-microsoft-teams-rooms-premium-sku-for-microsoft-teams-pdf)。</span><span class="sxs-lookup"><span data-stu-id="06e2c-453">To help you become familiar with the new offer and the geographical availability, visit the [frequently asked questions (FAQ)](https://partner.microsoft.com/resources/detail/faq-microsoft-teams-rooms-premium-sku-for-microsoft-teams-pdf).</span></span>

### <a name="next-steps"></a><span data-ttu-id="06e2c-454">后续步骤</span><span class="sxs-lookup"><span data-stu-id="06e2c-454">Next steps</span></span>

- <span data-ttu-id="06e2c-455">在 [rooms.microsoft.com](https://rooms.microsoft.com/) 上详细了解 Microsoft 会议室及相关产品/服务。</span><span class="sxs-lookup"><span data-stu-id="06e2c-455">Learn more about Microsoft Rooms and related offers at [rooms.microsoft.com](https://rooms.microsoft.com/).</span></span> 
- <span data-ttu-id="06e2c-456">使用 [Teams 合作伙伴指南](https://aka.ms/teamscallingmeetingsguide)开发 Teams 会议室实践，并创建可共同销售的产品/服务。</span><span class="sxs-lookup"><span data-stu-id="06e2c-456">Use the [Teams Partner Guide](https://aka.ms/teamscallingmeetingsguide) to develop your practice with Teams Meeting Rooms, and create a Co-sell Ready offer.</span></span> 
- <span data-ttu-id="06e2c-457">查看 [Microsoft Teams 会议室常见问题解答](https://aka.ms/PartnerMTRFAQ)，了解有关产品解决方案和服务的详细信息。</span><span class="sxs-lookup"><span data-stu-id="06e2c-457">Review the [Microsoft Teams Rooms FAQ](https://aka.ms/PartnerMTRFAQ) for more information about the product solution and services.</span></span> 
- <span data-ttu-id="06e2c-458">与组织中所有适当的联系人共享此信息，并了解追加销售和交叉销售机会。</span><span class="sxs-lookup"><span data-stu-id="06e2c-458">Share this information with all appropriate contacts in your organization and understand the upsell and cross-sell opportunities.</span></span>

### <a name="questions"></a><span data-ttu-id="06e2c-459">是否有任何问题?</span><span class="sxs-lookup"><span data-stu-id="06e2c-459">Questions?</span></span>

<span data-ttu-id="06e2c-460">如果对这些产品/服务有进一步的问题，请访问相关的 Yammer 社区。</span><span class="sxs-lookup"><span data-stu-id="06e2c-460">For further questions about these offers, check your relevant Yammer communities.</span></span>

________________


## <a name="microsoft-calling-plans-are-now-available-in-new-markets"></a><a name="6"></a><span data-ttu-id="06e2c-461">Microsoft 通话套餐现已在新市场中推出</span><span class="sxs-lookup"><span data-stu-id="06e2c-461">Microsoft Calling Plans are now available in new markets</span></span>

### <a name="categories"></a><span data-ttu-id="06e2c-462">类别</span><span class="sxs-lookup"><span data-stu-id="06e2c-462">Categories</span></span>

- <span data-ttu-id="06e2c-463">日期:2020-10-02</span><span class="sxs-lookup"><span data-stu-id="06e2c-463">Date: 2020-10-02</span></span>
- <span data-ttu-id="06e2c-464">产品/市场</span><span class="sxs-lookup"><span data-stu-id="06e2c-464">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="06e2c-465">摘要</span><span class="sxs-lookup"><span data-stu-id="06e2c-465">Summary</span></span>

<span data-ttu-id="06e2c-466">Microsoft 很高兴地宣布， Microsoft 通话套餐将在以下新市场中推出：奥地利、丹麦、意大利、葡萄牙、瑞典和瑞士。</span><span class="sxs-lookup"><span data-stu-id="06e2c-466">Microsoft is excited to announce that Microsoft Calling Plans are now available in the following new markets: Austria, Denmark, Italy, Portugal, Sweden, and Switzerland.</span></span>
 
### <a name="impacted-audience"></a><span data-ttu-id="06e2c-467">影响受众</span><span class="sxs-lookup"><span data-stu-id="06e2c-467">Impacted audience</span></span>

<span data-ttu-id="06e2c-468">云解决方案提供商 (CSP) 直接提供商、间接提供商和间接经销商</span><span class="sxs-lookup"><span data-stu-id="06e2c-468">Cloud Solution Provider (CSP) direct providers, indirect providers, and indirect resellers</span></span>

### <a name="details"></a><span data-ttu-id="06e2c-469">详细信息</span><span class="sxs-lookup"><span data-stu-id="06e2c-469">Details</span></span>

<span data-ttu-id="06e2c-470">Microsoft 很高兴地宣布，从 2020 年 10 月 1 日起，Microsoft 通话套餐将在以下新市场中推出：奥地利、丹麦、意大利、葡萄牙、瑞典和瑞士。</span><span class="sxs-lookup"><span data-stu-id="06e2c-470">Microsoft is excited to announce that, as of October 1, 2020, Microsoft Calling Plans are now available in the following new markets: Austria, Denmark, Italy, Portugal, Sweden, and Switzerland.</span></span> <span data-ttu-id="06e2c-471">新的地区可用性已通过企业协议 (EA) 或企业协议订阅 (EAS)、教育解决方案合约 (EES)、Web Direct 和 CSP 在商业、全球公共部门、非盈利和政府社区云中启动。</span><span class="sxs-lookup"><span data-stu-id="06e2c-471">The new geo availability was launched in Commercial, Worldwide Public Sector, Non-profit, and Government Community Cloud via Enterprise Agreement (EA) or Enterprise Agreement Subscription (EAS), Enrollment for Education Solutions (EES), Web Direct, and CSP.</span></span>

<span data-ttu-id="06e2c-472">所有 Microsoft 通话套餐功能都可用于 Microsoft 的国内和国际通话套餐，包括每个用户每月 120、240 和 1,200 分钟 (p/u/m) 国内套餐，以及含 1,200 分钟国内通话 p/u/m 和 600 分钟国际通话 p/u/m 的国际套餐。</span><span class="sxs-lookup"><span data-stu-id="06e2c-472">All Microsoft Calling Plans features are available for Microsoft's Domestic and International Calling Plans, including the 120, 240, and 1,200 minutes per user per month (p/u/m) Domestic plans, and the International Plan with 1,200 domestic minutes p/u/m and 600 international minutes p/u/m.</span></span>

<span data-ttu-id="06e2c-473">Microsoft 通话套餐之前在以下市场中提供：比利时、加拿大、法国、德国、爱尔兰、荷兰、波多黎各（渠道可用性仅限于 EA 和 EES）、西班牙、英国和美国（澳大利亚和日本的第三方通话套餐可用）。</span><span class="sxs-lookup"><span data-stu-id="06e2c-473">Microsoft Calling Plans were previously made available in the following markets: Belgium, Canada, France, Germany, Ireland, Netherlands, Puerto Rico (with channel availability limited to EA and EES only), Spain, United Kingdom, and United States (with third-party Calling Plan availability in Australia and Japan).</span></span>

#### <a name="offer-details"></a><span data-ttu-id="06e2c-474">产品/服务详细信息</span><span class="sxs-lookup"><span data-stu-id="06e2c-474">Offer details</span></span>

   |<span data-ttu-id="06e2c-475">**产品/服务名称**</span><span class="sxs-lookup"><span data-stu-id="06e2c-475">**Offer name**</span></span>|<span data-ttu-id="06e2c-476">**产品/服务 ID**</span><span class="sxs-lookup"><span data-stu-id="06e2c-476">**Offer ID**</span></span>|<span data-ttu-id="06e2c-477">**材料 ID**</span><span class="sxs-lookup"><span data-stu-id="06e2c-477">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="06e2c-478">Microsoft 365 国内通话套餐</span><span class="sxs-lookup"><span data-stu-id="06e2c-478">Microsoft 365 Domestic Calling Plan</span></span>|<span data-ttu-id="06e2c-479">52b01454-aa44-4e03-8049-c4d57496a430</span><span class="sxs-lookup"><span data-stu-id="06e2c-479">52b01454-aa44-4e03-8049-c4d57496a430</span></span>|<span data-ttu-id="06e2c-480">4ID-00002</span><span class="sxs-lookup"><span data-stu-id="06e2c-480">4ID-00002</span></span>|
   |<span data-ttu-id="06e2c-481">Microsoft 365 国内通话套餐</span><span class="sxs-lookup"><span data-stu-id="06e2c-481">Microsoft 365 Domestic Calling Plan</span></span>|<span data-ttu-id="06e2c-482">0f598efe-f330-4d79-b79f-c9480bb7ce3e</span><span class="sxs-lookup"><span data-stu-id="06e2c-482">0f598efe-f330-4d79-b79f-c9480bb7ce3e</span></span>|<span data-ttu-id="06e2c-483">AAA-13706</span><span class="sxs-lookup"><span data-stu-id="06e2c-483">AAA-13706</span></span>|
   |<span data-ttu-id="06e2c-484">Microsoft 365 国内通话套餐（政府定价）</span><span class="sxs-lookup"><span data-stu-id="06e2c-484">Microsoft 365 Domestic Calling Plan (Government Pricing)</span></span>|<span data-ttu-id="06e2c-485">96b96fd8-b77d-41a4-ae5d-0a6652f454b7</span><span class="sxs-lookup"><span data-stu-id="06e2c-485">96b96fd8-b77d-41a4-ae5d-0a6652f454b7</span></span>|<span data-ttu-id="06e2c-486">AAA-13707</span><span class="sxs-lookup"><span data-stu-id="06e2c-486">AAA-13707</span></span>|
   |<span data-ttu-id="06e2c-487">面向学生的 Microsoft 365 国内通话套餐</span><span class="sxs-lookup"><span data-stu-id="06e2c-487">Microsoft 365 Domestic Calling Plan for students</span></span>|<span data-ttu-id="06e2c-488">da2034e1-c147-4aae-afab-9c15acf16ea5</span><span class="sxs-lookup"><span data-stu-id="06e2c-488">da2034e1-c147-4aae-afab-9c15acf16ea5</span></span>|<span data-ttu-id="06e2c-489">AAA-22335</span><span class="sxs-lookup"><span data-stu-id="06e2c-489">AAA-22335</span></span>|
   |<span data-ttu-id="06e2c-490">面向教职员工的 Microsoft 365 国内通话套餐</span><span class="sxs-lookup"><span data-stu-id="06e2c-490">Microsoft 365 Domestic Calling Plan for faculty</span></span>|<span data-ttu-id="06e2c-491">5e8853ed-611c-4f9c-af21-540ba351a636</span><span class="sxs-lookup"><span data-stu-id="06e2c-491">5e8853ed-611c-4f9c-af21-540ba351a636</span></span>|<span data-ttu-id="06e2c-492">AAA-22334</span><span class="sxs-lookup"><span data-stu-id="06e2c-492">AAA-22334</span></span>|
   |<span data-ttu-id="06e2c-493">面向 GCC 的 Microsoft 365 国内通话套餐</span><span class="sxs-lookup"><span data-stu-id="06e2c-493">Microsoft 365 Domestic Calling Plan for GCC</span></span>|<span data-ttu-id="06e2c-494">7099743e-f474-48be-97bc-d4fb22f059bf</span><span class="sxs-lookup"><span data-stu-id="06e2c-494">7099743e-f474-48be-97bc-d4fb22f059bf</span></span>|<span data-ttu-id="06e2c-495">AAD-25690</span><span class="sxs-lookup"><span data-stu-id="06e2c-495">AAD-25690</span></span>|
   |<span data-ttu-id="06e2c-496">Microsoft 365 国内和国际通话套餐</span><span class="sxs-lookup"><span data-stu-id="06e2c-496">Microsoft 365 Domestic and International Calling Plan</span></span>|<span data-ttu-id="06e2c-497">ded34535-507f-4246-8370-f9180318c537</span><span class="sxs-lookup"><span data-stu-id="06e2c-497">ded34535-507f-4246-8370-f9180318c537</span></span>|<span data-ttu-id="06e2c-498">AAA-13708</span><span class="sxs-lookup"><span data-stu-id="06e2c-498">AAA-13708</span></span>|
   |<span data-ttu-id="06e2c-499">Microsoft 365 国内和国际通话套餐（政府定价）</span><span class="sxs-lookup"><span data-stu-id="06e2c-499">Microsoft 365 Domestic and International Calling Plan (Government Pricing)</span></span>|<span data-ttu-id="06e2c-500">d97b23b4-627c-41db-8f55-ce342b0db656</span><span class="sxs-lookup"><span data-stu-id="06e2c-500">d97b23b4-627c-41db-8f55-ce342b0db656</span></span>|<span data-ttu-id="06e2c-501">AAA-13709</span><span class="sxs-lookup"><span data-stu-id="06e2c-501">AAA-13709</span></span>|
   |<span data-ttu-id="06e2c-502">面向学生的 Microsoft 365 国内和国际通话套餐</span><span class="sxs-lookup"><span data-stu-id="06e2c-502">Microsoft 365 Domestic and International Calling Plan for students</span></span>|<span data-ttu-id="06e2c-503">64ed3fb4-9f46-4e8a-b287-7a3662245c37</span><span class="sxs-lookup"><span data-stu-id="06e2c-503">64ed3fb4-9f46-4e8a-b287-7a3662245c37</span></span>|<span data-ttu-id="06e2c-504">AAA-22337</span><span class="sxs-lookup"><span data-stu-id="06e2c-504">AAA-22337</span></span>|
   |<span data-ttu-id="06e2c-505">面向教职员工的 Microsoft 365 国内和国际通话套餐</span><span class="sxs-lookup"><span data-stu-id="06e2c-505">Microsoft 365 Domestic and International Calling Plan for faculty</span></span>|<span data-ttu-id="06e2c-506">492b8a14-381c-4536-bf63-bd5785c14734</span><span class="sxs-lookup"><span data-stu-id="06e2c-506">492b8a14-381c-4536-bf63-bd5785c14734</span></span>|<span data-ttu-id="06e2c-507">AAA-22336</span><span class="sxs-lookup"><span data-stu-id="06e2c-507">AAA-22336</span></span>|
   |<span data-ttu-id="06e2c-508">面向 GCC 的 Microsoft 365 国内和国际通话套餐</span><span class="sxs-lookup"><span data-stu-id="06e2c-508">Microsoft 365 Domestic and International Calling Plan for GCC</span></span>|<span data-ttu-id="06e2c-509">0cf5df85-ecf5-43f5-93b0-04a950e906a3</span><span class="sxs-lookup"><span data-stu-id="06e2c-509">0cf5df85-ecf5-43f5-93b0-04a950e906a3</span></span>|<span data-ttu-id="06e2c-510">AAD-25680</span><span class="sxs-lookup"><span data-stu-id="06e2c-510">AAD-25680</span></span>|
   |<span data-ttu-id="06e2c-511">Microsoft 365 国内通话套餐（120 分钟）</span><span class="sxs-lookup"><span data-stu-id="06e2c-511">Microsoft 365 Domestic Calling Plan (120 min)</span></span>|<span data-ttu-id="06e2c-512">40d28d55-0006-4bb0-8f41-37ac05df5dc7</span><span class="sxs-lookup"><span data-stu-id="06e2c-512">40d28d55-0006-4bb0-8f41-37ac05df5dc7</span></span>|<span data-ttu-id="06e2c-513">AAD-11639</span><span class="sxs-lookup"><span data-stu-id="06e2c-513">AAD-11639</span></span>|
   |<span data-ttu-id="06e2c-514">面向学生的 Microsoft 365 国内通话套餐（120 分钟）</span><span class="sxs-lookup"><span data-stu-id="06e2c-514">Microsoft 365 Domestic Calling Plan (120 min) for students</span></span>|<span data-ttu-id="06e2c-515">353d7f89-2e6f-4deb-9145-80f281a782ab</span><span class="sxs-lookup"><span data-stu-id="06e2c-515">353d7f89-2e6f-4deb-9145-80f281a782ab</span></span>|<span data-ttu-id="06e2c-516">AAD-11641</span><span class="sxs-lookup"><span data-stu-id="06e2c-516">AAD-11641</span></span>|
   |<span data-ttu-id="06e2c-517">面向教职员工的 Microsoft 365 国内通话套餐（120 分钟）</span><span class="sxs-lookup"><span data-stu-id="06e2c-517">Microsoft 365 Domestic Calling Plan (120 min) for faculty</span></span>|<span data-ttu-id="06e2c-518">80fc6c74-cc94-478d-97b0-8455593a5987</span><span class="sxs-lookup"><span data-stu-id="06e2c-518">80fc6c74-cc94-478d-97b0-8455593a5987</span></span>|<span data-ttu-id="06e2c-519">AAD-11640</span><span class="sxs-lookup"><span data-stu-id="06e2c-519">AAD-11640</span></span>|

### <a name="next-steps"></a><span data-ttu-id="06e2c-520">后续步骤</span><span class="sxs-lookup"><span data-stu-id="06e2c-520">Next Steps</span></span>

- <span data-ttu-id="06e2c-521">如果你所在的市场已于 2020 年 10 月 1 日开始提供通话套餐，请与利益干系人共享此信息</span><span class="sxs-lookup"><span data-stu-id="06e2c-521">If you are in a market where the calling plans are made available on October 1, 2020, share this with your stakeholders</span></span> 
- <span data-ttu-id="06e2c-522">联系这些地域中的客户以讨论 Microsoft 通话套餐。</span><span class="sxs-lookup"><span data-stu-id="06e2c-522">Reach out to your customers in these geos to discuss Microsoft Calling Plans.</span></span> 
- <span data-ttu-id="06e2c-523">提名客户参加 Microsoft Teams 通话研讨会</span><span class="sxs-lookup"><span data-stu-id="06e2c-523">Nominate your customer for a Microsoft Teams Calling Workshop</span></span> 
- <span data-ttu-id="06e2c-524">利用 Microsoft Teams 合作伙伴指南来开发通话实践</span><span class="sxs-lookup"><span data-stu-id="06e2c-524">Leverage the Microsoft Teams Partner Guide to develop your Calling practice</span></span> 
- <span data-ttu-id="06e2c-525">获得 Microsoft Teams 高级专业化通话机会</span><span class="sxs-lookup"><span data-stu-id="06e2c-525">Attain a Calling for Microsoft Teams Advanced Specialization</span></span> 

### <a name="questions"></a><span data-ttu-id="06e2c-526">是否有任何问题?</span><span class="sxs-lookup"><span data-stu-id="06e2c-526">Questions?</span></span>

<span data-ttu-id="06e2c-527">如果对这些产品/服务有任何进一步的问题，请访问相关的 Yammer 社区。</span><span class="sxs-lookup"><span data-stu-id="06e2c-527">For any further questions about these offers, check your relevant Yammer communities.</span></span>

________________

## <a name="promotions-for-microsoft-teams-advanced-communications-are-coming-soon"></a><a name="5"></a><span data-ttu-id="06e2c-528">即将举行 Microsoft Teams 高级通信的促销活动</span><span class="sxs-lookup"><span data-stu-id="06e2c-528">Promotions for Microsoft Teams Advanced Communications are coming soon</span></span>

### <a name="categories"></a><span data-ttu-id="06e2c-529">类别</span><span class="sxs-lookup"><span data-stu-id="06e2c-529">Categories</span></span>

- <span data-ttu-id="06e2c-530">日期:2020-10-02</span><span class="sxs-lookup"><span data-stu-id="06e2c-530">Date: 2020-10-02</span></span>
- <span data-ttu-id="06e2c-531">产品/市场</span><span class="sxs-lookup"><span data-stu-id="06e2c-531">Offers/Markets</span></span>
 
### <a name="summary"></a><span data-ttu-id="06e2c-532">摘要</span><span class="sxs-lookup"><span data-stu-id="06e2c-532">Summary</span></span>

<span data-ttu-id="06e2c-533">2020 年 11 月 1 日，Microsoft Teams 高级通信将提供新的促销定价。</span><span class="sxs-lookup"><span data-stu-id="06e2c-533">On November 1, 2020, new promotional pricing for Microsoft Teams Advanced Communications will be available.</span></span> 

### <a name="impacted-audience"></a><span data-ttu-id="06e2c-534">影响受众</span><span class="sxs-lookup"><span data-stu-id="06e2c-534">Impacted audience</span></span>

<span data-ttu-id="06e2c-535">参与云解决方案提供商 (CSP) 计划的所有合作伙伴。</span><span class="sxs-lookup"><span data-stu-id="06e2c-535">All partners transacting through the Cloud Solution Provider (CSP) program.</span></span>

### <a name="details"></a><span data-ttu-id="06e2c-536">详细信息</span><span class="sxs-lookup"><span data-stu-id="06e2c-536">Details</span></span>

<span data-ttu-id="06e2c-537">Microsoft Teams 的高级通信促销 SKU 将于 2020 年 11 月 1 日起以 35% 的折扣价格提供。</span><span class="sxs-lookup"><span data-stu-id="06e2c-537">The Advanced Communications Promo SKU for Microsoft Teams will be available from November 1, 2020 at a 35 percent discount.</span></span> <span data-ttu-id="06e2c-538">可在 2020 年 11 月 1 日至 2021 年 1 月 31 日期间购买该 SKU。</span><span class="sxs-lookup"><span data-stu-id="06e2c-538">The SKU can be purchased from November 1, 2020 through January 31, 2021.</span></span> 

 
#### <a name="offer-details"></a><span data-ttu-id="06e2c-539">产品/服务详细信息</span><span class="sxs-lookup"><span data-stu-id="06e2c-539">Offer details</span></span>

   |<span data-ttu-id="06e2c-540">**产品/服务名称**</span><span class="sxs-lookup"><span data-stu-id="06e2c-540">**Offer name**</span></span>|<span data-ttu-id="06e2c-541">**产品/服务 ID**</span><span class="sxs-lookup"><span data-stu-id="06e2c-541">**Offer ID**</span></span>|<span data-ttu-id="06e2c-542">**材料 ID**</span><span class="sxs-lookup"><span data-stu-id="06e2c-542">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="06e2c-543">高级通信促销</span><span class="sxs-lookup"><span data-stu-id="06e2c-543">Advanced Communications Promo</span></span>|<span data-ttu-id="06e2c-544">0e89eea4-5cb1-4417-9f5d-886d1ff87940</span><span class="sxs-lookup"><span data-stu-id="06e2c-544">0e89eea4-5cb1-4417-9f5d-886d1ff87940</span></span>|<span data-ttu-id="06e2c-545">1UC-00013</span><span class="sxs-lookup"><span data-stu-id="06e2c-545">1UC-00013</span></span>|

#### <a name="frequently-asked-questions"></a><span data-ttu-id="06e2c-546">常见问题</span><span class="sxs-lookup"><span data-stu-id="06e2c-546">Frequently asked questions</span></span>

<span data-ttu-id="06e2c-547">**什么是高级通信？**</span><span class="sxs-lookup"><span data-stu-id="06e2c-547">**What is Advanced Communication?**</span></span>
<span data-ttu-id="06e2c-548">这是一个新的 Microsoft Teams 附加 SKU，它让客户能够在订阅的任何 Microsoft 365 或 Office 365 套件上进一步增强他们的通信体验。</span><span class="sxs-lookup"><span data-stu-id="06e2c-548">This is a new Microsoft Teams add-on SKU, enabling customers to further enhance their communication experience on top of any Microsoft 365 or Office 365 suite they are subscribed to.</span></span>

<span data-ttu-id="06e2c-549">**在不促销的情况下费用是多少？**</span><span class="sxs-lookup"><span data-stu-id="06e2c-549">**How much does it cost without the promotion?**</span></span>
<span data-ttu-id="06e2c-550">商业预估零售价为每个用户每月 12 美元。</span><span class="sxs-lookup"><span data-stu-id="06e2c-550">The commercial estimated retail price is $12 per user per month.</span></span>

<span data-ttu-id="06e2c-551">**哪些客户可以购买高级通信？**</span><span class="sxs-lookup"><span data-stu-id="06e2c-551">**Which customers can purchase Advanced Communications?**</span></span>
<span data-ttu-id="06e2c-552">商业、全球商业公共部门、教育和非营利组织。</span><span class="sxs-lookup"><span data-stu-id="06e2c-552">Commercial, Worldwide Commercial Public Sector, Education, and Nonprofit.</span></span>

<span data-ttu-id="06e2c-553">**可以通过哪些渠道购买高级通信？**</span><span class="sxs-lookup"><span data-stu-id="06e2c-553">**Through which channels can Advanced Communications be purchased?**</span></span>
<span data-ttu-id="06e2c-554">企业协议 (EA)/企业订阅 (EAS)、教育解决方案合约 (EES)、CSP 或 Web Direct。</span><span class="sxs-lookup"><span data-stu-id="06e2c-554">Enterprise Agreement (EA)/Enterprise Subscription (EAS), Enrollment for Education Solutions (EES), CSP, or Web Direct.</span></span>

<span data-ttu-id="06e2c-555">**哪些客户可以购买高级通信促销 SKU？**</span><span class="sxs-lookup"><span data-stu-id="06e2c-555">**Which customers can purchase the Advanced Communications promo SKU?**</span></span>
<span data-ttu-id="06e2c-556">仅限商业客户。</span><span class="sxs-lookup"><span data-stu-id="06e2c-556">Commercial customers only.</span></span>

<span data-ttu-id="06e2c-557">**如何购买高级通信促销 SKU？**</span><span class="sxs-lookup"><span data-stu-id="06e2c-557">**How can the Advanced Communications promo SKU be purchased?**</span></span>
<span data-ttu-id="06e2c-558">可以通过 EA/EAS 或 CSP 购买促销 SKU。</span><span class="sxs-lookup"><span data-stu-id="06e2c-558">The promo SKU can be purchased through EA/EAS or CSP.</span></span> 

<span data-ttu-id="06e2c-559">**它在何处销售？**</span><span class="sxs-lookup"><span data-stu-id="06e2c-559">**Where can it be sold?**</span></span>
<span data-ttu-id="06e2c-560">它可以在所有当前市场中销售。</span><span class="sxs-lookup"><span data-stu-id="06e2c-560">It can be sold in all current markets.</span></span>

<span data-ttu-id="06e2c-561">**使用高级通信的先决条件有哪些？**</span><span class="sxs-lookup"><span data-stu-id="06e2c-561">**What are the pre-requisites for Advanced Communications?**</span></span>
<span data-ttu-id="06e2c-562">Microsoft Teams 和任何 Microsoft 365/Office 365 套件。</span><span class="sxs-lookup"><span data-stu-id="06e2c-562">Microsoft Teams and any Microsoft 365/Office 365 suite.</span></span>

### <a name="next-steps"></a><span data-ttu-id="06e2c-563">后续步骤</span><span class="sxs-lookup"><span data-stu-id="06e2c-563">Next steps</span></span>

- <span data-ttu-id="06e2c-564">与组织中的相关联系人共享此信息，并了解追加销售和交叉销售机会。</span><span class="sxs-lookup"><span data-stu-id="06e2c-564">Share this information with the relevant contacts in your organization and understand the upsell and cross-sell opportunities.</span></span>
- <span data-ttu-id="06e2c-565">查看 [Teams 合作伙伴指南](https://aka.ms/teamscallingmeetingsguide)的“资源”部分。</span><span class="sxs-lookup"><span data-stu-id="06e2c-565">Review the resources section of the [Teams Partner Guide](https://aka.ms/teamscallingmeetingsguide).</span></span>
- <span data-ttu-id="06e2c-566">可以在 [博客](https://www.microsoft.com/microsoft-365/blog/2020/09/08/3-deals-meeting-calling-experiences-microsoft-teams/) 或 [Office 365 合作伙伴 yammer 组](https://www.yammer.com/office365partners/)中找到有关 Microsoft Teams 促销优惠的其他信息。</span><span class="sxs-lookup"><span data-stu-id="06e2c-566">You can find additional information on Microsoft Teams promotional offers on [the blog](https://www.microsoft.com/microsoft-365/blog/2020/09/08/3-deals-meeting-calling-experiences-microsoft-teams/) or at the [Office 365 partner yammer group](https://www.yammer.com/office365partners/).</span></span>

### <a name="questions"></a><span data-ttu-id="06e2c-567">是否有任何问题?</span><span class="sxs-lookup"><span data-stu-id="06e2c-567">Questions?</span></span>

<span data-ttu-id="06e2c-568">如有关于这些产品/服务的任何疑问，请联系 Microsoft 客户团队中的代表或支持人员。</span><span class="sxs-lookup"><span data-stu-id="06e2c-568">For any questions about these offers, contact your representative in the Microsoft account team or support.</span></span>

________________

## <a name="upcoming-new-offers-and-products-for-dynamics-365"></a><a name="4"></a><span data-ttu-id="06e2c-569">即将推出 Dynamics 365 的新优惠活动和产品</span><span class="sxs-lookup"><span data-stu-id="06e2c-569">Upcoming new offers and products for Dynamics 365</span></span>

### <a name="categories"></a><span data-ttu-id="06e2c-570">类别</span><span class="sxs-lookup"><span data-stu-id="06e2c-570">Categories</span></span>

- <span data-ttu-id="06e2c-571">日期:2020-10-02</span><span class="sxs-lookup"><span data-stu-id="06e2c-571">Date: 2020-10-02</span></span>
- <span data-ttu-id="06e2c-572">产品/市场</span><span class="sxs-lookup"><span data-stu-id="06e2c-572">Offers/Markets</span></span>
 
### <a name="impacted-audience"></a><span data-ttu-id="06e2c-573">影响受众</span><span class="sxs-lookup"><span data-stu-id="06e2c-573">Impacted audience</span></span>

<span data-ttu-id="06e2c-574">云解决方案提供商 (CSP) 合作伙伴</span><span class="sxs-lookup"><span data-stu-id="06e2c-574">Cloud Solution Provider (CSP) partners</span></span>

### <a name="details"></a><span data-ttu-id="06e2c-575">详细信息</span><span class="sxs-lookup"><span data-stu-id="06e2c-575">Details</span></span>

<span data-ttu-id="06e2c-576">2020 年 11 月 1 日，Microsoft 将为 CSP 计划发布以下新的和更新后的 Dynamics 365 和 Power Platform 产品/服务：</span><span class="sxs-lookup"><span data-stu-id="06e2c-576">On November 1, 2020, Microsoft will release the following new and updated Dynamics 365 and Power Platform offers and products for the CSP program:</span></span> 

- <span data-ttu-id="06e2c-577">Dynamics 365 Customer Voice 用户订阅许可证 (USL)</span><span class="sxs-lookup"><span data-stu-id="06e2c-577">Dynamics 365 Customer Voice User Subscription License (USL)</span></span> 
- <span data-ttu-id="06e2c-578">将产品/服务扩展到 CSP</span><span class="sxs-lookup"><span data-stu-id="06e2c-578">Expand offers into CSP</span></span>

### <a name="additional-resources"></a><span data-ttu-id="06e2c-579">其他资源</span><span class="sxs-lookup"><span data-stu-id="06e2c-579">Additional resources</span></span>

- <span data-ttu-id="06e2c-580">查看 [Dynamics CSP 产品/服务 - 2020 年 11 月](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-november-2020-xls) Excel 文档中的“Project Operations”选项卡，了解产品/服务 ID 详细信息。</span><span class="sxs-lookup"><span data-stu-id="06e2c-580">Review the Project Operations tab in the [Dynamics CSP Offers-November 2020](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-november-2020-xls) Excel document for offer ID details.</span></span>
- <span data-ttu-id="06e2c-581">有关详细信息，请访问 [Microsoft Dynamics 365 Customer Voice 主页](https://dynamics.microsoft.com/customer-voice/overview/)。</span><span class="sxs-lookup"><span data-stu-id="06e2c-581">Find more information on the [Microsoft Dynamics 365 Customer Voice Home Page](https://dynamics.microsoft.com/customer-voice/overview/).</span></span>
- <span data-ttu-id="06e2c-582">查看 9 月 [Dynamics 新产品/服务公告](2020-september.md#3)。</span><span class="sxs-lookup"><span data-stu-id="06e2c-582">View the September [Dynamics new offers announcement](2020-september.md#3).</span></span>

________________

## <a name="windows-7-year-2-extended-security-updates-esu-now-available-for-cloud-solution-provider-csp-partners"></a><a name="3"></a><span data-ttu-id="06e2c-583">Windows 7 第 2 年扩展安全更新 (ESU) 现可供云解决方案提供商 (CSP) 合作伙伴使用</span><span class="sxs-lookup"><span data-stu-id="06e2c-583">Windows 7 Year 2 Extended Security Updates (ESU) now available for Cloud Solution Provider (CSP) partners</span></span> 

### <a name="categories"></a><span data-ttu-id="06e2c-584">类别</span><span class="sxs-lookup"><span data-stu-id="06e2c-584">Categories</span></span>

- <span data-ttu-id="06e2c-585">日期:2020-10-01</span><span class="sxs-lookup"><span data-stu-id="06e2c-585">Date: 2020-10-01</span></span>
- <span data-ttu-id="06e2c-586">产品/市场</span><span class="sxs-lookup"><span data-stu-id="06e2c-586">Offers/Markets</span></span>
 
### <a name="impacted-audience"></a><span data-ttu-id="06e2c-587">影响受众</span><span class="sxs-lookup"><span data-stu-id="06e2c-587">Impacted audience</span></span>

<span data-ttu-id="06e2c-588">参与 CSP 计划的所有合作伙伴</span><span class="sxs-lookup"><span data-stu-id="06e2c-588">All partners participating in the CSP program</span></span>

### <a name="details"></a><span data-ttu-id="06e2c-589">详细信息</span><span class="sxs-lookup"><span data-stu-id="06e2c-589">Details</span></span>

<span data-ttu-id="06e2c-590">对 Windows 7 的支持已于 2020 年 1 月 14 日结束。</span><span class="sxs-lookup"><span data-stu-id="06e2c-590">Support for Windows 7 ended on January 14, 2020.</span></span> <span data-ttu-id="06e2c-591">尽管许多客户正在部署 Windows 10，但 Microsoft 明白每个人都处于升级过程中的不同阶段。</span><span class="sxs-lookup"><span data-stu-id="06e2c-591">While many customers are well on their way to deploying Windows 10, Microsoft understands that everyone is at a different point in their upgrade process.</span></span> <span data-ttu-id="06e2c-592">由于 Windows 7 第 1 年 ESU 的有效期将于 2021 年 1 月 12 日结束，客户已经开始进行明年的规划。</span><span class="sxs-lookup"><span data-stu-id="06e2c-592">With the effective period of Windows 7 Year 1 ESU ending on January 12, 2021, we know customers are starting to plan for next year.</span></span>  

<span data-ttu-id="06e2c-593">对于希望在 2021 年继续使用 Windows 7 设备的客户，现已为 CSP 合作伙伴提供 Windows 7 第 2 年的 ESU（结束日期为 2022 年 1 月 12 日），以帮助客户决定是否使用 Windows 10。</span><span class="sxs-lookup"><span data-stu-id="06e2c-593">For customers who expect to continue using Windows 7 devices in 2021, Windows 7 Year 2 ESU (end date January 12, 2022) is available to CSP partners now to help customers with their Windows 10 decision.</span></span> <span data-ttu-id="06e2c-594">有关详细信息，请访问[资源库](https://partner.microsoft.com/resources/collection/windows-esu-csp#/)。</span><span class="sxs-lookup"><span data-stu-id="06e2c-594">Visit the [Resource Gallery](https://partner.microsoft.com/resources/collection/windows-esu-csp#/) for more information.</span></span> 

#### <a name="additional-resources"></a><span data-ttu-id="06e2c-595">其他资源</span><span class="sxs-lookup"><span data-stu-id="06e2c-595">Additional Resources</span></span>

- [<span data-ttu-id="06e2c-596">Windows 7 支持常见问题解答页面</span><span class="sxs-lookup"><span data-stu-id="06e2c-596">Windows 7 Support FAQ page</span></span>](/troubleshoot/windows-client/windows-7-eos-faq/windows-7-end-support-faq)
- [<span data-ttu-id="06e2c-597">Windows 7 支持和 Microsoft 365 应用</span><span class="sxs-lookup"><span data-stu-id="06e2c-597">Windows 7 support and Microsoft 365 Apps</span></span>](/deployoffice/endofsupport/windows-7-support)
- [<span data-ttu-id="06e2c-598">资源库</span><span class="sxs-lookup"><span data-stu-id="06e2c-598">Resource Gallery</span></span>](https://partner.microsoft.com/resources/collection/windows-esu-csp#/)

### <a name="next-steps"></a><span data-ttu-id="06e2c-599">后续步骤</span><span class="sxs-lookup"><span data-stu-id="06e2c-599">Next steps</span></span>

<span data-ttu-id="06e2c-600">查看有关本主题的资源，并与组织内部的相关利益干系人共享此信息。</span><span class="sxs-lookup"><span data-stu-id="06e2c-600">Review the resources about this topic, and share this information with the appropriate stakeholders in your organization.</span></span>  

### <a name="questions"></a><span data-ttu-id="06e2c-601">是否有任何问题?</span><span class="sxs-lookup"><span data-stu-id="06e2c-601">Questions?</span></span>

<span data-ttu-id="06e2c-602">如果对这些产品/服务有任何进一步的问题，请访问相关的 Yammer 社区。</span><span class="sxs-lookup"><span data-stu-id="06e2c-602">For any further questions about these offers, check your relevant Yammer communities.</span></span> 
________________

## <a name="new-skus-bring-the-power-of-project-cortex-and-more-to-customers"></a><a name="2"></a><span data-ttu-id="06e2c-603">新的 SKU 将 Project Cortex 等内容的强大功能带给客户</span><span class="sxs-lookup"><span data-stu-id="06e2c-603">New SKUs bring the power of Project Cortex and more to customers</span></span>

### <a name="categories"></a><span data-ttu-id="06e2c-604">类别</span><span class="sxs-lookup"><span data-stu-id="06e2c-604">Categories</span></span>

- <span data-ttu-id="06e2c-605">日期:2020-10-01</span><span class="sxs-lookup"><span data-stu-id="06e2c-605">Date: 2020-10-01</span></span>
- <span data-ttu-id="06e2c-606">产品/市场</span><span class="sxs-lookup"><span data-stu-id="06e2c-606">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="06e2c-607">摘要</span><span class="sxs-lookup"><span data-stu-id="06e2c-607">Summary</span></span>

<span data-ttu-id="06e2c-608">我们非常高兴地宣布在 2020 年 10 月 1 日提供了新的 SKU，以帮助客户利用 [Project Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) 和 Microsoft 搜索的强大功能。</span><span class="sxs-lookup"><span data-stu-id="06e2c-608">We're excited to announce the October 1, 2020 availability of new SKUs to help customers harness the power of [Project Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) and Microsoft Search.</span></span>
 
### <a name="impacted-audience"></a><span data-ttu-id="06e2c-609">影响受众</span><span class="sxs-lookup"><span data-stu-id="06e2c-609">Impacted audience</span></span>

<span data-ttu-id="06e2c-610">通过云解决方案提供商计划进行交易的合作伙伴</span><span class="sxs-lookup"><span data-stu-id="06e2c-610">Partners transacting through the Cloud Solution Provider program</span></span>

### <a name="details"></a><span data-ttu-id="06e2c-611">详细信息</span><span class="sxs-lookup"><span data-stu-id="06e2c-611">Details</span></span>

<span data-ttu-id="06e2c-612">我们很高兴地宣布在 2020 年 10 月 1日提供了新的 SKU 和价值，以帮助客户充分利用 [Project Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) 和 Microsoft 搜索的强大功能，从而使用户能够更高效地查找和管理信息。</span><span class="sxs-lookup"><span data-stu-id="06e2c-612">We're excited to announce the October 1, 2020 availability of new SKUs and value to help customers harness the power of [Project Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) and Microsoft Search to enable their users to find and manage information more efficiently.</span></span>  

<span data-ttu-id="06e2c-613">**SharePoint Syntex（以前称为智能内容服务）**</span><span class="sxs-lookup"><span data-stu-id="06e2c-613">**SharePoint Syntex (previously Intelligent Content Services)**</span></span>  
<span data-ttu-id="06e2c-614">SharePoint Syntex 使用高级 AI 来实现内容捕获、标记和管理的自动化。</span><span class="sxs-lookup"><span data-stu-id="06e2c-614">SharePoint Syntex uses advanced AI to automate the capture, tagging, and management of content.</span></span> <span data-ttu-id="06e2c-615">它构建在 SharePoint 的基础之上，用于大容量内容处理、提取元数据进行流程自动化，以及精细的安全性和符合性。</span><span class="sxs-lookup"><span data-stu-id="06e2c-615">It builds on SharePoint for high-volume content processing, extracting metadata for process automation, and fine-grained security and compliance.</span></span> <span data-ttu-id="06e2c-616">它通过向你的知识网络提供更多智能内容，提供更好的知识管理和发现体验。</span><span class="sxs-lookup"><span data-stu-id="06e2c-616">It makes knowledge curation and discovery experiences better by providing more intelligent content to your knowledge network.</span></span> 

<span data-ttu-id="06e2c-617">SharePoint Syntex SKU 将在 10 月 1 日的价格列表（在 9 月 1 日的价格列表预览上反映为智能内容服务）上提供。</span><span class="sxs-lookup"><span data-stu-id="06e2c-617">SharePoint Syntex SKUs will be available on the October 1 price lists (the September 1 price list preview reflected Intelligent Content Services).</span></span> <span data-ttu-id="06e2c-618">在 2020 年 11 月 1 日之前，Microsoft 许可条款仍然可能使用其旧名称“智能内容服务”来指代该SKU。</span><span class="sxs-lookup"><span data-stu-id="06e2c-618">Microsoft licensing terms may still refer to this SKU under its old name, Intelligent Content Services, until November 1, 2020.</span></span>

<span data-ttu-id="06e2c-619">**用于 Microsoft 搜索的 Microsoft Graph 连接器**</span><span class="sxs-lookup"><span data-stu-id="06e2c-619">**Microsoft Graph connectors for Microsoft Search**</span></span>  

<span data-ttu-id="06e2c-620">通过 Microsoft Graph 连接器，客户可将外部存储库中的项目编入索引，从而包含在 Microsoft 搜索结果中。</span><span class="sxs-lookup"><span data-stu-id="06e2c-620">With Microsoft Graph connectors, customers can index items in external repositories for inclusion in Microsoft Search results.</span></span> <span data-ttu-id="06e2c-621">从 2020 年 10 月 1 日起：</span><span class="sxs-lookup"><span data-stu-id="06e2c-621">Beginning October 1, 2020:</span></span>

- <span data-ttu-id="06e2c-622">Microsoft 365 E5 和 Office 365 E5 将包含通过用于 Microsoft 搜索的 Microsoft Graph 连接器对项目编制索引（项目数不超过 500）的功能 - A5 中不提供该功能。</span><span class="sxs-lookup"><span data-stu-id="06e2c-622">Microsoft 365 E5 and Office 365 E5 will include the ability to index up to 500 items using Microsoft Graph connectors for Microsoft Search (not included with A5).</span></span>  
- <span data-ttu-id="06e2c-623">如果用户具有成套许可证或独立许可证，且此类许可证包含 SharePoint 或 OneDrive 计划，那么这些用户将能够看到来自用于 Microsoft 搜索的 Microsoft Graph 连接器的搜索结果。</span><span class="sxs-lookup"><span data-stu-id="06e2c-623">Any user with a suite or standalone license that includes a SharePoint or OneDrive plan will be able to see search results from Microsoft Graph connectors for Microsoft Search.</span></span> 
- <span data-ttu-id="06e2c-624">新的额外 Graph 连接器容量 SKU 将可用于对另外多达 100 万个项目编制索引。</span><span class="sxs-lookup"><span data-stu-id="06e2c-624">A new **Extra Graph Connector Capacity SKU** will be available for indexing up to 1 million additional items.</span></span>

#### <a name="offer-details"></a><span data-ttu-id="06e2c-625">产品/服务详细信息</span><span class="sxs-lookup"><span data-stu-id="06e2c-625">Offer details</span></span>

   |<span data-ttu-id="06e2c-626">**产品/服务名称**</span><span class="sxs-lookup"><span data-stu-id="06e2c-626">**Offer name**</span></span>|<span data-ttu-id="06e2c-627">**产品/服务 ID**</span><span class="sxs-lookup"><span data-stu-id="06e2c-627">**Offer ID**</span></span>|<span data-ttu-id="06e2c-628">**材料 ID**</span><span class="sxs-lookup"><span data-stu-id="06e2c-628">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="06e2c-629">SharePoint Syntex</span><span class="sxs-lookup"><span data-stu-id="06e2c-629">SharePoint Syntex</span></span>|<span data-ttu-id="06e2c-630">2e969027-6eca-44a3-88fb-e7923e2c147f</span><span class="sxs-lookup"><span data-stu-id="06e2c-630">2e969027-6eca-44a3-88fb-e7923e2c147f</span></span>|<span data-ttu-id="06e2c-631">5YI-00004</span><span class="sxs-lookup"><span data-stu-id="06e2c-631">5YI-00004</span></span>|
   |<span data-ttu-id="06e2c-632">SharePoint Syntex（非营利人员定价）</span><span class="sxs-lookup"><span data-stu-id="06e2c-632">SharePoint Syntex (Nonprofit Staff Pricing)</span></span>|<span data-ttu-id="06e2c-633">48db24e2-0aac-47bd-bd74-40bde9ff7748</span><span class="sxs-lookup"><span data-stu-id="06e2c-633">48db24e2-0aac-47bd-bd74-40bde9ff7748</span></span>|<span data-ttu-id="06e2c-634">5YI-00005</span><span class="sxs-lookup"><span data-stu-id="06e2c-634">5YI-00005</span></span>|
   |<span data-ttu-id="06e2c-635">SharePoint Syntex（教职员工）</span><span class="sxs-lookup"><span data-stu-id="06e2c-635">SharePoint Syntex for faculty</span></span>|<span data-ttu-id="06e2c-636">4a8f9036-791e-4ce4-a788-6c5af859fd82</span><span class="sxs-lookup"><span data-stu-id="06e2c-636">4a8f9036-791e-4ce4-a788-6c5af859fd82</span></span>|<span data-ttu-id="06e2c-637">5Z1-00005</span><span class="sxs-lookup"><span data-stu-id="06e2c-637">5Z1-00005</span></span>|
   |<span data-ttu-id="06e2c-638">额外 Graph 连接器容量</span><span class="sxs-lookup"><span data-stu-id="06e2c-638">Extra Graph Connector Capacity</span></span>|<span data-ttu-id="06e2c-639">9c8b008f-d84f-46cd-a588-fea84947161d</span><span class="sxs-lookup"><span data-stu-id="06e2c-639">9c8b008f-d84f-46cd-a588-fea84947161d</span></span>|<span data-ttu-id="06e2c-640">1LA-00002</span><span class="sxs-lookup"><span data-stu-id="06e2c-640">1LA-00002</span></span>|
   |<span data-ttu-id="06e2c-641">额外 Graph 连接器容量（教职员工）</span><span class="sxs-lookup"><span data-stu-id="06e2c-641">Extra Graph Connector Capacity for faculty</span></span>|<span data-ttu-id="06e2c-642">0e0eb210-86e7-4038-9905-4fd5bf71c4bd</span><span class="sxs-lookup"><span data-stu-id="06e2c-642">0e0eb210-86e7-4038-9905-4fd5bf71c4bd</span></span>|<span data-ttu-id="06e2c-643">1TL-00003</span><span class="sxs-lookup"><span data-stu-id="06e2c-643">1TL-00003</span></span>|

### <a name="next-steps"></a><span data-ttu-id="06e2c-644">后续步骤</span><span class="sxs-lookup"><span data-stu-id="06e2c-644">Next steps</span></span>

<span data-ttu-id="06e2c-645">查看有关本主题的资源，并与组织中相应的利益干系人共享。</span><span class="sxs-lookup"><span data-stu-id="06e2c-645">Review the resources about this topic, and share with the appropriate stakeholders in your organization.</span></span>

### <a name="questions"></a><span data-ttu-id="06e2c-646">问题</span><span class="sxs-lookup"><span data-stu-id="06e2c-646">Questions</span></span>

<span data-ttu-id="06e2c-647">如果对这些产品/服务有进一步的问题，请访问相关的 Yammer 社区。</span><span class="sxs-lookup"><span data-stu-id="06e2c-647">For further questions about these offers, check your relevant Yammer communities.</span></span> 
________________

## <a name="fiscal-year-2021-fy21-cloud-solution-provider-csp-incentive-program-announcement"></a><span data-ttu-id="06e2c-648"><a name="1">2021 财年 (FY21) 云解决方案提供商 (CSP) 奖励计划公告</a></span><span class="sxs-lookup"><span data-stu-id="06e2c-648"><a name="1"></a>Fiscal year 2021 (FY21) Cloud Solution Provider (CSP) incentive program announcement</span></span>

### <a name="categories"></a><span data-ttu-id="06e2c-649">类别</span><span class="sxs-lookup"><span data-stu-id="06e2c-649">Categories</span></span>

- <span data-ttu-id="06e2c-650">日期:2020-10-01</span><span class="sxs-lookup"><span data-stu-id="06e2c-650">Date: 2020-10-01</span></span>
- <span data-ttu-id="06e2c-651">功能</span><span class="sxs-lookup"><span data-stu-id="06e2c-651">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="06e2c-652">摘要</span><span class="sxs-lookup"><span data-stu-id="06e2c-652">Summary</span></span>

<span data-ttu-id="06e2c-653">2021 财年 CSP 奖励计划将于 2020 年 10 月 1 日开始。</span><span class="sxs-lookup"><span data-stu-id="06e2c-653">The FY21 CSP incentive program term begins October 1, 2020.</span></span> <span data-ttu-id="06e2c-654">合作伙伴中心内现已提供 2021 财年奖励指南和流程幻灯片组。</span><span class="sxs-lookup"><span data-stu-id="06e2c-654">The FY21 incentive guides and walking decks are now available on Partner Center.</span></span>
 
### <a name="impacted-audience"></a><span data-ttu-id="06e2c-655">影响受众</span><span class="sxs-lookup"><span data-stu-id="06e2c-655">Impacted audience</span></span>

<span data-ttu-id="06e2c-656">CSP 直接支付合作伙伴、间接提供商和间接经销商</span><span class="sxs-lookup"><span data-stu-id="06e2c-656">CSP direct bill partners, indirect providers, and indirect resellers</span></span>

### <a name="details"></a><span data-ttu-id="06e2c-657">详细信息</span><span class="sxs-lookup"><span data-stu-id="06e2c-657">Details</span></span>

<span data-ttu-id="06e2c-658">2020 财年 CSP 奖励计划的期限已于 2020 年 9 月 30 日结束。</span><span class="sxs-lookup"><span data-stu-id="06e2c-658">The FY20 CSP incentive program term ended September 30, 2020.</span></span> <span data-ttu-id="06e2c-659">2021 财年 CSP 奖励计划的期限将于 2020 年 10 月 1 日开始，直到 2021 年9 月30 日结束。</span><span class="sxs-lookup"><span data-stu-id="06e2c-659">The FY21 CSP incentive program term begins October 1, 2020, and runs through September 30, 2021.</span></span> <span data-ttu-id="06e2c-660">现已在[合作伙伴网站](https://aka.ms/partnerincentives/)上的相关 CSP 奖励计划资产集合中发布了 2021 财年奖励计划指南、概述幻灯片和流程幻灯片组。</span><span class="sxs-lookup"><span data-stu-id="06e2c-660">The FY21 incentive program guides, overview slides, and walking decks are now posted on the relevant CSP incentive program asset collections on the [partner website](https://aka.ms/partnerincentives/).</span></span> <span data-ttu-id="06e2c-661">我们鼓励合作伙伴下载并查看 2021 财年计划资产。</span><span class="sxs-lookup"><span data-stu-id="06e2c-661">We encourage partners to download and review the FY21 program assets.</span></span>

<span data-ttu-id="06e2c-662">更新后的 2021 财年计划费率将从 2020 年 10 月 1 日起生效。</span><span class="sxs-lookup"><span data-stu-id="06e2c-662">The updated FY21 program rates will be effective from October 1, 2020.</span></span> <span data-ttu-id="06e2c-663">自 2020 年 12 月 15 日的支付周期开始，合作伙伴将注意到每月奖励金发生的相应变化。</span><span class="sxs-lookup"><span data-stu-id="06e2c-663">Partners will notice corresponding changes to their monthly incentive payments beginning with the December 15, 2020, payment cycle.</span></span>

### <a name="next-steps"></a><span data-ttu-id="06e2c-664">后续步骤</span><span class="sxs-lookup"><span data-stu-id="06e2c-664">Next steps</span></span>

- <span data-ttu-id="06e2c-665">查看 2021 财年计划资产，并准备对选定产品和客户行动的奖励费率进行更新。</span><span class="sxs-lookup"><span data-stu-id="06e2c-665">Review the FY21 program assets, and prepare for updates to incentive rates on select products and customer motions.</span></span>

### <a name="questions"></a><span data-ttu-id="06e2c-666">是否有任何问题?</span><span class="sxs-lookup"><span data-stu-id="06e2c-666">Questions?</span></span>

<span data-ttu-id="06e2c-667">可以通过在合作伙伴中心的搜索栏中搜索“奖励”来查看推荐的步骤和自助文章。</span><span class="sxs-lookup"><span data-stu-id="06e2c-667">Recommended steps and self-help articles for incentive-related questions are available by searching **Incentives** in the search bar of Partner Center.</span></span> 
________________
