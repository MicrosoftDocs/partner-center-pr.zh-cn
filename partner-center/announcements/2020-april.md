...
### <a name="summary"></a><span data-ttu-id="d2b75-112">摘要</span><span class="sxs-lookup"><span data-stu-id="d2b75-112">Summary</span></span>
...
<span data-ttu-id="d2b75-128">新客户的定义</span><span class="sxs-lookup"><span data-stu-id="d2b75-128">Definition of New customers</span></span>
...
### <a name="categories"></a><span data-ttu-id="d2b75-140">类别</span><span class="sxs-lookup"><span data-stu-id="d2b75-140">Categories</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="d2b75-157">后续步骤</span><span class="sxs-lookup"><span data-stu-id="d2b75-157">Next steps</span></span>
...
<span data-ttu-id="d2b75-170">通过云解决方案提供商计划中的欧元价目表交易 M365 E3 的所有合作伙伴。</span><span class="sxs-lookup"><span data-stu-id="d2b75-170">All partners transacting M365 E3 through the EUR price list in the Cloud Solution Provider program.</span></span>
...
### <a name="categories"></a><span data-ttu-id="d2b75-184">类别</span><span class="sxs-lookup"><span data-stu-id="d2b75-184">Categories</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="d2b75-201">后续步骤</span><span class="sxs-lookup"><span data-stu-id="d2b75-201">Next steps</span></span>
...
### <a name="summary"></a><span data-ttu-id="d2b75-230">摘要</span><span class="sxs-lookup"><span data-stu-id="d2b75-230">Summary</span></span>
...
### <a name="additional-resources"></a><span data-ttu-id="d2b75-249">其他资源</span><span class="sxs-lookup"><span data-stu-id="d2b75-249">Additional resources</span></span>
...
<span data-ttu-id="d2b75-273">适用于服务器的 MDATP 350158a2-f253-4ea3-988e-eef9d1b828cf</span><span class="sxs-lookup"><span data-stu-id="d2b75-273">MDATP for Servers 350158a2-f253-4ea3-988e-eef9d1b828cf</span></span>
...
### <a name="categories"></a><span data-ttu-id="d2b75-287">类别</span><span class="sxs-lookup"><span data-stu-id="d2b75-287">Categories</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="d2b75-309">后续步骤</span><span class="sxs-lookup"><span data-stu-id="d2b75-309">Next steps</span></span>
...
<span data-ttu-id="d2b75-323">全球参与云解决方案提供商计划的所有合作伙伴。</span><span class="sxs-lookup"><span data-stu-id="d2b75-323">All partners transacting through the Cloud Solution Provider worldwide.</span></span>
...
<span data-ttu-id="d2b75-350">通过云解决方案提供商 (CSP) 计划使用教育产品/服务的所有合作伙伴。</span><span class="sxs-lookup"><span data-stu-id="d2b75-350">All partners transacting Education offers through the Cloud Solution Provider (CSP) program.</span></span>
...
<span data-ttu-id="d2b75-369">请参阅价目表中的以下产品/服务 ID：</span><span class="sxs-lookup"><span data-stu-id="d2b75-369">Please refer to the following offer IDs in the price list:</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="d2b75-389">后续步骤</span><span class="sxs-lookup"><span data-stu-id="d2b75-389">Next steps</span></span>
...
<span data-ttu-id="d2b75-402">参与云解决方案提供商 (CSP) 计划的所有合作伙伴。</span><span class="sxs-lookup"><span data-stu-id="d2b75-402">All partners transacting in the Cloud Solution Provider (CSP) program.</span></span>
...
<span data-ttu-id="d2b75-433">影响受众</span><span class="sxs-lookup"><span data-stu-id="d2b75-433">Impacted audience</span></span>

<span data-ttu-id="d2b75-434">通过云解决方案提供商 (CSP) 计划提供 Dynamics 365 的合作伙伴。</span><span class="sxs-lookup"><span data-stu-id="d2b75-434">Partners offering Dynamics 365 through the Cloud Solution Provider (CSP) program.</span></span> <span data-ttu-id="d2b75-435">这些更新将在全球各地发布（除非另行通知）。</span><span class="sxs-lookup"><span data-stu-id="d2b75-435">These updates relate to all locations worldwide, unless otherwise specified.</span></span>

### <a name="details"></a><span data-ttu-id="d2b75-436">详细信息</span><span class="sxs-lookup"><span data-stu-id="d2b75-436">Details</span></span>

<span data-ttu-id="d2b75-437">Microsoft 于 2020 年 4 月 1 日为 Dynamics Business Central Online 以及 Dynamics Biz 应用和 Power Platform 发布了新产品。</span><span class="sxs-lookup"><span data-stu-id="d2b75-437">On April 1, 2020, Microsoft released new products for Dynamics Business Central Online, and Dynamics Biz Apps and Power Platforms.</span></span> <span data-ttu-id="d2b75-438">适用于 Dynamics 365 的其他新产品/服务将于 2020 年 5 月 1 日发布。</span><span class="sxs-lookup"><span data-stu-id="d2b75-438">Additional new offers for Dynamics 365 will be released on May 1, 2020.</span></span>

### <a name="dynamics-business-central-online-offers"></a><span data-ttu-id="d2b75-439">Dynamics Business Central Online 产品/服务</span><span class="sxs-lookup"><span data-stu-id="d2b75-439">Dynamics Business Central Online Offers</span></span>
<span data-ttu-id="d2b75-440">Dynamics Business Central Online 产品/服务在 2020 年 4 月 1 日进行了以下更改。</span><span class="sxs-lookup"><span data-stu-id="d2b75-440">On April 1, 2020, the following changes were made to the Dynamics Business Central Online offers.</span></span>

- <span data-ttu-id="d2b75-441">适用于云解决方案提供商计划中 Business Central 的新 Dynamics Business 产品/服务</span><span class="sxs-lookup"><span data-stu-id="d2b75-441">New Dynamics Business offers for Business Central in CSP</span></span>
- <span data-ttu-id="d2b75-442">更新 Sales Pro 和 Customer Service Pro 附加 SKU</span><span class="sxs-lookup"><span data-stu-id="d2b75-442">Update Sales Pro and Customer Service Pro Attach SKUs</span></span>

### <a name="dynamics-biz-apps-and-power-platform-products"></a><span data-ttu-id="d2b75-443">Dynamics Biz 应用和 Power Platform 产品</span><span class="sxs-lookup"><span data-stu-id="d2b75-443">Dynamics Biz Apps and Power Platform Products</span></span>

<span data-ttu-id="d2b75-444">Dynamics Biz 应用和 Power Platform 产品/服务在 2020 年 4 月 1 日进行了以下更改。</span><span class="sxs-lookup"><span data-stu-id="d2b75-444">On April 1, 2020, the following changes were made to the Dynamics Biz Apps and Power Platform products.</span></span>

- <span data-ttu-id="d2b75-445">第一方机器人流程自动化 (RPA) 产品/服务</span><span class="sxs-lookup"><span data-stu-id="d2b75-445">First-party Robotic Process Automation (RPA) offers</span></span>
- <span data-ttu-id="d2b75-446">适用于 RPA 产品/服务的新 BOT 产品</span><span class="sxs-lookup"><span data-stu-id="d2b75-446">New BOT product for RPA offers</span></span>

<span data-ttu-id="d2b75-447">请在[此处](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)的“Dynamics 云解决方案提供商产品/服务更新 - 2020 年 3 月”文件中查看具体更改信息。</span><span class="sxs-lookup"><span data-stu-id="d2b75-447">Please see the specific changes in the Dynamics CSP Offer Updates-Mar 2020 file [here](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/).</span></span>

### <a name="robotic-process-automation"></a><span data-ttu-id="d2b75-448">机器人流程自动化</span><span class="sxs-lookup"><span data-stu-id="d2b75-448">Robotic Process Automation</span></span>

<span data-ttu-id="d2b75-449">Microsoft 将于 2020 年 5 月 1 日将新的机器人流程自动化 (RPA) 产品/服务扩展到 Azure 教育计划。</span><span class="sxs-lookup"><span data-stu-id="d2b75-449">On May 1, 2020, Microsoft will be expanding the availability of new RPA offers into the Education programs.</span></span>
<span data-ttu-id="d2b75-450">若要详细了解云解决方案提供商计划中授权教育合作伙伴计划的相关更改信息，请单击[此处](https://partner.microsoft.com/resources/collection/csp-aer-partner-qualification-retirement#/)。</span><span class="sxs-lookup"><span data-stu-id="d2b75-450">To learn more about changes to the Authorized Education Partner Program in CSP click [here](https://partner.microsoft.com/resources/collection/csp-aer-partner-qualification-retirement#/).</span></span> <span data-ttu-id="d2b75-451">这是指向合作伙伴中心现有集合的链接）。</span><span class="sxs-lookup"><span data-stu-id="d2b75-451">This is a link to an existing collection on Partner Center).</span></span>

<span data-ttu-id="d2b75-452">请在[此处](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)的相关下载部分查看附加的 Dynamics 云解决方案提供商计划产品/服务更新 - 2020 年 5 月文件，了解新 SKU 相关信息。</span><span class="sxs-lookup"><span data-stu-id="d2b75-452">Please review the attached **Dynamics CSP Offer Updates-May 2020 file** [here](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/) in the related download section for new SKU information.</span></span>

### <a name="ecommerce-changes"></a><span data-ttu-id="d2b75-453">电子商务更改</span><span class="sxs-lookup"><span data-stu-id="d2b75-453">eCommerce changes</span></span>

<span data-ttu-id="d2b75-454">电子商务产品/服务在最终价目表上的显示名称和/或 PFAM 发生更改，并于 2020 年 4 月 1 日起生效。</span><span class="sxs-lookup"><span data-stu-id="d2b75-454">Effective April 1, 2020, eCommerce offers have display name and/or PFAM changes on the final price sheets.</span></span> <span data-ttu-id="d2b75-455">下表概述了这些更改。</span><span class="sxs-lookup"><span data-stu-id="d2b75-455">The changes are outlined in the table below.</span></span>

|<span data-ttu-id="d2b75-456">**显示名称和/或 PFAM 更改**</span><span class="sxs-lookup"><span data-stu-id="d2b75-456">**Display Name and/or PFAM Change**</span></span>|<span data-ttu-id="d2b75-457">**2020 年 3 月 1 日**</span><span class="sxs-lookup"><span data-stu-id="d2b75-457">**March 1, 2020**</span></span>|<span data-ttu-id="d2b75-458">**2020 年 4 月 1 日**</span><span class="sxs-lookup"><span data-stu-id="d2b75-458">**April 1, 2020**</span></span>|
|-------------------|:------|:-----|
|<span data-ttu-id="d2b75-459">显示名称</span><span class="sxs-lookup"><span data-stu-id="d2b75-459">Display Name</span></span>|<span data-ttu-id="d2b75-460">电子商务评分和评价</span><span class="sxs-lookup"><span data-stu-id="d2b75-460">eCommerce Ratings and Reviews</span></span>|<span data-ttu-id="d2b75-461">商业评分和评价</span><span class="sxs-lookup"><span data-stu-id="d2b75-461">Commerce Ratings and Reviews</span></span>|
|<span data-ttu-id="d2b75-462">显示名称</span><span class="sxs-lookup"><span data-stu-id="d2b75-462">Display Name</span></span>|<span data-ttu-id="d2b75-463">电子商务建议</span><span class="sxs-lookup"><span data-stu-id="d2b75-463">eCommerce Recommendations</span></span>|<span data-ttu-id="d2b75-464">商业建议</span><span class="sxs-lookup"><span data-stu-id="d2b75-464">Commerce Recommendations</span></span>|
|<span data-ttu-id="d2b75-465">显示和 PFAM</span><span class="sxs-lookup"><span data-stu-id="d2b75-465">Display and PFAM</span></span>|<span data-ttu-id="d2b75-466">Dynamics 365 商业云缩放单元基本版</span><span class="sxs-lookup"><span data-stu-id="d2b75-466">Dynamics 365 Commerce Cloud Scale Unit Basic</span></span>|<span data-ttu-id="d2b75-467">Dynamics 365 商业缩放单元基本版 – 云</span><span class="sxs-lookup"><span data-stu-id="d2b75-467">Dynamics 365 Commerce Scale Unit Basic – Cloud</span></span>|
|<span data-ttu-id="d2b75-468">显示和 PFAM</span><span class="sxs-lookup"><span data-stu-id="d2b75-468">Display and PFAM</span></span>|<span data-ttu-id="d2b75-469">Dynamics 365 商业云缩放单元标准版</span><span class="sxs-lookup"><span data-stu-id="d2b75-469">Dynamics 365 Commerce Cloud Scale Unit Standard</span></span>|<span data-ttu-id="d2b75-470">Dynamics 365 商业缩放单元基本版 – 云</span><span class="sxs-lookup"><span data-stu-id="d2b75-470">Dynamics 365 Commerce Scale Unit Basic - Cloud</span></span>|
|<span data-ttu-id="d2b75-471">显示和 PFAM</span><span class="sxs-lookup"><span data-stu-id="d2b75-471">Display and PFAM</span></span>|<span data-ttu-id="d2b75-472">Dynamics 365 商业云缩放单元高级版</span><span class="sxs-lookup"><span data-stu-id="d2b75-472">Dynamics 365 Commerce Cloud Scale Unit Premium</span></span>|<span data-ttu-id="d2b75-473">Dynamics 365 商业缩放单元高级版 – 云</span><span class="sxs-lookup"><span data-stu-id="d2b75-473">Dynamics 365 Commerce Scale Unit Premium - Cloud</span></span>|

### <a name="additional-resources"></a><span data-ttu-id="d2b75-474">其他资源</span><span class="sxs-lookup"><span data-stu-id="d2b75-474">Additional resources</span></span>

- [<span data-ttu-id="d2b75-475">Dynamics 365 主页</span><span class="sxs-lookup"><span data-stu-id="d2b75-475">Dynamics 365 Home Page</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="d2b75-476">混合现实应用指南主页</span><span class="sxs-lookup"><span data-stu-id="d2b75-476">Mixed Reality Apps Guide Home Page</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="d2b75-477">Biz 应用欺诈主页</span><span class="sxs-lookup"><span data-stu-id="d2b75-477">Biz Apps Fraud Home Page</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="d2b75-478">2020 财年 PowerApps 和 Flow 许可更新</span><span class="sxs-lookup"><span data-stu-id="d2b75-478">FY20 PowerApps and Flow Licensing Updates</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="d2b75-479">Microsoft Dynamics 365 许可</span><span class="sxs-lookup"><span data-stu-id="d2b75-479">Microsoft Dynamics 365 Licensing</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="d2b75-480">Dynamics 365 和 Power Platform - 可用性、数据位置、语言和本地化内容</span><span class="sxs-lookup"><span data-stu-id="d2b75-480">Dynamics 365 and Power Platforms-Availability, data location, language, and localization content</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="d2b75-481">FY20 新增功能网络研讨会系列</span><span class="sxs-lookup"><span data-stu-id="d2b75-481">FY20 What's New Webinar Series</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="d2b75-482">FY20 技术准备网络研讨会系列</span><span class="sxs-lookup"><span data-stu-id="d2b75-482">FY20 Technical Readiness Webinar Series</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="d2b75-483">机器人流程自动化 (RPA)</span><span class="sxs-lookup"><span data-stu-id="d2b75-483">Robotic Process Automation (RPA)</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)

### <a name="next-steps"></a><span data-ttu-id="d2b75-484">后续步骤</span><span class="sxs-lookup"><span data-stu-id="d2b75-484">Next steps</span></span>

<span data-ttu-id="d2b75-485">请与贵组织中的相应联系人共享这些信息。</span><span class="sxs-lookup"><span data-stu-id="d2b75-485">Please share this information with appropriate contacts in your organization.</span></span> <span data-ttu-id="d2b75-486">如果想深入了解许可更新和价值主张，请熟悉“附加资源”部分和 PartnerSource 上的准备内容。</span><span class="sxs-lookup"><span data-stu-id="d2b75-486">For more details on the licensing updates and the value proposition, please familiarize yourself with our readiness content in the "Additional resources" section, and on PartnerSource.</span></span>

### <a name="questions"></a><span data-ttu-id="d2b75-487">有疑问？</span><span class="sxs-lookup"><span data-stu-id="d2b75-487">Questions?</span></span>

<span data-ttu-id="d2b75-488">若要获得与 Microsoft 操作高度相关的帮助，请[联系支持人员](https://partner.microsoft.com/pcv/servicerequests/create)。</span><span class="sxs-lookup"><span data-stu-id="d2b75-488">For help strictly relating to your operations with Microsoft, please [reach out to support](https://partner.microsoft.com/pcv/servicerequests/create).</span></span>

_________________

## <a name="now-available---operations-readiness-resources-in-one-place"></a><a id="3"/></a><span data-ttu-id="d2b75-489">现已推出 - 将运营准备资源集于一处</span><span class="sxs-lookup"><span data-stu-id="d2b75-489">Now available - Operations readiness resources in one place</span></span>

### <a name="categories"></a><span data-ttu-id="d2b75-490">类别</span><span class="sxs-lookup"><span data-stu-id="d2b75-490">Categories</span></span>

- <span data-ttu-id="d2b75-491">日期:2020-04-03</span><span class="sxs-lookup"><span data-stu-id="d2b75-491">Date: 2020-04-03</span></span>
- <span data-ttu-id="d2b75-492">键入：功能</span><span class="sxs-lookup"><span data-stu-id="d2b75-492">Type: Capabilities</span></span>
- <span data-ttu-id="d2b75-493">状态：现已推出</span><span class="sxs-lookup"><span data-stu-id="d2b75-493">Status: Now Available</span></span>
- [<span data-ttu-id="d2b75-494">了解详细信息</span><span class="sxs-lookup"><span data-stu-id="d2b75-494">Learn more</span></span>](https://partner.microsoft.com/resources/collection/readiness-in-one-place#/)

### <a name="impacted-audience"></a><span data-ttu-id="d2b75-495">影响受众</span><span class="sxs-lookup"><span data-stu-id="d2b75-495">Impacted audience</span></span>
- <span data-ttu-id="d2b75-496">所有云解决方案提供商计划合作伙伴</span><span class="sxs-lookup"><span data-stu-id="d2b75-496">All CSP partners</span></span>

### <a name="summary"></a><span data-ttu-id="d2b75-497">摘要</span><span class="sxs-lookup"><span data-stu-id="d2b75-497">Summary</span></span>

<span data-ttu-id="d2b75-498">统一的[运营准备资源位置](https://partner.microsoft.com/resources#/)现已上线，这为合作伙伴提供了一个集中的运营准备资源位置，使其能够比以往更轻松地在所有 Microsoft 渠道和项目中找到最新的更新和关键运营准备资源。</span><span class="sxs-lookup"><span data-stu-id="d2b75-498">The [Operations Readiness resource location](https://partner.microsoft.com/resources#/) is now live, providing partners with one location for operations readiness resources, making it easier than ever to find the latest updates and key operational readiness resources across all Microsoft channels and programs.</span></span> <span data-ttu-id="d2b75-499">云解决方案提供商计划更新资源库和 Microsoft 准备内容已迁移至“运营准备”资源位置，指向云解决方案提供商计划更新资源库 ([https://partner.microsoft.com/resources#/](https://partner.microsoft.com/resources#/)) 的 URL 已更新为指向运营准备资源位置。</span><span class="sxs-lookup"><span data-stu-id="d2b75-499">The CSP Program Updates Resource gallery and Microsoft Readiness content has been moved to the Operations Readiness resource location and the URL pointing to the CSP Program Update Resource Gallery ([https://partner.microsoft.com/resources#/](https://partner.microsoft.com/resources#/)) has been updated to point to the Operations Readiness resource location.</span></span>

<span data-ttu-id="d2b75-500">请在此处查看[更新的常见问题解答](https://assetsprod.microsoft.com/mpn/readiness-in-one-place-partner-login-faq.pdf)，以获取有关此新体验和一些区域的更多详细信息，这些内容将在接下来的几周不断更新。</span><span class="sxs-lookup"><span data-stu-id="d2b75-500">Please review the [updated FAQ](https://assetsprod.microsoft.com/mpn/readiness-in-one-place-partner-login-faq.pdf) here for further details on this new experience and some areas that will continue to evolve over the next few weeks.</span></span>

<span data-ttu-id="d2b75-501">你的反馈对于我们至关重要！</span><span class="sxs-lookup"><span data-stu-id="d2b75-501">**Your feedback is important to us!**</span></span> <span data-ttu-id="d2b75-502">在你使用新的运营准备位置期间，我们邀请你提供反馈，帮助我们持续改进使用体验。</span><span class="sxs-lookup"><span data-stu-id="d2b75-502">As you use the new Operations Readiness location, we invite you to leave feedback so we can continue to improve your experience.</span></span> <span data-ttu-id="d2b75-503">为此，你可以使用每页底部的“此页面是否有帮助？是 | 否”反馈工具。</span><span class="sxs-lookup"><span data-stu-id="d2b75-503">You can do this by using the **Was this page helpful? Yes | No** feedback tool available at the bottom of each page.</span></span>

<span data-ttu-id="d2b75-504">Microsoft 正在简化我们的通信方式，并在所有 Microsoft 计划中提供准备就绪的资料。</span><span class="sxs-lookup"><span data-stu-id="d2b75-504">Microsoft is streamlining the way we communicate and provide readiness materials across all Microsoft programs.</span></span> <span data-ttu-id="d2b75-505">我们将在 Microsoft 合作伙伴网站 [https://partner.microsoft.com](https://partner.microsoft.com) 上引入一个运营准备资源位置，其中包含[云解决方案提供商计划更新资源库](https://partner.microsoft.com/resources#/)以及 [Microsoft Readiness 站点](https://www.microsoftreadiness.com/)中的资产。</span><span class="sxs-lookup"><span data-stu-id="d2b75-505">We are introducing one Operations Readiness resource location on the Microsoft partner website at [https://partner.microsoft.com](https://partner.microsoft.com) that will combine assets from the [CSP Program Updates Resource Gallery](https://partner.microsoft.com/resources#/) and the [Microsoft Readiness site](https://www.microsoftreadiness.com/).</span></span>

<span data-ttu-id="d2b75-506">利用统一的运营准备资源位置，合作伙伴可以比以往更轻松地在所有 Microsoft 渠道和项目中找到最新的更新、重要的公告，以及关键的运营准备资源。</span><span class="sxs-lookup"><span data-stu-id="d2b75-506">With one location for operations readiness resources, it will be easier than ever for partners to find the latest updates, critical announcements, and key operational readiness resources across all Microsoft channels and programs.</span></span> <span data-ttu-id="d2b75-507">借助单一登录体验和增强的搜索、筛选和排序功能，合作伙伴可以轻松地访问、使用资源，并让自己的企业做好准备，以适合的方式与 Microsoft 进行交易和开展业务。</span><span class="sxs-lookup"><span data-stu-id="d2b75-507">With a single sign-on experience and enhanced search, filter, and sort capabilities partners can easily access, consume, and prepare their businesses to successfully transact and do business with Microsoft in the way that works for them.</span></span>

### <a name="expanding-on-the-success-of-the-csp-program-updates-resource-gallery"></a><span data-ttu-id="d2b75-508">扩大云解决方案提供商计划更新资源库取得的成功：</span><span class="sxs-lookup"><span data-stu-id="d2b75-508">Expanding on the success of the CSP Program Updates Resource Gallery:</span></span>

<span data-ttu-id="d2b75-509">位于 partner.microsoft.com 上的运营准备资源位置将与最新的云解决方案提供商计划更新资源库发挥相似的作用，提供一些显著的增强功能和修改，其中包括：</span><span class="sxs-lookup"><span data-stu-id="d2b75-509">The operations readiness resource location on partner.microsoft.com will function much like the current CSP Program Update Resource Gallery with some notable enhancements and modifications, including:</span></span>

- <span data-ttu-id="d2b75-510">**计划页面：** 借助预筛选为仅包含特定计划资源的页面，查找该计划的最新文档更新将变得非常简单。</span><span class="sxs-lookup"><span data-stu-id="d2b75-510">**Program Pages:** Finding the most recent document updates for a specific program will be made easy with pages that are pre-filtered to content only for that program.</span></span>
- <span data-ttu-id="d2b75-511">**强大的库搜索功能：** 内容筛选器会使在项目和内容中查找特定内容（例如云解决方案提供商）更加轻松快捷。</span><span class="sxs-lookup"><span data-stu-id="d2b75-511">**Powerful gallery search:** Content filters will make finding content across programs and content faster and simpler, for example, CSP.</span></span>
- <span data-ttu-id="d2b75-512">**公告：** 借助预筛选为仅包含特定计划内容的页面，查找该计划的最新公告和文档更新将变得非常简单。</span><span class="sxs-lookup"><span data-stu-id="d2b75-512">**Announcements:** Finding the latest announcements and most recent document updates for a specific program will be easier with pages that are pre-filtered to content only for that program.</span></span> <span data-ttu-id="d2b75-513">我们将提供云解决方案提供商的计划页面，但云解决方案提供商公告将继续在合作伙伴中心发布。</span><span class="sxs-lookup"><span data-stu-id="d2b75-513">There will be a program page for CSP as well however CSP announcements will continue to be posted in Partner Center.</span></span>
- <span data-ttu-id="d2b75-514">**新的位置：** 运营资源的新位置在 partner.microsoft.com 上线后，Microsoft Readiness 站点和云解决方案提供商计划更新资源库将不再可供访问，用户会被重定向到新的运营资源位置。</span><span class="sxs-lookup"><span data-stu-id="d2b75-514">**New location:** Once the new location for operations resources is live on partner.microsoft.com, the Microsoft Readiness site and the CSP Program Updates Resource Gallery will no longer be accessible and will redirect users to the new operations resource location.</span></span> <span data-ttu-id="d2b75-515">合作伙伴将能够利用内容计划筛选器筛选到云解决方案提供商或其他特定的计划资源。</span><span class="sxs-lookup"><span data-stu-id="d2b75-515">Partners will be able to leverage content program filters to filter to CSP or other specific program resources.</span></span>
- <span data-ttu-id="d2b75-516">**扩充的内容：** Microsoft Readiness 站点和云解决方案提供商计划更新资源库中的所有最新和相关内容将重定位到新的运营准备位置，这意味着更多计划的内容现在将位于同一位置。</span><span class="sxs-lookup"><span data-stu-id="d2b75-516">**Content expanded:** All recent and relevant content from the Microsoft Readiness site and the CSP Program Updates Resource Gallery will be relocated to the new operations readiness location meaning content for more programs will now be housed in one location.</span></span>

### <a name="next-steps"></a><span data-ttu-id="d2b75-517">后续步骤</span><span class="sxs-lookup"><span data-stu-id="d2b75-517">Next steps</span></span>

<span data-ttu-id="d2b75-518">应该如何准备？</span><span class="sxs-lookup"><span data-stu-id="d2b75-518">What should you do to prepare?</span></span>

- <span data-ttu-id="d2b75-519">详细了解用于运营准备资源的新的 Microsoft 合作伙伴网站位置，方法是在库集合[即将发布 - 同一个位置的运营准备资源](https://partner.microsoft.com/resources/collection/readiness-in-one-place#/)中查看更新的准备材料。</span><span class="sxs-lookup"><span data-stu-id="d2b75-519">**Learn more** about the new Microsoft partner website location for operations readiness resources by reviewing the updated readiness materials at the gallery collection [Coming soon - Operations readiness resources in one place](https://partner.microsoft.com/resources/collection/readiness-in-one-place#/).</span></span>
- <span data-ttu-id="d2b75-520">参加 4 月的合作伙伴社区拜访，届时你将详细了解新的体验并提问：[https://globalpbocomm.eventbuilder.com/GlobalCSP](https://globalpbocomm.eventbuilder.com/GlobalCSP)</span><span class="sxs-lookup"><span data-stu-id="d2b75-520">**Attend an April partner community call** where you can learn more about the new experience and ask questions: [https://globalpbocomm.eventbuilder.com/GlobalCSP](https://globalpbocomm.eventbuilder.com/GlobalCSP)</span></span>

### <a name="questions"></a><span data-ttu-id="d2b75-521">有疑问？</span><span class="sxs-lookup"><span data-stu-id="d2b75-521">Questions?</span></span>

<span data-ttu-id="d2b75-522">如需了解相关问题、查询或详细信息，请[联系支持人员](https://partner.microsoft.com/dashboard/support/csp/servicerequests/create?category=csp)。</span><span class="sxs-lookup"><span data-stu-id="d2b75-522">Please [contact Support](https://partner.microsoft.com/dashboard/support/csp/servicerequests/create?category=csp) for questions, queries, or more information.</span></span>

### <a name="change-log"></a><span data-ttu-id="d2b75-523">更改日志</span><span class="sxs-lookup"><span data-stu-id="d2b75-523">Change log</span></span>

- <span data-ttu-id="d2b75-524">2020 年 4 月 3 日：已更新为“现已推出”</span><span class="sxs-lookup"><span data-stu-id="d2b75-524">April 3, 2020: Updated to Now Available</span></span>
- <span data-ttu-id="d2b75-525">2020 年 3 月 23 日：云解决方案提供商计划更新资源库到运营准备资源位置的转换时间更新为 2020 年 4 月 3 日</span><span class="sxs-lookup"><span data-stu-id="d2b75-525">March 23, 2020: CSP Program Updates Resource Gallery transition to Operations Readiness resource location updated to April 3, 2020</span></span>
- <span data-ttu-id="d2b75-526">2020 年 3 月 9 日：30 天通知，更新的准备材料</span><span class="sxs-lookup"><span data-stu-id="d2b75-526">March 9, 2020: 30-Day notice, updated readiness materials</span></span>
- <span data-ttu-id="d2b75-527">2020 年 2 月 14 日：原始发布日期</span><span class="sxs-lookup"><span data-stu-id="d2b75-527">February 14, 2020: Original publication date</span></span>

_________________

## <a name="microsoft-365-business-voice-available-to-csp-partners-from-april-1-2020"></a><a id="2"/></a><span data-ttu-id="d2b75-528">Microsoft 365 商务语音从 2020 年 4 月 1 日起向云解决方案提供商合作伙伴推出</span><span class="sxs-lookup"><span data-stu-id="d2b75-528">Microsoft 365 Business Voice available to CSP partners from April 1, 2020</span></span>

### <a name="categories"></a><span data-ttu-id="d2b75-529">类别</span><span class="sxs-lookup"><span data-stu-id="d2b75-529">Categories</span></span>

- <span data-ttu-id="d2b75-530">日期:2020-04-01</span><span class="sxs-lookup"><span data-stu-id="d2b75-530">Date: 2020-04-01</span></span>
- <span data-ttu-id="d2b75-531">键入：产品/市场</span><span class="sxs-lookup"><span data-stu-id="d2b75-531">Type: Offers/Markets</span></span>
- <span data-ttu-id="d2b75-532">状态：现已推出</span><span class="sxs-lookup"><span data-stu-id="d2b75-532">Status: Now Available</span></span>
- [<span data-ttu-id="d2b75-533">了解详细信息</span><span class="sxs-lookup"><span data-stu-id="d2b75-533">Learn more</span></span>](https://partner.microsoft.com/resources/collection/microsoft_365_business_voice_in_csp#/)

### <a name="summary"></a><span data-ttu-id="d2b75-534">摘要</span><span class="sxs-lookup"><span data-stu-id="d2b75-534">Summary</span></span>

<span data-ttu-id="d2b75-535">Microsoft 365 商务语音是一个基于云的电话系统，专为中小型企业所打造，将从 2020 年 4 月 1 日起在此处列出的国家/地区推出。</span><span class="sxs-lookup"><span data-stu-id="d2b75-535">Microsoft 365 Business Voice, a cloud-based phone system built for small and medium businesses, will be available in the countries listed here from April 1, 2020.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="d2b75-536">影响受众</span><span class="sxs-lookup"><span data-stu-id="d2b75-536">Impacted audience</span></span>

- <span data-ttu-id="d2b75-537">在这些[国家/地区](https://partner.microsoft.com/resources/collection/microsoft_365_business_voice_in_csp#/)运营的所有 CSP 合作伙伴。</span><span class="sxs-lookup"><span data-stu-id="d2b75-537">All CSP partners operating in [these countries](https://partner.microsoft.com/resources/collection/microsoft_365_business_voice_in_csp#/).</span></span>
- <span data-ttu-id="d2b75-538">澳大利亚的合作伙伴须查看我们下面的指南。</span><span class="sxs-lookup"><span data-stu-id="d2b75-538">Partners in Australia should check our guidance below.</span></span>

### <a name="details"></a><span data-ttu-id="d2b75-539">详细信息</span><span class="sxs-lookup"><span data-stu-id="d2b75-539">Details</span></span>

<span data-ttu-id="d2b75-540">2020 年 4 月 1 日，Microsoft 将向其他地区引入 Microsoft 365 商务语音。</span><span class="sxs-lookup"><span data-stu-id="d2b75-540">On April 1, 2020, Microsoft will introduce Microsoft 365 Business Voice to additional geographies.</span></span> <span data-ttu-id="d2b75-541">我们将推出以下两项产品/服务：Microsoft 365 商务语音，以及 Microsoft 365 商务语音（不含通话套餐），后者使用的是直接路由。</span><span class="sxs-lookup"><span data-stu-id="d2b75-541">Two offers will be available: Microsoft 365 Business Voice, and Microsoft 365 Business Voice Without Calling Plan (using direct routing).</span></span> <span data-ttu-id="d2b75-542">这两项产品/服务都将在美国推出。</span><span class="sxs-lookup"><span data-stu-id="d2b75-542">Both offers will be available in the U.S.</span></span>

### <a name="customer-value-proposition"></a><span data-ttu-id="d2b75-543">客户价值主张</span><span class="sxs-lookup"><span data-stu-id="d2b75-543">Customer value proposition</span></span>

<span data-ttu-id="d2b75-544">Microsoft 365 商务语音是基于云的电话系统，适用于多达 300 个用户的企业。</span><span class="sxs-lookup"><span data-stu-id="d2b75-544">Microsoft 365 Business Voice is a cloud-based phone system for businesses of up to 300 users.</span></span> <span data-ttu-id="d2b75-545">它使用户可在 Microsoft Teams 中拨打和接听任何电话。</span><span class="sxs-lookup"><span data-stu-id="d2b75-545">It provides the ability to make and receive calls from any phone number in Microsoft Teams.</span></span> <span data-ttu-id="d2b75-546">通过与 Teams 配合使用，它可以提供将通话、聊天和会议结合在一起的一体式通信解决方案。</span><span class="sxs-lookup"><span data-stu-id="d2b75-546">Together with Teams, it delivers an all-in-one communication solution combining calling, chat, and meetings.</span></span>

<span data-ttu-id="d2b75-547">Microsoft 365 商务语音对高效工作和通信功能进行了简化和优化，将它们集成到了单一应用程序中，可随时随地通过任何设备处理业务：无论是计算机、手机，还是桌面电话。</span><span class="sxs-lookup"><span data-stu-id="d2b75-547">Microsoft 365 Business Voice simplifies and streamlines productivity and communications into a single application that works wherever businesses do: on computers, smart phones, and desk phones.</span></span> <span data-ttu-id="d2b75-548">Microsoft 365 商务语音的优点包括：</span><span class="sxs-lookup"><span data-stu-id="d2b75-548">The benefits of Microsoft 365 Business Voice include:</span></span>

- <span data-ttu-id="d2b75-549">一体式通信。</span><span class="sxs-lookup"><span data-stu-id="d2b75-549">All-in-one communication.</span></span> <span data-ttu-id="d2b75-550">通过统一通话、聊天、会议、日历和电子邮件功能来转换完成工作的方式。</span><span class="sxs-lookup"><span data-stu-id="d2b75-550">Transform how work gets done by unifying calling, chat, meetings, calendar, and email.</span></span>
- <span data-ttu-id="d2b75-551">轻松且智能的通话。</span><span class="sxs-lookup"><span data-stu-id="d2b75-551">Easy and intelligent calling.</span></span> <span data-ttu-id="d2b75-552">实现更灵活、更轻松以及更智能的通话，使你随时保持连接。</span><span class="sxs-lookup"><span data-stu-id="d2b75-552">Communicate with more flexibility, ease, and intelligence, so you can stay connected.</span></span>
- <span data-ttu-id="d2b75-553">通过 Microsoft 云提供。</span><span class="sxs-lookup"><span data-stu-id="d2b75-553">Delivered from the Microsoft cloud.</span></span> <span data-ttu-id="d2b75-554">凭借可靠、安全的基于云的解决方案自信地工作。</span><span class="sxs-lookup"><span data-stu-id="d2b75-554">Work confidently with a reliable and secure cloud-based solution.</span></span>

<span data-ttu-id="d2b75-555">Microsoft 365 商务语音将作为以下计划的加载项提供：</span><span class="sxs-lookup"><span data-stu-id="d2b75-555">Microsoft 365 Business Voice is available as an add-on to the following plans:</span></span>

- <span data-ttu-id="d2b75-556">Office 365 商业协作版、商业高级版、F1、A1、E1、A3 和 E3</span><span class="sxs-lookup"><span data-stu-id="d2b75-556">Office 365 Business Essentials, Business Premium, F1, A1, E1, A3, E3</span></span>
- <span data-ttu-id="d2b75-557">Microsoft 365 商业版、F1、A3 和 E3</span><span class="sxs-lookup"><span data-stu-id="d2b75-557">Microsoft 365 Business, F1, A3, E3</span></span>

### <a name="partner-value-proposition"></a><span data-ttu-id="d2b75-558">合作伙伴价值主张</span><span class="sxs-lookup"><span data-stu-id="d2b75-558">Partner value proposition</span></span>

<span data-ttu-id="d2b75-559">合作伙伴可以通过以下方式利用此机会实现盈利：</span><span class="sxs-lookup"><span data-stu-id="d2b75-559">Partners can monetize this opportunity by:</span></span>

- <span data-ttu-id="d2b75-560">对带有呼叫队列/自动助理的电话系统提供支持、评估网络质量，或者配置直接路由和音频会议。</span><span class="sxs-lookup"><span data-stu-id="d2b75-560">Enabling the phone system with Call Queues/Auto-Attendant, assessing the network quality, or configuring Direct Routing and audio conferencing.</span></span>
- <span data-ttu-id="d2b75-561">提供用户采用/培训服务，从而确保组织已准备就绪并开始使用现代通信工具 Microsoft Teams。</span><span class="sxs-lookup"><span data-stu-id="d2b75-561">Offering user adoption/training services to secure organization readiness and start using the modern communication tool, Microsoft Teams.</span></span>
- <span data-ttu-id="d2b75-562">通过质量报告、设备管理和用户支持等托管服务支持并监视客户环境。</span><span class="sxs-lookup"><span data-stu-id="d2b75-562">Supporting and monitoring the customer environment with managed services like quality reporting, device management, and user support.</span></span>

<span data-ttu-id="d2b75-563">**Microsoft 365 商务语音（美国、加拿大、英国）**</span><span class="sxs-lookup"><span data-stu-id="d2b75-563">**Microsoft 365 Business Voice (United States, Canada, United Kingdom)**</span></span>

<span data-ttu-id="d2b75-564">继我们于 2019 年 11 月在英国和加拿大推出了商务语音（含通话套餐）后，我们将于 2020 年 4 月 1 日向美国客户推出此产品/服务，供他们购买。</span><span class="sxs-lookup"><span data-stu-id="d2b75-564">On April 1, 2020, Business Voice with calling plans will be available for purchase in the United States, following our launch in the United Kingdom and Canada in November 2019.</span></span>

<span data-ttu-id="d2b75-565">对于需要国际呼叫功能的客户，还可购买附加产品/服务。</span><span class="sxs-lookup"><span data-stu-id="d2b75-565">An add-on offer will also be available for those customers seeking international calling capabilities.</span></span>

- <span data-ttu-id="d2b75-566">Microsoft 365 商务语音：9f9f2c7b-c961-402b-9421-8e3c9207eeb3</span><span class="sxs-lookup"><span data-stu-id="d2b75-566">Microsoft 365 Business Voice: 9f9f2c7b-c961-402b-9421-8e3c9207eeb3</span></span>
- <span data-ttu-id="d2b75-567">适用于 SMB 的 Microsoft 365 国际通话套餐：c01a89e5-d246-42d6-b21a-f4a1e9b04f56</span><span class="sxs-lookup"><span data-stu-id="d2b75-567">Microsoft 365 International Calling Plan for SMB: c01a89e5-d246-42d6-b21a-f4a1e9b04f56</span></span>

<span data-ttu-id="d2b75-568">**Microsoft 365 商务语音（不含通话套餐）（70 多个国家/地区）**</span><span class="sxs-lookup"><span data-stu-id="d2b75-568">**Microsoft 365 Business Voice Without Calling Plan (70+ countries)**</span></span>

<span data-ttu-id="d2b75-569">或者，从 2020 年 4 月 1 日起，可以购买商务语音（不含通话套餐）这一产品/服务，其中包含了电话系统和音频会议。</span><span class="sxs-lookup"><span data-stu-id="d2b75-569">Alternatively, from April 1, 2020, you can purchase the Business Voice Without Calling Plan offer, which includes phone system and audio conferencing.</span></span> <span data-ttu-id="d2b75-570">此产品/服务将在此处列出的所有国家/地区推出。</span><span class="sxs-lookup"><span data-stu-id="d2b75-570">This offer is available in all countries listed here.</span></span>

- <span data-ttu-id="d2b75-571">**仅限美国：** Microsoft 365 商务语音（不含通话套餐）：39d77d0f-eb8f-4ebc-b618-692e1cc59c8f</span><span class="sxs-lookup"><span data-stu-id="d2b75-571">**United States only:** Microsoft 365 Business Voice Without Calling Plan: 39d77d0f-eb8f-4ebc-b618-692e1cc59c8f</span></span>
- <span data-ttu-id="d2b75-572">**世界其他国家/地区：** Microsoft 365 商务语音（不含通话套餐）：cc69a07c-8c51-457f-bb2a-f21a62d6bede</span><span class="sxs-lookup"><span data-stu-id="d2b75-572">**Rest of the world:** Microsoft 365 Business Voice Without Calling Plan: cc69a07c-8c51-457f-bb2a-f21a62d6bede</span></span>

<span data-ttu-id="d2b75-573">请与我们位于你当地的子公司联系以了解如何通过此产品/服务获益。</span><span class="sxs-lookup"><span data-stu-id="d2b75-573">Please engage with your local subsidiary to understand how to benefit from this offer.</span></span>

### <a name="additional-guidance-for-partners-in-the-united-states-and-puerto-rico"></a><span data-ttu-id="d2b75-574">适用于美国和波多黎各合作伙伴的其他指导信息</span><span class="sxs-lookup"><span data-stu-id="d2b75-574">Additional guidance for partners in the United States and Puerto Rico</span></span>

<span data-ttu-id="d2b75-575">在美国和波多黎各，商务语音是一项含税服务。</span><span class="sxs-lookup"><span data-stu-id="d2b75-575">In the US and Puerto Rico, Business Voice is a tax-inclusive offer.</span></span> <span data-ttu-id="d2b75-576">Microsoft 向合作伙伴收取的费用以及合作伙伴向 Microsoft 支付的费用包括适用的美国电信税费。</span><span class="sxs-lookup"><span data-stu-id="d2b75-576">The price billed to Partners and paid by Partners to Microsoft includes applicable US telco taxes and fees.</span></span> <span data-ttu-id="d2b75-577">在其他市场中，则按普通开票流程收取税金。</span><span class="sxs-lookup"><span data-stu-id="d2b75-577">In other markets, taxes will be applied per the normal invoicing process.</span></span> <span data-ttu-id="d2b75-578">在决定提升商务语音价格之前，请就缴税事宜咨询法律顾问。</span><span class="sxs-lookup"><span data-stu-id="d2b75-578">Please talk to your legal counsel about remitting taxes, before deciding to mark-up Business Voice.</span></span> <span data-ttu-id="d2b75-579">如果合作伙伴提升了商务语音的价格，则需要通过某种方式来缴纳电信税。</span><span class="sxs-lookup"><span data-stu-id="d2b75-579">If Business Voice is marked up, the Partner needs to a way to remit the telco taxes.</span></span> <span data-ttu-id="d2b75-580">否则，合作伙伴将不会缴纳溢价部分的增量税金，从而导致违反纳税规定。</span><span class="sxs-lookup"><span data-stu-id="d2b75-580">Otherwise, partner would not be paying the incremental tax on the mark-up, resulting in tax violations.</span></span> <span data-ttu-id="d2b75-581">Microsoft 为美国的商务语音合作伙伴提供额外的云解决方案提供商奖励，以补偿可能缺少的利润。</span><span class="sxs-lookup"><span data-stu-id="d2b75-581">Microsoft provides additional CSP incentives to partners for Business Voice in the US, to compensate for potential lack of margin.</span></span>

### <a name="guidance-for-partners-in-australia"></a><span data-ttu-id="d2b75-582">针对澳大利亚合作伙伴的指南</span><span class="sxs-lookup"><span data-stu-id="d2b75-582">Guidance for partners in Australia</span></span>

<span data-ttu-id="d2b75-583">澳大利亚的合作伙伴须留意，Microsoft 365 商务语音（不含通话套餐）这项产品/服务将不会提供在 2020 年 4 月 1 日的产品价目表上 – 尽管这项产品/服务已在 2020 年 3 月的预览价目表上提供。</span><span class="sxs-lookup"><span data-stu-id="d2b75-583">Partners in Australia should be aware that the offer Microsoft 365 Business Voice Without Calling Plan will not be available on the production price list on April 1, 2020 – despite being available on the preview price list in March 2020.</span></span> <span data-ttu-id="d2b75-584">感谢你的理解。</span><span class="sxs-lookup"><span data-stu-id="d2b75-584">Thank you for your understanding.</span></span>

### <a name="further-countries"></a><span data-ttu-id="d2b75-585">更多国家/地区</span><span class="sxs-lookup"><span data-stu-id="d2b75-585">Further countries</span></span>

<span data-ttu-id="d2b75-586">随着时间的推移，我们希望将 Microsoft 365 商务语音引入到 Office 365 和 Microsoft 365 可用的所有国家/地区。</span><span class="sxs-lookup"><span data-stu-id="d2b75-586">Over time, we hope to bring Microsoft 365 Business Voice to all countries where Office 365 and Microsoft 365 are available.</span></span>

### <a name="next-steps"></a><span data-ttu-id="d2b75-587">后续步骤</span><span class="sxs-lookup"><span data-stu-id="d2b75-587">Next steps</span></span>

- <span data-ttu-id="d2b75-588">请查看我们的合作伙伴库，详细了解此产品/服务的价值主张，并且建立和巩固你的 Microsoft Teams 实践：[面向云解决方案提供商的 Microsoft 365 商务语音可用性](https://partner.microsoft.com/resources/collection/microsoft_365_business_voice_in_csp#/)</span><span class="sxs-lookup"><span data-stu-id="d2b75-588">Check our partner gallery to know more about the value proposition of this offer, as well to establish, and consolidate your Microsoft Teams practice: [Microsoft 365 Business Voice availability in CSP](https://partner.microsoft.com/resources/collection/microsoft_365_business_voice_in_csp#/)</span></span>
- <span data-ttu-id="d2b75-589">请熟悉预览版价目表的内容，并与你组织中所有合适的联系人共享此信息。</span><span class="sxs-lookup"><span data-stu-id="d2b75-589">Please familiarize yourself with the preview price list and share this information with all appropriate contacts in your organization.</span></span>
- <span data-ttu-id="d2b75-590">请与你当地的 One Commercial Partner 团队联系，详细了解此产品/服务以及如何有效地进入市场</span><span class="sxs-lookup"><span data-stu-id="d2b75-590">Please engage with your local One Commercial Partner team to know more about this offer and how to go to market effectively</span></span>

### <a name="questions"></a><span data-ttu-id="d2b75-591">有疑问？</span><span class="sxs-lookup"><span data-stu-id="d2b75-591">Questions?</span></span>

<span data-ttu-id="d2b75-592">有关这些产品/服务的任何其他问题，请联系你的 Microsoft One Commercial Partner 团队代表。</span><span class="sxs-lookup"><span data-stu-id="d2b75-592">For any further questions about these offers, please contact your representative in the Microsoft One Commercial Partner team.</span></span>

### <a name="change-log"></a><span data-ttu-id="d2b75-593">更改日志</span><span class="sxs-lookup"><span data-stu-id="d2b75-593">Change log</span></span>

- <span data-ttu-id="d2b75-594">将为美国客户推出 M365 商务语音：2020 年 4 月 1 日</span><span class="sxs-lookup"><span data-stu-id="d2b75-594">M365 Business Voice available for US customers: April 1, 2020</span></span>
- <span data-ttu-id="d2b75-595">将推出 M365 商务语音（不含通话套餐）：2020 年 4 月 1 日</span><span class="sxs-lookup"><span data-stu-id="d2b75-595">M365 Business Voice without calling plan launch: April 1, 2020</span></span>
- <span data-ttu-id="d2b75-596">原始发布日期：2019 年 11 月 5 日</span><span class="sxs-lookup"><span data-stu-id="d2b75-596">Original publication date: November 5, 2019</span></span>

_________________

## <a name="act-now-partners-are-now-required-to-have-accepted-the-microsoft-partner-agreement"></a><a id="1"/></a><span data-ttu-id="d2b75-597">立即行动：合作伙伴现在需要接受 Microsoft 合作伙伴协议。</span><span class="sxs-lookup"><span data-stu-id="d2b75-597">Act now: Partners are now required to have accepted the Microsoft Partner Agreement.</span></span>

### <a name="categories"></a><span data-ttu-id="d2b75-598">类别</span><span class="sxs-lookup"><span data-stu-id="d2b75-598">Categories</span></span>

- <span data-ttu-id="d2b75-599">日期:2020-04-01</span><span class="sxs-lookup"><span data-stu-id="d2b75-599">Date: 2020-04-01</span></span>
- <span data-ttu-id="d2b75-600">键入：功能</span><span class="sxs-lookup"><span data-stu-id="d2b75-600">Type: Capabilities</span></span>
- <span data-ttu-id="d2b75-601">状态：现已推出</span><span class="sxs-lookup"><span data-stu-id="d2b75-601">Status: Now Available</span></span>
- [<span data-ttu-id="d2b75-602">了解详细信息</span><span class="sxs-lookup"><span data-stu-id="d2b75-602">Learn more</span></span>](https://partner.microsoft.com/resources/collection/new-microsoft-cloud-agreement-csp)

### <a name="impacted-audience"></a><span data-ttu-id="d2b75-603">影响受众</span><span class="sxs-lookup"><span data-stu-id="d2b75-603">Impacted audience</span></span>
<span data-ttu-id="d2b75-604">所有云解决方案提供商计划合作伙伴。</span><span class="sxs-lookup"><span data-stu-id="d2b75-604">All CSP partners.</span></span>

<span data-ttu-id="d2b75-605">**2020 年 4 月 1 日更新**截至 2020 年 1 月 31 日，云解决方案提供商 (CSP) 计划中的所有合作伙伴都应接受针对他们所有交易 CSP 租户的协议。</span><span class="sxs-lookup"><span data-stu-id="d2b75-605">**April 1, 2020 Update** As of 31 January 2020, all partners in the Cloud Solution Provider (CSP) Program should have accepted the agreement for all of their transacting CSP tenants.</span></span> <span data-ttu-id="d2b75-606">之前，我们传递的信息是协议的下一个实施阶段将从 2020 年 4 月开始。</span><span class="sxs-lookup"><span data-stu-id="d2b75-606">We previously communicated that the next phase of implementation for the agreement would begin in April 2020.</span></span><span data-ttu-id="d2b75-607">  然而，为了防止对业务造成任何中断，我们已决定将下一个阶段的实施延长至 2020 年 4 月之后进行。</span><span class="sxs-lookup"><span data-stu-id="d2b75-607">  To help prevent any disruption to business, we have decided to extend the next phase of implementation beyond April 2020.</span></span> <span data-ttu-id="d2b75-608">我们收到了来自一些云解决方案提供商合作伙伴的反馈，他们在接受 MPA 时遇到了问题。</span><span class="sxs-lookup"><span data-stu-id="d2b75-608">We have received feedback from some of our Cloud Solution Provider Partners that they have experienced issues accepting the MPA.</span></span> <span data-ttu-id="d2b75-609">基于这些情况，我们正努力保障 Microsoft 资源已做好为这些接受协议时遇到困难的合作伙伴提供支持的准备。</span><span class="sxs-lookup"><span data-stu-id="d2b75-609">Based on these circumstances, we are working toward ensuring Microsoft resources are in place to support partners who have been having trouble accepting the agreement.</span></span>

### <a name="summary"></a><span data-ttu-id="d2b75-610">摘要</span><span class="sxs-lookup"><span data-stu-id="d2b75-610">Summary</span></span>
<span data-ttu-id="d2b75-611">截至 2020 年 1 月 31 日，云解决方案提供商计划中的所有合作伙伴（包括间接经销商）都应接受 Microsoft 合作伙伴协议，从而确保能够继续开发新客户或为 CSP 计划中的现有客户新下订单。</span><span class="sxs-lookup"><span data-stu-id="d2b75-611">As of January 31, 2020, all partners in the Cloud Solution Provider program should have accepted the Microsoft Partner Agreement, including Indirect Resellers, to ensure no disruption of their ability to create new customers or place new orders for existing customers in the CSP program.</span></span> <span data-ttu-id="d2b75-612">CSP 计划中的所有合作伙伴现在必须接受 Microsoft 合作伙伴协议。</span><span class="sxs-lookup"><span data-stu-id="d2b75-612">Acceptance of the Microsoft Partner Agreement is now required for all partners in the CSP program.</span></span>

<span data-ttu-id="d2b75-613">自 2020 年 4 月起：</span><span class="sxs-lookup"><span data-stu-id="d2b75-613">Starting in April, 2020:</span></span>
- <span data-ttu-id="d2b75-614">尚未接受 Microsoft 合作伙伴协议的直接计费合作伙伴和间接提供商将无法新下订单，并且仅能管理现有订阅。</span><span class="sxs-lookup"><span data-stu-id="d2b75-614">Direct Bill partners and Indirect Providers who have not accepted the Microsoft Partner Agreement will not be able to place new orders and will be limited to managing existing subscriptions only.</span></span>
- <span data-ttu-id="d2b75-615">尚未接受 Microsoft 合作伙伴协议的间接经销商将不再有资格担任新订单的记录合作伙伴。</span><span class="sxs-lookup"><span data-stu-id="d2b75-615">Indirect Resellers who have not accepted the Microsoft Partner Agreement will no longer be eligible to act as partner of record on new orders.</span></span>

<span data-ttu-id="d2b75-616">如果尚未执行此操作，请立即完成以下操作。</span><span class="sxs-lookup"><span data-stu-id="d2b75-616">**If you have not done so already, please complete the following actions immediately.**</span></span>

### <a name="actions-for-direct-bill-partners"></a><span data-ttu-id="d2b75-617">所有直接计费合作伙伴需要执行的操作：</span><span class="sxs-lookup"><span data-stu-id="d2b75-617">Actions for direct bill partners:</span></span>
1. <span data-ttu-id="d2b75-618">通知组织中的主要利益干系人查看 Microsoft 合作伙伴协议。</span><span class="sxs-lookup"><span data-stu-id="d2b75-618">Inform key stakeholders in your organization to review the Microsoft Partner Agreement.</span></span>
2. <span data-ttu-id="d2b75-619">使用全局管理员凭据在[合作伙伴中心的云解决方案提供商概述页面](https://partner.microsoft.com/pcv/dashboard/overview)上接受 Microsoft 合作伙伴协议。</span><span class="sxs-lookup"><span data-stu-id="d2b75-619">Accept the Microsoft Partner Agreement on the [CSP Overview page on Partner Center](https://partner.microsoft.com/pcv/dashboard/overview) using Global Admin credentials.</span></span>

<span data-ttu-id="d2b75-620">可以通过[此处](https://partner.microsoft.com/resources/collection/new-microsoft-cloud-agreement-csp#/)的 CSP 库页面获取更多信息和资源。</span><span class="sxs-lookup"><span data-stu-id="d2b75-620">More information and resources are available via the CSP Gallery page [here](https://partner.microsoft.com/resources/collection/new-microsoft-cloud-agreement-csp#/).</span></span>

### <a name="actions-for-indirect-providers"></a><span data-ttu-id="d2b75-621">间接提供商需要执行的操作</span><span class="sxs-lookup"><span data-stu-id="d2b75-621">Actions for indirect providers</span></span>
1. <span data-ttu-id="d2b75-622">通知组织中的主要利益干系人查看 Microsoft 合作伙伴协议。</span><span class="sxs-lookup"><span data-stu-id="d2b75-622">Inform key stakeholders in your organization to review the Microsoft Partner Agreement.</span></span>
2. <span data-ttu-id="d2b75-623">使用全局管理员凭据在[合作伙伴中心的云解决方案提供商概述页面](https://partner.microsoft.com/pcv/dashboard/overview)上接受 Microsoft 合作伙伴协议。</span><span class="sxs-lookup"><span data-stu-id="d2b75-623">Accept the Microsoft Partner Agreement on the [CSP Overview page on Partner Center](https://partner.microsoft.com/pcv/dashboard/overview) using Global Admin credentials.</span></span>
3. <span data-ttu-id="d2b75-624">使用 [API 来验证你的间接经销商的签署状态](https://docs.microsoft.com/partner-center/develop/verify-indirect-reseller-mpa-status)。</span><span class="sxs-lookup"><span data-stu-id="d2b75-624">Use the [API to verify your indirect reseller's signing status](https://docs.microsoft.com/partner-center/develop/verify-indirect-reseller-mpa-status).</span></span>
4. <span data-ttu-id="d2b75-625">帮助你的间接经销商完成以下操作。</span><span class="sxs-lookup"><span data-stu-id="d2b75-625">Assist your indirect resellers with completing their actions below.</span></span>

<span data-ttu-id="d2b75-626">可以通过[此处](https://partner.microsoft.com/resources/collection/new-microsoft-cloud-agreement-csp#/)的 CSP 库页面获取更多信息和资源。</span><span class="sxs-lookup"><span data-stu-id="d2b75-626">More information and resources are available via the CSP Gallery page [here](https://partner.microsoft.com/resources/collection/new-microsoft-cloud-agreement-csp#/).</span></span>

<span data-ttu-id="d2b75-627">我们了解到了间接提供商在测试交易执行功能时遇到的技术问题。</span><span class="sxs-lookup"><span data-stu-id="d2b75-627">We are aware of technical issues encountered by Indirect Providers testing the transactional enforcement capabilities.</span></span> <span data-ttu-id="d2b75-628">这些问题将于 2020 年 4 月前解决。</span><span class="sxs-lookup"><span data-stu-id="d2b75-628">Those issues will be resolved by April, 2020.</span></span>

### <a name="actions-for-indirect-resellers"></a><span data-ttu-id="d2b75-629">间接经销商需要执行的操作</span><span class="sxs-lookup"><span data-stu-id="d2b75-629">Actions for indirect resellers</span></span>
1. <span data-ttu-id="d2b75-630">以间接经销商的身份[加入合作伙伴中心](https://partner.microsoft.com/resources/collection/indirect-reseller-onboarding-for-mpa-in-csp#/)，并在加入过程中接受 Microsoft 合作伙伴协议。</span><span class="sxs-lookup"><span data-stu-id="d2b75-630">[Onboard to Partner Center](https://partner.microsoft.com/resources/collection/indirect-reseller-onboarding-for-mpa-in-csp#/) as an indirect reseller and accept the Microsoft Partner Agreement as part of the onboarding process.</span></span>
2. <span data-ttu-id="d2b75-631">如果你之前已经以间接经销商的身份加入了合作伙伴中心，请使用全局管理员凭据在[合作伙伴中心仪表板](https://partner.microsoft.com/pcv/dashboard/overview)页面上接受 Microsoft 合作伙伴协议。</span><span class="sxs-lookup"><span data-stu-id="d2b75-631">If you have previously onboarded to Partner Center as an indirect reseller, accept the Microsoft Partner Agreement on the [Partner Center dashboard](https://partner.microsoft.com/pcv/dashboard/overview) page using Global Admin credentials.</span></span>
<span data-ttu-id="d2b75-632">可以通过[此处](https://partner.microsoft.com/resources/collection/indirect-reseller-onboarding-for-mpa-in-csp#/)的经销商 CSP 库页面获取特定于间接经销商的信息和资源。</span><span class="sxs-lookup"><span data-stu-id="d2b75-632">Indirect reseller specific information and resources are available via the reseller CSP Gallery page [here](https://partner.microsoft.com/resources/collection/indirect-reseller-onboarding-for-mpa-in-csp#/).</span></span>

### <a name="change-log"></a><span data-ttu-id="d2b75-633">更改日志</span><span class="sxs-lookup"><span data-stu-id="d2b75-633">Change log</span></span>

- <span data-ttu-id="d2b75-634">2020 年 1 月 14 日：发布了最初公告。</span><span class="sxs-lookup"><span data-stu-id="d2b75-634">January 14, 2020: Original announcement published.</span></span>
- <span data-ttu-id="d2b75-635">2020 年 1 月 24 日：网络研讨会系列邀请信息已于 2020 年 1 月 27 日周一更新。</span><span class="sxs-lookup"><span data-stu-id="d2b75-635">January 24, 2020: Webinar Series invites updated for w/c 27th January 2020.</span></span>
- <span data-ttu-id="d2b75-636">2020 年 1 月 31 日：网络研讨会系列邀请信息已于 2020 年 2 月更新。</span><span class="sxs-lookup"><span data-stu-id="d2b75-636">January 31, 2020: Webinar Series invites updated for February 2020.</span></span>
- <span data-ttu-id="d2b75-637">2020 年 2 月 5 日：现在需要接受 Microsoft 合作伙伴协议。</span><span class="sxs-lookup"><span data-stu-id="d2b75-637">February 5, 2020: Microsoft Partner Agreement acceptance is now required.</span></span>
- <span data-ttu-id="d2b75-638">2020 年 3 月 4 日：网络研讨会系列邀请信息已于 2020 年 3 月更新。</span><span class="sxs-lookup"><span data-stu-id="d2b75-638">March 4, 2020: Webinar Series invites updated for March 2020.</span></span>
- <span data-ttu-id="d2b75-639">2020 年 4 月 1 日：**更新** - 为了防止对业务造成任何中断，我们已决定将下一个阶段的实施延长至 2020 年 4 月之后进行。</span><span class="sxs-lookup"><span data-stu-id="d2b75-639">April 1, 2020: \*\* Update\*\* - To help prevent any disruption to business, we have decided to extend the next phase of implementation beyond April 2020.</span></span>
