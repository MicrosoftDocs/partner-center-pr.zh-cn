...
<span data-ttu-id="15c59-110">为帮助合作伙伴和客户在相互信任的基础上开展其业务，我们将邀请世界各地的合作伙伴测试对验证地址 API 的更改。</span><span class="sxs-lookup"><span data-stu-id="15c59-110">To help partners and customers run their business based on trust, we’ll be inviting partners to test changes to the Validate Address API for all countries worldwide.</span></span>
...
|<span data-ttu-id="15c59-144">未验证</span><span class="sxs-lookup"><span data-stu-id="15c59-144">Not validated</span></span> | <span data-ttu-id="15c59-145">无法通过验证过程发送地址。</span><span class="sxs-lookup"><span data-stu-id="15c59-145">Address was not able to be sent through the validation process.</span></span> | <span data-ttu-id="15c59-146">无</span><span class="sxs-lookup"><span data-stu-id="15c59-146">None</span></span> |
...
- <span data-ttu-id="15c59-173">个性化的面板，便于提高工作效率。</span><span class="sxs-lookup"><span data-stu-id="15c59-173">Personalized dashboards to increase productivity.</span></span>
...
### <a name="summary"></a><span data-ttu-id="15c59-187">总结</span><span class="sxs-lookup"><span data-stu-id="15c59-187">Summary</span></span>
...
- <span data-ttu-id="15c59-215">日期：2021-03-25</span><span class="sxs-lookup"><span data-stu-id="15c59-215">Date: 2021-03-25</span></span>
...
2. <span data-ttu-id="15c59-226">合作伙伴与以下国家/地区的新客户或现有客户开展业务：</span><span class="sxs-lookup"><span data-stu-id="15c59-226">The partner does business with new or existing customers in the following countries:</span></span>
    ...
    - <span data-ttu-id="15c59-237">沙特阿拉伯</span><span class="sxs-lookup"><span data-stu-id="15c59-237">Saudi Arabia</span></span>
...
<span data-ttu-id="15c59-271">交易永久性软件的间接提供商和直接帐单合作伙伴在云解决方案提供商计划中</span><span class="sxs-lookup"><span data-stu-id="15c59-271">Indirect providers and direct bill partners transacting perpetual software in the Cloud Solution Provider program</span></span> 
...
### <a name="categories"></a><span data-ttu-id="15c59-285">类别</span><span class="sxs-lookup"><span data-stu-id="15c59-285">Categories</span></span>
...
- <span data-ttu-id="15c59-299">新资源类型“CustomerDirectoryRole”</span><span class="sxs-lookup"><span data-stu-id="15c59-299">New resource type “CustomerDirectoryRole”</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="15c59-317">后续步骤</span><span class="sxs-lookup"><span data-stu-id="15c59-317">Next Steps</span></span>
...
### <a name="questions"></a><span data-ttu-id="15c59-346">是否有任何问题?</span><span class="sxs-lookup"><span data-stu-id="15c59-346">Questions?</span></span>  
...
<span data-ttu-id="15c59-359">2021 年 4 月 1 日的最终价目表将更新以明确 Power BI Premium Per User 产品/服务的命名和/或先决条件信息。</span><span class="sxs-lookup"><span data-stu-id="15c59-359">The April 1, 2021 final price list will be updated to add clarity to the naming and/or prerequisite information for Power BI Premium Per User offers.</span></span>
...
| ------ |----------|
| <span data-ttu-id="15c59-389">Power BI Pro（非营利组织员工定价）</span><span class="sxs-lookup"><span data-stu-id="15c59-389">Power BI Pro (Nonprofit Staff Pricing)</span></span>  |   <span data-ttu-id="15c59-390">cabdfc93-5786-4224-bfd3-35d58f833b35</span><span class="sxs-lookup"><span data-stu-id="15c59-390">cabdfc93-5786-4224-bfd3-35d58f833b35</span></span> |
...
### <a name="summary"></a><span data-ttu-id="15c59-429">总结</span><span class="sxs-lookup"><span data-stu-id="15c59-429">Summary</span></span>
...
### <a name="questions"></a><span data-ttu-id="15c59-442">是否有任何问题?</span><span class="sxs-lookup"><span data-stu-id="15c59-442">Questions?</span></span>
...
<span data-ttu-id="15c59-456">在这次数字转型的延续中，我们宣布进行以下变更：</span><span class="sxs-lookup"><span data-stu-id="15c59-456">In continuation of this digital transformation, we are announcing the following changes:</span></span>
...
_______________
## <a name="update-to-a-previous-announcement-premium-assessments-an-add-on-to-compliance-manager"></a><a name="8"></a><span data-ttu-id="15c59-468">对上一公告的更新：高级评估，合规性管理器加载项</span><span class="sxs-lookup"><span data-stu-id="15c59-468">Update to a previous announcement: Premium Assessments, an add-on to Compliance Manager</span></span>

### <a name="categories"></a><span data-ttu-id="15c59-469">类别</span><span class="sxs-lookup"><span data-stu-id="15c59-469">Categories</span></span>

- <span data-ttu-id="15c59-470">日期：2021-03-15</span><span class="sxs-lookup"><span data-stu-id="15c59-470">Date: 2021-03-15</span></span>
- <span data-ttu-id="15c59-471">拓展业务</span><span class="sxs-lookup"><span data-stu-id="15c59-471">Grow your business</span></span>

### <a name="summary"></a><span data-ttu-id="15c59-472">总结</span><span class="sxs-lookup"><span data-stu-id="15c59-472">Summary</span></span>

<span data-ttu-id="15c59-473">不得在价目表中列出试用版产品/服务，这些内容将被删除。</span><span class="sxs-lookup"><span data-stu-id="15c59-473">The trial offers shouldn’t have been listed on the price list and will be removed.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="15c59-474">影响受众</span><span class="sxs-lookup"><span data-stu-id="15c59-474">Impacted audience</span></span>

<span data-ttu-id="15c59-475">通过云解决方案提供商交易的合作伙伴</span><span class="sxs-lookup"><span data-stu-id="15c59-475">Partners transacting through Cloud Solution Provider</span></span>

### <a name="details"></a><span data-ttu-id="15c59-476">详细信息</span><span class="sxs-lookup"><span data-stu-id="15c59-476">Details</span></span>

<span data-ttu-id="15c59-477">价目表中不得包含试用版产品/服务。</span><span class="sxs-lookup"><span data-stu-id="15c59-477">The trial offers shouldn’t have been included in the price list.</span></span> <span data-ttu-id="15c59-478">这些内容将从 2021 年 5 月 1 日的价目表中删除。</span><span class="sxs-lookup"><span data-stu-id="15c59-478">These will be removed from the May 1, 2021 price list.</span></span>

<span data-ttu-id="15c59-479">如需最初公告，请查看[此处](./2021-february.md#4)。</span><span class="sxs-lookup"><span data-stu-id="15c59-479">The original announcement is [here](./2021-february.md#4).</span></span>

### <a name="additional-resources"></a><span data-ttu-id="15c59-480">其他资源</span><span class="sxs-lookup"><span data-stu-id="15c59-480">Additional resources</span></span>

- [<span data-ttu-id="15c59-481">Microsoft 365 E5 安全性和合规性</span><span class="sxs-lookup"><span data-stu-id="15c59-481">Microsoft 365 E5 security and compliance</span></span>](https://www.microsoft.com/licensing/product-licensing/microsoft-365-enterprise?activetab=m365-enterprise:primaryr5)

- [<span data-ttu-id="15c59-482">在 Microsoft 合规性管理器中生成和管理评估 - Microsoft 365 合规性</span><span class="sxs-lookup"><span data-stu-id="15c59-482">Build and manage assessments in Microsoft Compliance Manager - Microsoft 365 Compliance</span></span>](/microsoft-365/compliance/compliance-manager-assessments)

### <a name="next-steps"></a><span data-ttu-id="15c59-483">后续步骤</span><span class="sxs-lookup"><span data-stu-id="15c59-483">Next steps</span></span>

<span data-ttu-id="15c59-484">查看有关本主题的资源，并与组织内部的相关利益干系人共享此信息。</span><span class="sxs-lookup"><span data-stu-id="15c59-484">Review the resources about this topic, and share this information with the appropriate stakeholders in your organization.</span></span>

### <a name="questions"></a><span data-ttu-id="15c59-485">是否有任何问题?</span><span class="sxs-lookup"><span data-stu-id="15c59-485">Questions?</span></span>

<span data-ttu-id="15c59-486">如果对这些产品/服务有疑问，请查看相关的 Yammer 社区。</span><span class="sxs-lookup"><span data-stu-id="15c59-486">For questions about these offers, check your relevant Yammer communities.</span></span>

________________
## <a name="migrate-your-solutions-from-one-commercial-partner-ocp-go-to-market-gtm-to-the-microsoft-commercial-marketplace"></a><a name="7"></a><span data-ttu-id="15c59-487">将解决方案从 One Commercial Partner (OCP) 进入市场 (GTM) 迁移到 Microsoft 商业市场</span><span class="sxs-lookup"><span data-stu-id="15c59-487">Migrate your solutions from One Commercial Partner (OCP) go-to market (GTM) to the Microsoft commercial marketplace</span></span>

### <a name="categories"></a><span data-ttu-id="15c59-488">类别</span><span class="sxs-lookup"><span data-stu-id="15c59-488">Categories</span></span>

- <span data-ttu-id="15c59-489">日期：2021-03-12</span><span class="sxs-lookup"><span data-stu-id="15c59-489">Date: 2021-03-12</span></span>
- <span data-ttu-id="15c59-490">功能</span><span class="sxs-lookup"><span data-stu-id="15c59-490">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="15c59-491">摘要</span><span class="sxs-lookup"><span data-stu-id="15c59-491">Summary</span></span>

<span data-ttu-id="15c59-492">从 2021 年 3 月 29 日开始，你将开始体验功能受限的 One Commercial Partner (OCP) 进入市场 (GTM) 功能。</span><span class="sxs-lookup"><span data-stu-id="15c59-492">From March 29, 2021, you will begin to experience limited One Commercial Partner (OCP) go-to market (GTM) capabilities.</span></span> <span data-ttu-id="15c59-493">建议你将解决方案迁移到合作伙伴中心的商业市场。</span><span class="sxs-lookup"><span data-stu-id="15c59-493">We encourage you to migrate your solutions to the commercial marketplace in Partner Center.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="15c59-494">影响受众</span><span class="sxs-lookup"><span data-stu-id="15c59-494">Impacted audience</span></span>

<span data-ttu-id="15c59-495">在 OCP GTM 中联合销售解决方案的组织</span><span class="sxs-lookup"><span data-stu-id="15c59-495">Organizations co-selling with solutions in OCP GTM</span></span>

### <a name="details"></a><span data-ttu-id="15c59-496">详细信息</span><span class="sxs-lookup"><span data-stu-id="15c59-496">Details</span></span>

<span data-ttu-id="15c59-497">在 2020 年 12 月，我们开始了从 Microsoft OCP GTM 工具迁移到合作伙伴中心的 Microsoft 商业市场的旅程。</span><span class="sxs-lookup"><span data-stu-id="15c59-497">In December 2020, we started our journey from the Microsoft OCP GTM tool to the Microsoft commercial marketplace in Partner Center.</span></span> <span data-ttu-id="15c59-498">这次过渡扩展了商业市场的能力，你可在这里向数百万名客户展示你的解决方案、与其他 Microsoft 和合作伙伴卖方相互分享销售机会，并联手销售创新的解决方案。</span><span class="sxs-lookup"><span data-stu-id="15c59-498">This transition expands the capabilities of the commercial marketplace where you can showcase your solutions to millions of customers, bidirectionally share opportunities with other Microsoft and partner sellers, and jointly sell innovative solutions.</span></span>

<span data-ttu-id="15c59-499">本次过渡的下一里程碑举措将在 2021 年 3 月 29 日实施。</span><span class="sxs-lookup"><span data-stu-id="15c59-499">The next milestone in the transition will take place on March 29, 2021.</span></span> <span data-ttu-id="15c59-500">届时，你将开始体验功能受限的 OCP GTM 功能，其中某些方面变为只供查看。</span><span class="sxs-lookup"><span data-stu-id="15c59-500">That’s when you’ll begin to experience limited OCP GTM capabilities, with some fields becoming read-only.</span></span> <span data-ttu-id="15c59-501">如果你当前正在 OCP GTM 中联合销售解决方案，建议你将解决方案迁移到商业市场来利用该市场中的功能并简化你的发布体验。</span><span class="sxs-lookup"><span data-stu-id="15c59-501">If you’re currently co-selling with solutions in OCP GTM, we encourage you to migrate your solutions to the commercial marketplace to take advantage of its capabilities and simplify your publishing experience.</span></span>

<span data-ttu-id="15c59-502">移到商业市场后，合作伙伴中心就成为了获取联合销售发布体验的主要位置。</span><span class="sxs-lookup"><span data-stu-id="15c59-502">Moving to the commercial marketplace makes Partner Center the primary destination for the co-sell publishing experience.</span></span> <span data-ttu-id="15c59-503">在这里，你可通过与我们对 Microsoft 产品使用的一样的通道和产品内体验将你的解决方案推广给我们共同的客户，从而继续发展你的业务。</span><span class="sxs-lookup"><span data-stu-id="15c59-503">It’s where you can continue to grow your business by connecting your solutions with our shared customers through the same channels and in-product experiences that we use for Microsoft products.</span></span> <span data-ttu-id="15c59-504">[详细了解商业市场](https://blogs.partner.microsoft.com/mpn/getting-started-with-the-microsoft-commercial-marketplace/)。</span><span class="sxs-lookup"><span data-stu-id="15c59-504">[Learn more about the commercial marketplace](https://blogs.partner.microsoft.com/mpn/getting-started-with-the-microsoft-commercial-marketplace/).</span></span>

### <a name="next-steps"></a><span data-ttu-id="15c59-505">后续步骤</span><span class="sxs-lookup"><span data-stu-id="15c59-505">Next steps</span></span>

- <span data-ttu-id="15c59-506">如果你尚未移动解决方案，请按照[过渡指南](/azure/marketplace/co-sell-solution-migration)中详述的说明或查看[视频分步教程](https://partner.microsoft.com/asset/detail/ocp-gtm-to-the-microsoft-commercial-marketplace-mp4)，来完成各项迁移活动并开始在商业市场发布你的解决方案。</span><span class="sxs-lookup"><span data-stu-id="15c59-506">If you have not yet moved your solutions, follow the instructions detailed in the [transition guide](/azure/marketplace/co-sell-solution-migration) or view the [step-by-step video tutorial](https://partner.microsoft.com/asset/detail/ocp-gtm-to-the-microsoft-commercial-marketplace-mp4) to complete all migration activities and start publishing your solution(s) in the commercial marketplace.</span></span>

- <span data-ttu-id="15c59-507">如果对 OCP GTM 中的受限功能体验存有疑问，请查看[在 Microsoft 商业市场中发布内容的联合销售要求常见问题解答](https://partner.microsoft.com/resources/detail/co-sell-requirements-publish-commercial-marketplace-faq-pdf)。</span><span class="sxs-lookup"><span data-stu-id="15c59-507">For questions regarding the limited capability experience in OCP GTM, view the [Co-sell requirements to publish in the Microsoft commercial marketplace FAQ](https://partner.microsoft.com/resources/detail/co-sell-requirements-publish-commercial-marketplace-faq-pdf).</span></span> <span data-ttu-id="15c59-508">（请查看“从 2021 年 3 月 29 日起推出 OCP GTM 受限功能”部分。）</span><span class="sxs-lookup"><span data-stu-id="15c59-508">(See the section “OCP GTM limited capabilities starting March 29, 2021.”)</span></span>

### <a name="questions"></a><span data-ttu-id="15c59-509">是否有任何问题?</span><span class="sxs-lookup"><span data-stu-id="15c59-509">Questions?</span></span>

<span data-ttu-id="15c59-510">如有任何疑问或需要更多信息，请联系[支持人员](https://partner.microsoft.com/support/?stage=1) 。</span><span class="sxs-lookup"><span data-stu-id="15c59-510">Contact [Support](https://partner.microsoft.com/support/?stage=1) if you have any questions or need more information.</span></span>

________________
## <a name="programmatic-access-to-commercial-marketplace-analytics"></a><a name="6"></a><span data-ttu-id="15c59-511">以编程方式访问商业市场分析</span><span class="sxs-lookup"><span data-stu-id="15c59-511">Programmatic access to commercial marketplace analytics</span></span>

### <a name="categories"></a><span data-ttu-id="15c59-512">类别</span><span class="sxs-lookup"><span data-stu-id="15c59-512">Categories</span></span>

- <span data-ttu-id="15c59-513">日期：2021-03-10</span><span class="sxs-lookup"><span data-stu-id="15c59-513">Date: 2021-03-10</span></span>
- <span data-ttu-id="15c59-514">功能</span><span class="sxs-lookup"><span data-stu-id="15c59-514">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="15c59-515">摘要</span><span class="sxs-lookup"><span data-stu-id="15c59-515">Summary</span></span>

<span data-ttu-id="15c59-516">合作伙伴现在可以通过编程方式访问分析报表，以监视销售情况，评估绩效，并优化商业市场中的产品/服务。</span><span class="sxs-lookup"><span data-stu-id="15c59-516">Partners can now programmatically access analytics reports to monitor sales, evaluate performance, and optimize offers in the commercial marketplace.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="15c59-517">影响受众</span><span class="sxs-lookup"><span data-stu-id="15c59-517">Impacted audience</span></span>

<span data-ttu-id="15c59-518">在商业市场中提供产品/服务的合作伙伴。</span><span class="sxs-lookup"><span data-stu-id="15c59-518">Partners with offers in the commercial marketplace.</span></span>

### <a name="details"></a><span data-ttu-id="15c59-519">详细信息</span><span class="sxs-lookup"><span data-stu-id="15c59-519">Details</span></span>

<span data-ttu-id="15c59-520">通过用于访问商业市场报表的 API 能够以异步方式计划分析数据的自定义报表。</span><span class="sxs-lookup"><span data-stu-id="15c59-520">The API for accessing commercial marketplace reports enable you to schedule custom reports of your analytics data asynchronously.</span></span>

<span data-ttu-id="15c59-521">利用此功能，可以根据需求定义报告查询和模板，制定计划，并按计划的间隔获得及时且可信的报表。</span><span class="sxs-lookup"><span data-stu-id="15c59-521">The capability enables you to define reporting queries and templates based on your needs, set a schedule, and get timely and trustworthy reports at scheduled intervals.</span></span>

### <a name="next-steps"></a><span data-ttu-id="15c59-522">后续步骤</span><span class="sxs-lookup"><span data-stu-id="15c59-522">Next steps</span></span>

<span data-ttu-id="15c59-523">若要了解详细信息，请参阅[开始以编程方式访问分析](/azure/marketplace/analytics-get-started)。</span><span class="sxs-lookup"><span data-stu-id="15c59-523">To learn more, see [Get started with programmatic access to analytics](/azure/marketplace/analytics-get-started).</span></span>

### <a name="questions"></a><span data-ttu-id="15c59-524">是否有任何问题?</span><span class="sxs-lookup"><span data-stu-id="15c59-524">Questions?</span></span>

<span data-ttu-id="15c59-525">如果还有其他问题，请联系[支持部门](https://go.microsoft.com/fwlink/?linkid=2165533)。</span><span class="sxs-lookup"><span data-stu-id="15c59-525">Contact [Support](https://go.microsoft.com/fwlink/?linkid=2165533) if you have any further questions.</span></span>

________________
## <a name="expanding-the-new-commerce-experience-in-the-cloud-solution-provider-csp-program-for-azure-to-russia"></a><a name="5"></a><span data-ttu-id="15c59-526">将 Azure 的云解决方案提供商 (CSP) 计划中新推出的商业体验扩展到俄罗斯</span><span class="sxs-lookup"><span data-stu-id="15c59-526">Expanding the new commerce experience in the Cloud Solution Provider (CSP) program for Azure to Russia</span></span>

### <a name="categories"></a><span data-ttu-id="15c59-527">类别</span><span class="sxs-lookup"><span data-stu-id="15c59-527">Categories</span></span>

- <span data-ttu-id="15c59-528">日期：2021-03-10</span><span class="sxs-lookup"><span data-stu-id="15c59-528">Date: 2021-03-10</span></span>
- <span data-ttu-id="15c59-529">功能</span><span class="sxs-lookup"><span data-stu-id="15c59-529">Capabilities</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="15c59-530">影响受众</span><span class="sxs-lookup"><span data-stu-id="15c59-530">Impacted audience</span></span>

<span data-ttu-id="15c59-531">参与云解决方案提供商 (CSP) 计划的所有俄罗斯的合作伙伴。</span><span class="sxs-lookup"><span data-stu-id="15c59-531">All partners in Russia transacting through the Cloud Solution Provider (CSP) program.</span></span>

### <a name="details"></a><span data-ttu-id="15c59-532">详细信息</span><span class="sxs-lookup"><span data-stu-id="15c59-532">Details</span></span>

<span data-ttu-id="15c59-533">我们很高兴宣布，从 2021 年 3 月 10 日起在俄罗斯的 CSP for Azure 中推出新的商业体验。</span><span class="sxs-lookup"><span data-stu-id="15c59-533">Starting March 10 2021, we’re excited to announce the availability of the **new commerce experience in CSP for Azure in Russia**.</span></span> <span data-ttu-id="15c59-534">此体验将简化和改进客户购买及使用 Azure 服务的方式。</span><span class="sxs-lookup"><span data-stu-id="15c59-534">This experience will streamline and improve the way customers buy and consume Azure services.</span></span> <span data-ttu-id="15c59-535">通过它，已加入 CSP 计划的合作伙伴可查看各销售活动中 Azure 定价的一致视图、获取美元定价（它可确保全球价格一致）、确保计费日期一致并访问 Azure 成本管理功能。</span><span class="sxs-lookup"><span data-stu-id="15c59-535">It will also give partners in the CSP program a consistent view of Azure pricing across sales motions, USD pricing for global consistency, billing date alignment, and access to Azure Cost Management.</span></span>

### <a name="next-steps"></a><span data-ttu-id="15c59-536">后续步骤</span><span class="sxs-lookup"><span data-stu-id="15c59-536">Next steps</span></span>

<span data-ttu-id="15c59-537">提供了有多项资源，它们引入了新的 Azure 商业体验并提供其他信息。</span><span class="sxs-lookup"><span data-stu-id="15c59-537">There are several resources available introducing the new Azure commerce experience and providing additional information.</span></span> <span data-ttu-id="15c59-538">有关最新的常见问题解答、宣传资料和视频等内容，可查看 [CSP 计划更新资源库](https://partner.microsoft.com/resources/collection/new-azure-experience-in-csp#/).。</span><span class="sxs-lookup"><span data-stu-id="15c59-538">Find the latest FAQs, decks, video and more in the [CSP Program Updates Resource Gallery](https://partner.microsoft.com/resources/collection/new-azure-experience-in-csp#/).</span></span>

________________
## <a name="partner-center-software-license-key-and-download-fulfillment"></a><a name="4"></a><span data-ttu-id="15c59-539">合作伙伴中心软件许可证密钥和下载履行</span><span class="sxs-lookup"><span data-stu-id="15c59-539">Partner Center software license key and download fulfillment</span></span>

### <a name="categories"></a><span data-ttu-id="15c59-540">类别</span><span class="sxs-lookup"><span data-stu-id="15c59-540">Categories</span></span>

- <span data-ttu-id="15c59-541">日期：2021-03-04</span><span class="sxs-lookup"><span data-stu-id="15c59-541">Date: 2021-03-04</span></span>
- <span data-ttu-id="15c59-542">功能</span><span class="sxs-lookup"><span data-stu-id="15c59-542">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="15c59-543">摘要</span><span class="sxs-lookup"><span data-stu-id="15c59-543">Summary</span></span>

<span data-ttu-id="15c59-544">现已恢复合作伙伴中心软件下载和许可证密钥履行功能。</span><span class="sxs-lookup"><span data-stu-id="15c59-544">The Partner Center software download and license key fulfillment capability has been reinstated.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="15c59-545">影响受众</span><span class="sxs-lookup"><span data-stu-id="15c59-545">Impacted audience</span></span>

<span data-ttu-id="15c59-546">通过合作伙伴中心处理永久性和服务器订阅软件订单的所有云解决方案提供商 (CSP) 合作伙伴</span><span class="sxs-lookup"><span data-stu-id="15c59-546">All Cloud Solution Provider (CSP) partners transacting perpetual and server subscription software orders through Partner Center</span></span>

### <a name="details"></a><span data-ttu-id="15c59-547">详细信息</span><span class="sxs-lookup"><span data-stu-id="15c59-547">Details</span></span>

<span data-ttu-id="15c59-548">为了回应合作伙伴反馈，我们将恢复合作伙伴中心履行功能，你可为永久性和服务器订阅软件订单获取软件和许可证密钥。</span><span class="sxs-lookup"><span data-stu-id="15c59-548">In response to partner feedback, we’re reinstating the Partner Center fulfillment capability to obtain software and license keys for perpetual and server subscription software orders.</span></span> <span data-ttu-id="15c59-549">此功能会还原到其之前的状态，然后在 2021 年 1 月 19 日被移除。</span><span class="sxs-lookup"><span data-stu-id="15c59-549">It will be restored to its previous state prior to being removed on January 19, 2021.</span></span> <span data-ttu-id="15c59-550">（请查看[公告](2020-september.md#17)。）</span><span class="sxs-lookup"><span data-stu-id="15c59-550">(See the [announcement](2020-september.md#17).)</span></span>

<span data-ttu-id="15c59-551">请注意，软件许可证密钥和下载链接是宝贵且受到热烈追捧的知识产权资产。</span><span class="sxs-lookup"><span data-stu-id="15c59-551">Note that software license keys and download links are valuable and highly sought-after intellectual property assets.</span></span> <span data-ttu-id="15c59-552">如果遭到泄露，其激活限制可能很快就被会耗尽，导致出现负面的客户和合作伙伴体验。</span><span class="sxs-lookup"><span data-stu-id="15c59-552">If leaked, they can quickly be depleted of their activation limits and cause a negative customer and partner experience.</span></span>

### <a name="next-steps"></a><span data-ttu-id="15c59-553">后续步骤</span><span class="sxs-lookup"><span data-stu-id="15c59-553">Next steps</span></span>

<span data-ttu-id="15c59-554">请查看下列资源，了解有关软件密钥分发的使用说明和重要指导：</span><span class="sxs-lookup"><span data-stu-id="15c59-554">Review the following resources for usage instructions and important guidance on software key distribution:</span></span>

- [<span data-ttu-id="15c59-555">通过 CSP 计划出售本地软件</span><span class="sxs-lookup"><span data-stu-id="15c59-555">Sell on-premises software through the CSP program</span></span>](../csp-on-premise-software.md)
- <span data-ttu-id="15c59-556">[合作伙伴中心新版商业操作指南](https://partner.microsoft.com/resources/detail/partner-center-new-commerce-operations-guide-pdf)（请查看“软件密钥分发指导”部分。）</span><span class="sxs-lookup"><span data-stu-id="15c59-556">[Partner Center New Commerce Operations Guide](https://partner.microsoft.com/resources/detail/partner-center-new-commerce-operations-guide-pdf) (See the **Guidance on Software Key Distribution** section.)</span></span>

### <a name="questions"></a><span data-ttu-id="15c59-557">是否有任何问题?</span><span class="sxs-lookup"><span data-stu-id="15c59-557">Questions?</span></span>

<span data-ttu-id="15c59-558">如果对此通知还有其他疑问，请访问相关的 Yammer 社区。</span><span class="sxs-lookup"><span data-stu-id="15c59-558">If you have any further questions about this notice, check your relevant Yammer communities.</span></span>

________________
## <a name="migrate-your-deals-from-partner-sales-connect-psc-to-partner-center"></a><a name="3"></a><span data-ttu-id="15c59-559">将交易从 Partner Sales Connect (PSC) 迁移到合作伙伴中心</span><span class="sxs-lookup"><span data-stu-id="15c59-559">Migrate your deals from Partner Sales Connect (PSC) to Partner Center</span></span>

### <a name="categories"></a><span data-ttu-id="15c59-560">类别</span><span class="sxs-lookup"><span data-stu-id="15c59-560">Categories</span></span>

- <span data-ttu-id="15c59-561">日期：2021-03-04</span><span class="sxs-lookup"><span data-stu-id="15c59-561">Date: 2021-03-04</span></span>
- <span data-ttu-id="15c59-562">功能</span><span class="sxs-lookup"><span data-stu-id="15c59-562">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="15c59-563">摘要</span><span class="sxs-lookup"><span data-stu-id="15c59-563">Summary</span></span>

<span data-ttu-id="15c59-564">自 2021 年 3 月 31 日起，将只能以只读方式访问 Partner Sales Connect (PSC)，因此请开始将你在 PSC 中的交易迁移到合作伙伴中心。</span><span class="sxs-lookup"><span data-stu-id="15c59-564">Partner Sales Connect (PSC) will move to read-only access starting March 31, 2021, so we urge you to begin migrating your deals from PSC to Partner Center.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="15c59-565">影响受众</span><span class="sxs-lookup"><span data-stu-id="15c59-565">Impacted audience</span></span>

<span data-ttu-id="15c59-566">在 PSC 中具有交易的合作伙伴</span><span class="sxs-lookup"><span data-stu-id="15c59-566">Partners with deals in PSC</span></span>

### <a name="details"></a><span data-ttu-id="15c59-567">详细信息</span><span class="sxs-lookup"><span data-stu-id="15c59-567">Details</span></span>

<span data-ttu-id="15c59-568">作为我们共同的发展承诺的一部分，与 Microsoft 联合销售让你能够被发现、表现你的专业知识并扩大客户群体来获得积极的客户成果 。</span><span class="sxs-lookup"><span data-stu-id="15c59-568">As part of our shared commitment to growth, **co-sell with Microsoft** is the path for you to **be discovered, deliver your expertise, and expand your customer footprint** for positive customer outcomes.</span></span> <span data-ttu-id="15c59-569">在合作伙伴中心管理你的联合销售体验将使平均交易时间比平时快 3.5 倍，让你能够跨直接客户、合作伙伴和 Microsoft 卖家渠道进行销售，并在一个位置管理你的整个推荐管道。</span><span class="sxs-lookup"><span data-stu-id="15c59-569">With an average deal that’s **3.5 times faster** than normal, managing your co-sell experience in Partner Center allows you to sell across the direct customer, partner, and Microsoft seller channels, and manage your entire referral pipeline in one location.</span></span>

<span data-ttu-id="15c59-570">自 2021 年 3 月 31 日起，将只能以只读方式访问 PSC，因此请开始迁移到合作伙伴中心，获取下列功能改进  ：</span><span class="sxs-lookup"><span data-stu-id="15c59-570">**PSC** will move to **read-only access** starting **March 31, 2021**, so we urge you to start your move to Partner Center and access these capability improvements:</span></span> 

- <span data-ttu-id="15c59-571">根据你需要的协助类型，更准确地将你与 Microsoft 共享的交易引导给适当的卖家。</span><span class="sxs-lookup"><span data-stu-id="15c59-571">**More accurate routing** of the deals that you share with Microsoft to the right seller, based on the type of assistance you need.</span></span>
- <span data-ttu-id="15c59-572">对符合激励计划的解决方案的前期交易资格验证，目的是满足 ISV Connect 计划标准，从而简化审批过程和最终的执行证明 (POE)。</span><span class="sxs-lookup"><span data-stu-id="15c59-572">**Upfront deal eligibility validation** for incentive-eligible solutions and to meet the ISV Connect program criteria, simplifying the approval process and final proof of execution (POE) attestation.</span></span>
- <span data-ttu-id="15c59-573">无缝的用户体验，可在一个位置管理你的联合销售机会和销售合格潜在客户。</span><span class="sxs-lookup"><span data-stu-id="15c59-573">**Seamless user experience** to manage all your co-sell opportunities and sales qualified leads in one place.</span></span>

<span data-ttu-id="15c59-574">我们最近还在合作伙伴中心增添了新的功能来帮助你进行迁移：</span><span class="sxs-lookup"><span data-stu-id="15c59-574">We’ve also recently added new features in Partner Center to assist in your move:</span></span>

- [<span data-ttu-id="15c59-575">针对联合销售机会的批量操作</span><span class="sxs-lookup"><span data-stu-id="15c59-575">Bulk operations for co-sell opportunities</span></span>](../bulk-operations.md)
- <span data-ttu-id="15c59-576">[交易迁移功能](../psc-to-pc.md)（请查看“PSC 交易迁移”部分。）</span><span class="sxs-lookup"><span data-stu-id="15c59-576">[Deal migration feature](../psc-to-pc.md) (See the **PSC Deals migration** section.)</span></span>

<span data-ttu-id="15c59-577">借助合作伙伴中心的联合销售体验，你的销售团队将有更多时间专注于培养潜在客户、创造机会、达成交易和建立持久的客户关系。</span><span class="sxs-lookup"><span data-stu-id="15c59-577">Using the co-sell experience in Partner Center, your sales teams will have more time to focus on nurturing leads and opportunities, closing deals, and creating lasting customer relationships.</span></span>

### <a name="next-steps"></a><span data-ttu-id="15c59-578">后续步骤</span><span class="sxs-lookup"><span data-stu-id="15c59-578">Next steps</span></span>

<span data-ttu-id="15c59-579">使用合作伙伴中心[过渡指南](../psc-to-pc.md)引导自己完成将交易从 PSC 迁移到合作伙伴中心的步骤。</span><span class="sxs-lookup"><span data-stu-id="15c59-579">Use the Partner Center [transition guide](../psc-to-pc.md) to walk you through the steps to migrate your deals from PSC to Partner Center.</span></span>

### <a name="questions"></a><span data-ttu-id="15c59-580">是否有任何问题?</span><span class="sxs-lookup"><span data-stu-id="15c59-580">Questions?</span></span>

<span data-ttu-id="15c59-581">如果还有其他疑问，请联系[支持部门](https://partner.microsoft.com/support/?stage=1)。</span><span class="sxs-lookup"><span data-stu-id="15c59-581">For any further questions, contact [Support](https://partner.microsoft.com/support/?stage=1).</span></span>

________________
## <a name="new-microsoft-dynamics-365-products-and-offers-available-on-april-1-2021"></a><a name="2"></a><span data-ttu-id="15c59-582">将于 2021 年 4 月 1 日推出的新增 Microsoft Dynamics 365 产品和服务</span><span class="sxs-lookup"><span data-stu-id="15c59-582">New Microsoft Dynamics 365 products and offers available on April 1, 2021</span></span>

### <a name="categories"></a><span data-ttu-id="15c59-583">类别</span><span class="sxs-lookup"><span data-stu-id="15c59-583">Categories</span></span>

- <span data-ttu-id="15c59-584">日期：2021-03-04</span><span class="sxs-lookup"><span data-stu-id="15c59-584">Date: 2021-03-04</span></span>
- <span data-ttu-id="15c59-585">功能</span><span class="sxs-lookup"><span data-stu-id="15c59-585">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="15c59-586">摘要</span><span class="sxs-lookup"><span data-stu-id="15c59-586">Summary</span></span>

<span data-ttu-id="15c59-587">在 2021 年 4 月 1 日，Microsoft 将对云解决方案提供商 (CSP) 计划推出几项新的产品和服务。</span><span class="sxs-lookup"><span data-stu-id="15c59-587">On April 1, 2021, Microsoft will be launching several new products and offers for the Cloud Solution Provider (CSP) program.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="15c59-588">影响受众</span><span class="sxs-lookup"><span data-stu-id="15c59-588">Impacted audience</span></span>

<span data-ttu-id="15c59-589">参与云解决方案提供商 (CSP) 计划的所有合作伙伴</span><span class="sxs-lookup"><span data-stu-id="15c59-589">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="details"></a><span data-ttu-id="15c59-590">详细信息</span><span class="sxs-lookup"><span data-stu-id="15c59-590">Details</span></span>

<span data-ttu-id="15c59-591">在 2021 年 4 月 1 日，Microsoft 将推出下列新产品和服务：</span><span class="sxs-lookup"><span data-stu-id="15c59-591">On April 1, 2021, Microsoft will be launching the following new products and offers:</span></span>

- <span data-ttu-id="15c59-592">Power BI Premium Per User</span><span class="sxs-lookup"><span data-stu-id="15c59-592">Power BI Premium Per User</span></span>
- <span data-ttu-id="15c59-593">Customer Voice 和 Marketing USL 地域和细分市场拓展</span><span class="sxs-lookup"><span data-stu-id="15c59-593">Customer Voice and Marketing USL geo and segment expansion</span></span>

<span data-ttu-id="15c59-594">**Power BI Premium Per User**</span><span class="sxs-lookup"><span data-stu-id="15c59-594">**Power BI Premium Per User**</span></span>

<span data-ttu-id="15c59-595">Microsoft 将引入首批 Power BI Premium 每用户产品/服务。</span><span class="sxs-lookup"><span data-stu-id="15c59-595">Microsoft will introduce the first per-user Power BI Premium offers.</span></span> <span data-ttu-id="15c59-596">目前仅在容量构造中出售 Power BI Premium。</span><span class="sxs-lookup"><span data-stu-id="15c59-596">Power BI Premium is currently sold only in a capacity construct.</span></span> <span data-ttu-id="15c59-597">通过 Power BI Premium Per User，可访问企业商业智能 (BI) 和分析功能。</span><span class="sxs-lookup"><span data-stu-id="15c59-597">Power BI Premium Per User provides access to enterprise business intelligence (BI) and analytics capabilities.</span></span> <span data-ttu-id="15c59-598">其灵活的个人席位许可很适合中小型企业。</span><span class="sxs-lookup"><span data-stu-id="15c59-598">Its flexible individual seat licensing caters to small and medium-sized businesses.</span></span>

<span data-ttu-id="15c59-599">若要详细了解此产品/服务，请查看 [Power BI 发布详细信息](/power-platform-release-plan/2020wave2/power-bi/planned-features)。</span><span class="sxs-lookup"><span data-stu-id="15c59-599">Review the [Power BI release details](/power-platform-release-plan/2020wave2/power-bi/planned-features) to learn more about this offer.</span></span>


<span data-ttu-id="15c59-600">**产品/服务详细信息**</span><span class="sxs-lookup"><span data-stu-id="15c59-600">**Offer details**</span></span>

<span data-ttu-id="15c59-601">请注意，产品/服务名称与价目表预览中的略有不同。</span><span class="sxs-lookup"><span data-stu-id="15c59-601">Note that the offer name differs slightly from the price list preview.</span></span>

| <span data-ttu-id="15c59-602">产品名称</span><span class="sxs-lookup"><span data-stu-id="15c59-602">Offer name</span></span> | <span data-ttu-id="15c59-603">产品/服务 ID</span><span class="sxs-lookup"><span data-stu-id="15c59-603">Offer ID</span></span> |
| ------ |----------- |
| <span data-ttu-id="15c59-604">Power BI Premium Per User</span><span class="sxs-lookup"><span data-stu-id="15c59-604">Power BI Premium Per User</span></span> | <span data-ttu-id="15c59-605">9c810018-9356-4903-95ab-eeb956289290</span><span class="sxs-lookup"><span data-stu-id="15c59-605">9c810018-9356-4903-95ab-eeb956289290</span></span> | 
| <span data-ttu-id="15c59-606">Power BI Premium Per User 教职员工版</span><span class="sxs-lookup"><span data-stu-id="15c59-606">Power BI Premium Per User for Faculty</span></span> | <span data-ttu-id="15c59-607">3affc44f-f372-4ad5-8657-aadd9574fce0</span><span class="sxs-lookup"><span data-stu-id="15c59-607">3affc44f-f372-4ad5-8657-aadd9574fce0</span></span> | 
| <span data-ttu-id="15c59-608">Power BI Premium Per User 学生版</span><span class="sxs-lookup"><span data-stu-id="15c59-608">Power BI Premium Per User for Students</span></span> | <span data-ttu-id="15c59-609">657eea87-d0b0-4c89-8c8e-9b04395bd940</span><span class="sxs-lookup"><span data-stu-id="15c59-609">657eea87-d0b0-4c89-8c8e-9b04395bd940</span></span> | 
| <span data-ttu-id="15c59-610">Power BI Premium Per User（非营利组织员工定价）</span><span class="sxs-lookup"><span data-stu-id="15c59-610">Power BI Premium Per User (Nonprofit Staff Pricing)</span></span> | <span data-ttu-id="15c59-611">7a0a856c-059f-45dd-9d26-ae27992e706a</span><span class="sxs-lookup"><span data-stu-id="15c59-611">7a0a856c-059f-45dd-9d26-ae27992e706a</span></span> | 
| <span data-ttu-id="15c59-612">Power BI Premium Per User 加载项</span><span class="sxs-lookup"><span data-stu-id="15c59-612">Power BI Premium Per User Add-On</span></span> | <span data-ttu-id="15c59-613">244ff87e-5925-44a0-bf31-cea189719b58</span><span class="sxs-lookup"><span data-stu-id="15c59-613">244ff87e-5925-44a0-bf31-cea189719b58</span></span> | 
| <span data-ttu-id="15c59-614">Power BI Premium Per User 加载项教职员工版</span><span class="sxs-lookup"><span data-stu-id="15c59-614">Power BI Premium Per User Add-On for Faculty</span></span> | <span data-ttu-id="15c59-615">5da849bd-b8f7-4340-b4f4-3a9eaeb8987e</span><span class="sxs-lookup"><span data-stu-id="15c59-615">5da849bd-b8f7-4340-b4f4-3a9eaeb8987e</span></span> | 
| <span data-ttu-id="15c59-616">Power BI Premium Per User 加载项学生版</span><span class="sxs-lookup"><span data-stu-id="15c59-616">Power BI Premium Per User Add-On for Students</span></span> | <span data-ttu-id="15c59-617">cf62d70d-5af5-422a-bda8-97936402ac8e</span><span class="sxs-lookup"><span data-stu-id="15c59-617">cf62d70d-5af5-422a-bda8-97936402ac8e</span></span> | 
| <span data-ttu-id="15c59-618">Power BI Premium Per User 加载项（非营利组织员工定价）</span><span class="sxs-lookup"><span data-stu-id="15c59-618">Power BI Premium Per User Add-On (Nonprofit Staff Pricing)</span></span> | <span data-ttu-id="15c59-619">31c03289-47ab-4ab0-8df1-03742c127ac6</span><span class="sxs-lookup"><span data-stu-id="15c59-619">31c03289-47ab-4ab0-8df1-03742c127ac6</span></span> | 

<span data-ttu-id="15c59-620">**Customer Voice 和 Marketing USL 地域和细分市场拓展**</span><span class="sxs-lookup"><span data-stu-id="15c59-620">**Customer Voice and Marketing USL geo and segment expansion**</span></span>

<span data-ttu-id="15c59-621">作为 2020 年 12 月发布的后续，Dynamics 365 Customer Voice 和 Marketing USL 产品/服务进行了更改，现增添新的国家/地区和更多非营利及教育 SKU。</span><span class="sxs-lookup"><span data-stu-id="15c59-621">As a follow-up to the December 2020 launch, Dynamics 365 Customer Voice and Marketing USL offers have been changed to add new countries and more nonprofit and educational SKUs.</span></span>

| <span data-ttu-id="15c59-622">产品名称</span><span class="sxs-lookup"><span data-stu-id="15c59-622">Offer name</span></span> | <span data-ttu-id="15c59-623">产品/服务 ID</span><span class="sxs-lookup"><span data-stu-id="15c59-623">Offer ID</span></span> |
| ------ |----------- |
| <span data-ttu-id="15c59-624">Dynamics 365 Customer Voice USL（非营利组织员工定价）</span><span class="sxs-lookup"><span data-stu-id="15c59-624">Dynamics 365 Customer Voice USL (Nonprofit Staff Pricing)</span></span> | <span data-ttu-id="15c59-625">7a8642a5-481e-4906-a642-b56dbeeb62a0</span><span class="sxs-lookup"><span data-stu-id="15c59-625">7a8642a5-481e-4906-a642-b56dbeeb62a0</span></span> |
| <span data-ttu-id="15c59-626">Dynamics 365 Customer Voice USL 教职员工版</span><span class="sxs-lookup"><span data-stu-id="15c59-626">Dynamics 365 Customer Voice USL for Faculty</span></span> | <span data-ttu-id="15c59-627">85162d70-9676-4cf6-a4bc-a0d6672f2657</span><span class="sxs-lookup"><span data-stu-id="15c59-627">85162d70-9676-4cf6-a4bc-a0d6672f2657</span></span> |

<span data-ttu-id="15c59-628">请访问以下页面，详细了解这些产品/服务：</span><span class="sxs-lookup"><span data-stu-id="15c59-628">Visit the following pages to find out more about these offers:</span></span>

- [<span data-ttu-id="15c59-629">Dynamics 365 Customer Service Voice 主页</span><span class="sxs-lookup"><span data-stu-id="15c59-629">Dynamics 365 Customer Service Voice home page</span></span>](https://dynamics.microsoft.com/customer-voice/overview/)
- [<span data-ttu-id="15c59-630">Dynamics 365 Marketing 主页</span><span class="sxs-lookup"><span data-stu-id="15c59-630">Dynamics 365 Marketing home page</span></span>](https://dynamics.microsoft.com/customer-voice/overview/)

### <a name="next-steps"></a><span data-ttu-id="15c59-631">后续步骤</span><span class="sxs-lookup"><span data-stu-id="15c59-631">Next steps</span></span>

<span data-ttu-id="15c59-632">请查看此主题的相关资源，与组织中的适当利益干系人分享此信息。</span><span class="sxs-lookup"><span data-stu-id="15c59-632">Review the resources on this topic, and share this information with the appropriate stakeholders in your organization.</span></span>  

### <a name="questions"></a><span data-ttu-id="15c59-633">是否有任何问题?</span><span class="sxs-lookup"><span data-stu-id="15c59-633">Questions?</span></span>

<span data-ttu-id="15c59-634">如果对这些产品/服务有任何疑问，请查看相关的 Yammer 社区。</span><span class="sxs-lookup"><span data-stu-id="15c59-634">For any questions about these offers, check your relevant Yammer communities.</span></span> 

________________
## <a name="microsoft-universal-print-now-available-in-some-suites"></a><a name="1"></a><span data-ttu-id="15c59-635">现已在部分套件中提供 Microsoft 通用打印服务</span><span class="sxs-lookup"><span data-stu-id="15c59-635">Microsoft Universal Print now available in some suites</span></span>

### <a name="categories"></a><span data-ttu-id="15c59-636">类别</span><span class="sxs-lookup"><span data-stu-id="15c59-636">Categories</span></span>

- <span data-ttu-id="15c59-637">日期：2021-03-03</span><span class="sxs-lookup"><span data-stu-id="15c59-637">Date: 2021-03-03</span></span>
- <span data-ttu-id="15c59-638">功能</span><span class="sxs-lookup"><span data-stu-id="15c59-638">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="15c59-639">摘要</span><span class="sxs-lookup"><span data-stu-id="15c59-639">Summary</span></span>

<span data-ttu-id="15c59-640">从 2021 年 3 月 1 日起，可在特选 Microsoft 365 套件中或以独立加载项的形式办理 Microsoft 通用打印服务。</span><span class="sxs-lookup"><span data-stu-id="15c59-640">Microsoft Universal Print will be available to transact within select Microsoft 365 suites and as a standalone add-on from March 1, 2021.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="15c59-641">影响受众</span><span class="sxs-lookup"><span data-stu-id="15c59-641">Impacted audience</span></span>

<span data-ttu-id="15c59-642">参与云解决方案提供商 (CSP) 计划的所有合作伙伴</span><span class="sxs-lookup"><span data-stu-id="15c59-642">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="details"></a><span data-ttu-id="15c59-643">详细信息</span><span class="sxs-lookup"><span data-stu-id="15c59-643">Details</span></span>

<span data-ttu-id="15c59-644">[通用打印](https://aka.ms/universalprint)是一项 Microsoft 365 打印服务，它让你不再需要本地打印服务器，还使 Windows 设备能够打印到注册了 Azure 的打印机。</span><span class="sxs-lookup"><span data-stu-id="15c59-644">[Universal Print](https://aka.ms/universalprint) is a Microsoft 365 print service that removes the need for on-premises print servers, and enables Windows devices to print to Azure-registered printers.</span></span> <span data-ttu-id="15c59-645">自 2021 年 3 月 1 日起可办理此功能。</span><span class="sxs-lookup"><span data-stu-id="15c59-645">It will be available to transact from March 1, 2021.</span></span>

<span data-ttu-id="15c59-646">免用驱动程序的打印、基于位置轻松发现打印机，以及无需累积学习的直观打印体验，这些都使员工受益匪浅。</span><span class="sxs-lookup"><span data-stu-id="15c59-646">Workers benefit from driverless printing, streamlined location-based printer discovery, and an intuitive printing experience with no learning curve.</span></span> <span data-ttu-id="15c59-647">已加入 Azure Active Directory (Azure AD) 的设备使用现有的 Azure AD 凭据安全地进行打印。</span><span class="sxs-lookup"><span data-stu-id="15c59-647">Devices that are joined to Azure Active Directory (Azure AD) use existing Azure AD credentials to print securely.</span></span> <span data-ttu-id="15c59-648">管理员通过 Azure 门户管理打印，并可借助对通用打印的本机支持轻松连接打印机。</span><span class="sxs-lookup"><span data-stu-id="15c59-648">Administrators manage printing by using the Azure portal, and can easily connect printers with native support for Universal Print.</span></span> <span data-ttu-id="15c59-649">可使用通用打印连接器软件在不简单的打印机上部署通用打印服务。</span><span class="sxs-lookup"><span data-stu-id="15c59-649">Universal Print can be deployed with non-compatible printers by using Universal Print connector software.</span></span>

<span data-ttu-id="15c59-650">在通用打印发布时，Windows E3、A3、E5 和 A5 以及 Microsoft 365 BP、F3、E3、A3、E5 和 A5 上将恢复该项服务。</span><span class="sxs-lookup"><span data-stu-id="15c59-650">Universal Print will be backfilled at launch to Windows E3, A3, E5, and A5, and Microsoft 365 BP, F3, E3, A3, E5, and A5.</span></span>  

<span data-ttu-id="15c59-651">**产品/服务详细信息**</span><span class="sxs-lookup"><span data-stu-id="15c59-651">**Offer details**</span></span>

<span data-ttu-id="15c59-652">请注意，产品/服务名称与价目表预览中的略有不同。</span><span class="sxs-lookup"><span data-stu-id="15c59-652">Note that the offer name differs slightly from the price list preview.</span></span>

| <span data-ttu-id="15c59-653">产品名称</span><span class="sxs-lookup"><span data-stu-id="15c59-653">Offer name</span></span> | <span data-ttu-id="15c59-654">产品/服务 ID</span><span class="sxs-lookup"><span data-stu-id="15c59-654">Offer ID</span></span> | <span data-ttu-id="15c59-655">材料 ID</span><span class="sxs-lookup"><span data-stu-id="15c59-655">Material ID</span></span> |
| ------ |----------- |----------- |  
| <span data-ttu-id="15c59-656">通用打印卷加载项（500 个作业）- Microsoft 365</span><span class="sxs-lookup"><span data-stu-id="15c59-656">Universal Print volume add-on (500 jobs) - Microsoft 365</span></span>  | <span data-ttu-id="15c59-657">cb131356-45ee-4ae2-8537-873b706c8e75</span><span class="sxs-lookup"><span data-stu-id="15c59-657">cb131356-45ee-4ae2-8537-873b706c8e75</span></span>     | <span data-ttu-id="15c59-658">9BI-00004</span><span class="sxs-lookup"><span data-stu-id="15c59-658">9BI-00004</span></span>   |
| <span data-ttu-id="15c59-659">通用打印卷加载项（500 个作业）教职员工版 - Microsoft 365</span><span class="sxs-lookup"><span data-stu-id="15c59-659">Universal Print volume add-on (500 jobs) for faculty - Microsoft 365</span></span>   | <span data-ttu-id="15c59-660">477bee81-9872-43d6-91d3-c72390bfcf49</span><span class="sxs-lookup"><span data-stu-id="15c59-660">477bee81-9872-43d6-91d3-c72390bfcf49</span></span>   | <span data-ttu-id="15c59-661">9BK-00004</span><span class="sxs-lookup"><span data-stu-id="15c59-661">9BK-00004</span></span>   |
| <span data-ttu-id="15c59-662">通用打印卷加载项（500 个作业）- Windows</span><span class="sxs-lookup"><span data-stu-id="15c59-662">Universal Print volume add-on (500 jobs) - Windows</span></span>    | <span data-ttu-id="15c59-663">d3ddc493-5741-4e0d-a02d-07edbb0bb72e</span><span class="sxs-lookup"><span data-stu-id="15c59-663">d3ddc493-5741-4e0d-a02d-07edbb0bb72e</span></span>   | <span data-ttu-id="15c59-664">9BI-00002</span><span class="sxs-lookup"><span data-stu-id="15c59-664">9BI-00002</span></span>   |
| <span data-ttu-id="15c59-665">通用打印卷加载项（500 个作业）教职员工版 - Windows</span><span class="sxs-lookup"><span data-stu-id="15c59-665">Universal Print volume add-on (500 jobs) for faculty - Windows</span></span>   |  <span data-ttu-id="15c59-666">d0862f05-80f5-4fd4-8432-fe72dd893cc7</span><span class="sxs-lookup"><span data-stu-id="15c59-666">d0862f05-80f5-4fd4-8432-fe72dd893cc7</span></span>  | <span data-ttu-id="15c59-667">9BK-00002</span><span class="sxs-lookup"><span data-stu-id="15c59-667">9BK-00002</span></span>   |

### <a name="next-steps"></a><span data-ttu-id="15c59-668">后续步骤</span><span class="sxs-lookup"><span data-stu-id="15c59-668">Next steps</span></span>

<span data-ttu-id="15c59-669">熟悉价目表和[通用打印概述](/universal-print/fundamentals/universal-print-whatis)。</span><span class="sxs-lookup"><span data-stu-id="15c59-669">Familiarize yourself with the price list and the [Universal Print overview](/universal-print/fundamentals/universal-print-whatis).</span></span> <span data-ttu-id="15c59-670">请与贵组织中的相应联系人共享这些信息。</span><span class="sxs-lookup"><span data-stu-id="15c59-670">Share this information with all appropriate contacts in your organization.</span></span>

### <a name="questions"></a><span data-ttu-id="15c59-671">有疑问？</span><span class="sxs-lookup"><span data-stu-id="15c59-671">Questions?</span></span>

<span data-ttu-id="15c59-672">如果对这些产品/服务有任何疑问，请查看相关的 Yammer 社区。</span><span class="sxs-lookup"><span data-stu-id="15c59-672">For any questions about these offers, check your relevant Yammer communities.</span></span>