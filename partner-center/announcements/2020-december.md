...
- <span data-ttu-id="6e8d9-108">日期:2020-12-22</span><span class="sxs-lookup"><span data-stu-id="6e8d9-108">Date: 2020-12-22</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="6e8d9-122">后续步骤</span><span class="sxs-lookup"><span data-stu-id="6e8d9-122">Next steps</span></span>
...
### <a name="impacted-audience"></a><span data-ttu-id="6e8d9-135">影响受众</span><span class="sxs-lookup"><span data-stu-id="6e8d9-135">Impacted audience</span></span>
...
<span data-ttu-id="6e8d9-166">请注意，所有其他价目表文件都将按常规计划发布，只有上述两个可交付文件将略有延迟。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-166">Realize that all other price list files are on scheduled to be available on the usual schedule, simply the above two deliverables will be slightly delayed.</span></span>
...
- <span data-ttu-id="6e8d9-182">日期:2020-12-21</span><span class="sxs-lookup"><span data-stu-id="6e8d9-182">Date: 2020-12-21</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="6e8d9-196">后续步骤</span><span class="sxs-lookup"><span data-stu-id="6e8d9-196">Next steps</span></span>
...
### <a name="details"></a><span data-ttu-id="6e8d9-208">详细信息</span><span class="sxs-lookup"><span data-stu-id="6e8d9-208">Details</span></span>
...
<span data-ttu-id="6e8d9-220">CSP 商直接计费合作伙伴和间接提供商，他们在下一节中列出的国家/地区具有新客户或现有客户</span><span class="sxs-lookup"><span data-stu-id="6e8d9-220">CSP direct bill partners and indirect providers who have new or existing customers in the countries listed in the next section</span></span>
...
<span data-ttu-id="6e8d9-240">满足条件的合作伙伴必须在其下一次更新或为客户创建订阅时提交该客户的公司注册 ID（也称为客户的组织 INN）和电话号码。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-240">Partners who meet the criteria will have to submit a customer's company registration ID (also known as the customer's organization INN) and phone number when they next update or create a subscription for that customer.</span></span> <span data-ttu-id="6e8d9-241">这些合作伙伴还可以为客户输入可选的中间名。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-241">These partners can also enter an optional middle name for the customer.</span></span>
...
### <a name="questions"></a><span data-ttu-id="6e8d9-262">是否有任何问题?</span><span class="sxs-lookup"><span data-stu-id="6e8d9-262">Questions?</span></span>
...
### <a name="perpetual-software-in-csp"></a><span data-ttu-id="6e8d9-294">CSP 中的永久性软件</span><span class="sxs-lookup"><span data-stu-id="6e8d9-294">Perpetual software in CSP</span></span>
...
### <a name="questions"></a><span data-ttu-id="6e8d9-307">是否有任何问题?</span><span class="sxs-lookup"><span data-stu-id="6e8d9-307">Questions?</span></span>
...
<span data-ttu-id="6e8d9-335">**产品/服务详细信息**</span><span class="sxs-lookup"><span data-stu-id="6e8d9-335">**Offer details**</span></span>
...
<span data-ttu-id="6e8d9-354">此优惠的产品/服务详细信息将在 2021 年 1 月产品/服务列表矩阵中公布。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-354">The offer details below for this offer will be in the January 2021 offer list matrix.</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="6e8d9-362">后续步骤</span><span class="sxs-lookup"><span data-stu-id="6e8d9-362">Next Steps</span></span>
...
<span data-ttu-id="6e8d9-374">**SelfServePolicies - 添加了新增功能**</span><span class="sxs-lookup"><span data-stu-id="6e8d9-374">**SelfServePolicies - new functionality added**</span></span>
...
- <span data-ttu-id="6e8d9-389">日期:2020-12-8</span><span class="sxs-lookup"><span data-stu-id="6e8d9-389">Date: 2020-12-8</span></span>
...
<span data-ttu-id="6e8d9-399">12 月基于许可证的价目表中包含以下不应出现在价目表中的产品/服务。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-399">The December license-based price lists contain the below offers that should not be in the price lists.</span></span> <span data-ttu-id="6e8d9-400">这些产品/服务在之前错误地包含在价目表中，实际并未发布。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-400">These offers were previously included in the price lists in error and should not have been published.</span></span> <span data-ttu-id="6e8d9-401">关于何时提供这些产品/服务尚无明确的日程。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-401">There is no schedule as to when these offers may be available.</span></span> <span data-ttu-id="6e8d9-402">将来如果在预览价目表中重新添加，它们将列为 ADD。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-402">In the future, if they are added back they will be listed as ADDs in future preview price lists.</span></span>

   |<span data-ttu-id="6e8d9-403">**产品/服务名称**</span><span class="sxs-lookup"><span data-stu-id="6e8d9-403">**Offer name**</span></span>|<span data-ttu-id="6e8d9-404">**产品/服务 ID**</span><span class="sxs-lookup"><span data-stu-id="6e8d9-404">**Offer ID**</span></span>|
   |-------------------|:------|
   |<span data-ttu-id="6e8d9-405">Dynamics 365 Human Resources（非营利组织版定价）</span><span class="sxs-lookup"><span data-stu-id="6e8d9-405">Dynamics 365 Human Resources (Nonprofits Pricing)</span></span>|<span data-ttu-id="6e8d9-406">1596fa61-7da1-4263-98f8-b27dfa4cfbb5</span><span class="sxs-lookup"><span data-stu-id="6e8d9-406">1596fa61-7da1-4263-98f8-b27dfa4cfbb5</span></span>|
   |<span data-ttu-id="6e8d9-407">Dynamics 365 Human Resources 附加到符合条件的 Dynamics 365 基础产品/服务（非营利组织版定价）</span><span class="sxs-lookup"><span data-stu-id="6e8d9-407">Dynamics 365 Human Resources Attach to Qualifying Dynamics 365 Base Offer (Nonprofits Pricing)</span></span>|<span data-ttu-id="6e8d9-408">8bf0b826-e05b-45aa-9cd1-9a9f742f7731</span><span class="sxs-lookup"><span data-stu-id="6e8d9-408">8bf0b826-e05b-45aa-9cd1-9a9f742f7731</span></span>|
   |<span data-ttu-id="6e8d9-409">Dynamics 365 Human Resources 附加到符合条件的 Dynamics 365 基础产品/服务（非营利组织版定价）（符合条件的产品/服务）</span><span class="sxs-lookup"><span data-stu-id="6e8d9-409">Dynamics 365 Human Resources Attach to Qualifying Dynamics 365 Base Offer (Nonprofits Pricing) (Qualified Offer)</span></span>|<span data-ttu-id="6e8d9-410">f906435d-9dc9-42ba-bea6-2a2b08ca60db</span><span class="sxs-lookup"><span data-stu-id="6e8d9-410">f906435d-9dc9-42ba-bea6-2a2b08ca60db</span></span>|
   |<span data-ttu-id="6e8d9-411">Dynamics 365 Human Resources 沙盒（非营利组织版定价）</span><span class="sxs-lookup"><span data-stu-id="6e8d9-411">Dynamics 365 Human Resources Sandbox (Nonprofits Pricing)</span></span>|<span data-ttu-id="6e8d9-412">079ec5ba-d726-4384-95af-62d135c210d2</span><span class="sxs-lookup"><span data-stu-id="6e8d9-412">079ec5ba-d726-4384-95af-62d135c210d2</span></span>|
   |<span data-ttu-id="6e8d9-413">Dynamics 365 Human Resources 自助服务（非营利组织版定价）</span><span class="sxs-lookup"><span data-stu-id="6e8d9-413">Dynamics 365 Human Resources Self-Service (Nonprofits Pricing)</span></span>|<span data-ttu-id="6e8d9-414">931acecc-34c3-4f83-913e-c7fdbfd7e2a1</span><span class="sxs-lookup"><span data-stu-id="6e8d9-414">931acecc-34c3-4f83-913e-c7fdbfd7e2a1</span></span>|
   |<span data-ttu-id="6e8d9-415">Dynamics 365 Operations - 订单行（非营利组织版定价）</span><span class="sxs-lookup"><span data-stu-id="6e8d9-415">Dynamics 365 Operations – Order Lines (Nonprofits Pricing)</span></span>|<span data-ttu-id="6e8d9-416">7dd6b78a-3d53-47f8-8a64-bd84609a9a70</span><span class="sxs-lookup"><span data-stu-id="6e8d9-416">7dd6b78a-3d53-47f8-8a64-bd84609a9a70</span></span>|
   
#### <a name="incorrect-offers-in-the-offer-list-matrix"></a><span data-ttu-id="6e8d9-417">产品/服务列表矩阵中的产品/服务不正确</span><span class="sxs-lookup"><span data-stu-id="6e8d9-417">Incorrect offers in the offer list matrix</span></span>
   
<span data-ttu-id="6e8d9-418">以下产品/服务错误地包含在了产品/服务列表矩阵中。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-418">Below offers were in the offer list matrix in error.</span></span> <span data-ttu-id="6e8d9-419">这些产品/服务不可用，并且尚无明确的可用日期。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-419">They are not available, there is not target date yet for availability.</span></span> <span data-ttu-id="6e8d9-420">合作伙伴应忽略这些明细项目。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-420">Partners should ignore these line items.</span></span>

   |<span data-ttu-id="6e8d9-421">**产品/服务名称**</span><span class="sxs-lookup"><span data-stu-id="6e8d9-421">**Offer name**</span></span>|<span data-ttu-id="6e8d9-422">**产品/服务 ID**</span><span class="sxs-lookup"><span data-stu-id="6e8d9-422">**Offer ID**</span></span>|
   |-------------------|:------|
   |<span data-ttu-id="6e8d9-423">Dynamics 365 Operations - 数据库容量（非营利组织版定价）</span><span class="sxs-lookup"><span data-stu-id="6e8d9-423">Dynamics 365 Operations - Database Capacity (Nonprofits Pricing)</span></span>|<span data-ttu-id="6e8d9-424">1d3f4d81-89b9-419e-a880-31b2c50b8d66</span><span class="sxs-lookup"><span data-stu-id="6e8d9-424">1d3f4d81-89b9-419e-a880-31b2c50b8d66</span></span>|
   |<span data-ttu-id="6e8d9-425">Dynamics 365 Operations - 文件容量（非营利组织版定价）</span><span class="sxs-lookup"><span data-stu-id="6e8d9-425">Dynamics 365 Operations - File Capacity (Nonprofits Pricing)</span></span>|<span data-ttu-id="6e8d9-426">dc173a86-285b-444c-881e-3ece531f67da</span><span class="sxs-lookup"><span data-stu-id="6e8d9-426">dc173a86-285b-444c-881e-3ece531f67da</span></span>|

#### <a name="powerapps-offer"></a><span data-ttu-id="6e8d9-427">PowerApps 产品/服务</span><span class="sxs-lookup"><span data-stu-id="6e8d9-427">Powerapps offer</span></span>

<span data-ttu-id="6e8d9-428">此产品/服务包含在产品/服务列表矩阵中，但未包含在 12 月价目表中。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-428">This offer was included in the offer list matrix but not the December price list.</span></span> <span data-ttu-id="6e8d9-429">此产品/服务可用，你可在上月（11 月）的价目表文件中找到其定价。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-429">The offer is available and pricing can be found in the previous month's price list November file.</span></span> <span data-ttu-id="6e8d9-430">此产品/服务会重新添加到 1 月价目表中。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-430">This offer should be added back to the January price list.</span></span>

   |<span data-ttu-id="6e8d9-431">**产品/服务名称**</span><span class="sxs-lookup"><span data-stu-id="6e8d9-431">**Offer name**</span></span>|<span data-ttu-id="6e8d9-432">**产品/服务 ID**</span><span class="sxs-lookup"><span data-stu-id="6e8d9-432">**Offer ID**</span></span>|
   |-------------------|:------|
   |<span data-ttu-id="6e8d9-433">每个应用计划的 Power Apps</span><span class="sxs-lookup"><span data-stu-id="6e8d9-433">Power Apps per app plan</span></span>|<span data-ttu-id="6e8d9-434">5e1087b6-246b-4503-b88a-b60bdf0b3840</span><span class="sxs-lookup"><span data-stu-id="6e8d9-434">5e1087b6-246b-4503-b88a-b60bdf0b3840</span></span>|

### <a name="next-steps"></a><span data-ttu-id="6e8d9-435">后续步骤</span><span class="sxs-lookup"><span data-stu-id="6e8d9-435">Next steps</span></span>

<span data-ttu-id="6e8d9-436">请经常查看发行说明，它们会揭示其他未发现的问题，并且也会附加到本公告中。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-436">Check release notes often as other issues are uncovered they will be appended to this announcement.</span></span>

### <a name="last-updated"></a><span data-ttu-id="6e8d9-437">上次更新时间</span><span class="sxs-lookup"><span data-stu-id="6e8d9-437">Last updated</span></span>

<span data-ttu-id="6e8d9-438">2020 年 12 月 8 日</span><span class="sxs-lookup"><span data-stu-id="6e8d9-438">December 8, 2020</span></span>

______________

## <a name="an-update-of-the-us-microsoft-365-business-voice-with-calling-plan-offer-is-coming-soon"></a><span data-ttu-id="6e8d9-439"><a name="2">即将推出含通话套餐的美国 Microsoft 365 商务语音产品/服务的更新</a></span><span class="sxs-lookup"><span data-stu-id="6e8d9-439"><a name="2"></a>An update of the US Microsoft 365 Business Voice with Calling Plan offer is coming soon</span></span>

### <a name="categories"></a><span data-ttu-id="6e8d9-440">类别</span><span class="sxs-lookup"><span data-stu-id="6e8d9-440">Categories</span></span>

- <span data-ttu-id="6e8d9-441">日期:2020-12-3</span><span class="sxs-lookup"><span data-stu-id="6e8d9-441">Date: 2020-12-3</span></span>
- <span data-ttu-id="6e8d9-442">产品/市场</span><span class="sxs-lookup"><span data-stu-id="6e8d9-442">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="6e8d9-443">摘要</span><span class="sxs-lookup"><span data-stu-id="6e8d9-443">Summary</span></span> 

<span data-ttu-id="6e8d9-444">从 2021 年 1 月 1 日起，Microsoft 会开始逐步将美国合作伙伴和客户过渡到含通话套餐的新 Microsoft 365 商业语音产品/服务。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-444">On January 1, 2021, Microsoft will begin transitioning US partners and customers to a new Microsoft 365 Business Voice with Calling Plan offer.</span></span> <span data-ttu-id="6e8d9-445">合作伙伴不需要执行任何操作。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-445">No partner action is required.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="6e8d9-446">影响受众</span><span class="sxs-lookup"><span data-stu-id="6e8d9-446">Impacted Audience</span></span> 

<span data-ttu-id="6e8d9-447">参与云解决方案提供商 (CSP) 计划的所有合作伙伴</span><span class="sxs-lookup"><span data-stu-id="6e8d9-447">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="details"></a><span data-ttu-id="6e8d9-448">详细信息</span><span class="sxs-lookup"><span data-stu-id="6e8d9-448">Details</span></span>

<span data-ttu-id="6e8d9-449">Microsoft 会将美国现有的含通话套餐的商务语音产品/服务替换为新产品/服务，以支持电信产品的内部要求。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-449">Microsoft will replace the existing Business Voice with Calling plan offer in the US with a new offer to support internal requirements for telco products.</span></span> <span data-ttu-id="6e8d9-450">新产品/服务的功能集和定价不变。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-450">The new offer will have the same feature set and pricing.</span></span> <span data-ttu-id="6e8d9-451">产品/服务更改在 Microsoft 内部进行，不会影响 CSP 合作伙伴对含通话套餐的商务语音产品/服务的营销、销售或支持。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-451">The offer changes are internal to Microsoft and should not affect the way that CSP partners market, sell, or support the Business Voice with Calling Plan offer.</span></span> <span data-ttu-id="6e8d9-452">此更改仅适用于此产品/服务。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-452">The change will only apply to this offer.</span></span>

<span data-ttu-id="6e8d9-453">从 2021 年 1 月 1 日起，你将开始销售新产品/服务。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-453">For new sales, you will use the new offer starting on January 1, 2021.</span></span> <span data-ttu-id="6e8d9-454">价目表上的旧产品/服务也将替换为新产品/服务。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-454">The old offer will be replaced by the new offer on the price list.</span></span>

<span data-ttu-id="6e8d9-455">现有客户将在续期日期后自动过渡到新产品/服务。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-455">Existing customers will be automatically transitioned to the new offer upon their renewal date.</span></span> <span data-ttu-id="6e8d9-456">合作伙伴不需要执行任何操作，客户也不需要续期。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-456">No action is required from partners and renewing customers.</span></span>


<span data-ttu-id="6e8d9-457">\*\*新产品/服务详细信息</span><span class="sxs-lookup"><span data-stu-id="6e8d9-457">\*\*New offer details</span></span>
 
   |<span data-ttu-id="6e8d9-458">**产品/服务名称**</span><span class="sxs-lookup"><span data-stu-id="6e8d9-458">**Offer name**</span></span>|<span data-ttu-id="6e8d9-459">**产品/服务 ID**</span><span class="sxs-lookup"><span data-stu-id="6e8d9-459">**Offer ID**</span></span>|<span data-ttu-id="6e8d9-460">**材料 ID**</span><span class="sxs-lookup"><span data-stu-id="6e8d9-460">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="6e8d9-461">Microsoft 365 商务语音（美国）</span><span class="sxs-lookup"><span data-stu-id="6e8d9-461">Microsoft 365 Business Voice (US)</span></span>|<span data-ttu-id="6e8d9-462">86713ec1-ad33-42cf-a1ce-8397d4d875fe</span><span class="sxs-lookup"><span data-stu-id="6e8d9-462">86713ec1-ad33-42cf-a1ce-8397d4d875fe</span></span>|<span data-ttu-id="6e8d9-463">PZW-00023</span><span class="sxs-lookup"><span data-stu-id="6e8d9-463">PZW-00023</span></span>|
   
<span data-ttu-id="6e8d9-464">\*\*旧产品/服务详细信息</span><span class="sxs-lookup"><span data-stu-id="6e8d9-464">\*\*Old offer details</span></span>

   |<span data-ttu-id="6e8d9-465">**产品/服务名称**</span><span class="sxs-lookup"><span data-stu-id="6e8d9-465">**Offer name**</span></span>|<span data-ttu-id="6e8d9-466">**产品/服务 ID**</span><span class="sxs-lookup"><span data-stu-id="6e8d9-466">**Offer ID**</span></span>|<span data-ttu-id="6e8d9-467">**材料 ID**</span><span class="sxs-lookup"><span data-stu-id="6e8d9-467">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="6e8d9-468">Microsoft 365 商务语音（美国）</span><span class="sxs-lookup"><span data-stu-id="6e8d9-468">Microsoft 365 Business Voice (US)</span></span>|<span data-ttu-id="6e8d9-469">9f9f2c7b-c961-402b-9421-8e3c9207eeb3</span><span class="sxs-lookup"><span data-stu-id="6e8d9-469">9f9f2c7b-c961-402b-9421-8e3c9207eeb3</span></span>|<span data-ttu-id="6e8d9-470">PZW-00009</span><span class="sxs-lookup"><span data-stu-id="6e8d9-470">PZW-00009</span></span>|

### <a name="next-steps"></a><span data-ttu-id="6e8d9-471">后续步骤</span><span class="sxs-lookup"><span data-stu-id="6e8d9-471">Next steps</span></span>

<span data-ttu-id="6e8d9-472">请熟悉价目表，并与组织内部所有合适的联系人共享此信息。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-472">Familiarize yourself with the price list and share this information with all appropriate contacts in your organization.</span></span>

______________

## <a name="now-live-partner-center-api-updates-and-user-interface-enhancements-for-the-education-customer-validation-process"></a><a name="1"></a><span data-ttu-id="6e8d9-473">现已上线：面向教育客户验证流程的合作伙伴中心 API 更新和用户界面改进功能</span><span class="sxs-lookup"><span data-stu-id="6e8d9-473">Now live: Partner Center API updates and user interface enhancements for the Education customer validation process</span></span>

### <a name="categories"></a><span data-ttu-id="6e8d9-474">类别</span><span class="sxs-lookup"><span data-stu-id="6e8d9-474">Categories</span></span>

- <span data-ttu-id="6e8d9-475">日期:2020-12-3</span><span class="sxs-lookup"><span data-stu-id="6e8d9-475">Date: 2020-12-3</span></span>
- <span data-ttu-id="6e8d9-476">功能</span><span class="sxs-lookup"><span data-stu-id="6e8d9-476">Capabilities</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="6e8d9-477">影响受众</span><span class="sxs-lookup"><span data-stu-id="6e8d9-477">Impacted Audience</span></span> 

<span data-ttu-id="6e8d9-478">通过云解决方案提供商 (CSP) 计划销售学术产品/服务的合作伙伴</span><span class="sxs-lookup"><span data-stu-id="6e8d9-478">Partners selling Academic offers through the Cloud Solution Provider program</span></span>

### <a name="summary"></a><span data-ttu-id="6e8d9-479">摘要</span><span class="sxs-lookup"><span data-stu-id="6e8d9-479">Summary</span></span> 

<span data-ttu-id="6e8d9-480">Microsoft 值得信赖。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-480">Microsoft runs on trust.</span></span> <span data-ttu-id="6e8d9-481">我们致力于在云解决方案提供商计划中为交易学术产品/服务提供合规、安全且可靠的客户验证方法。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-481">We are committed to providing a compliant, safe, and secure method of customer validation for transacting Academic offers in the Cloud Solution Provider program.</span></span> <span data-ttu-id="6e8d9-482">作为此承诺的一部分，我们将推出合作伙伴中心 API 和用户界面改进功能，这将增加客户审核流程的透明度和可见性，确保能够输入更准确的数据，从而提高客户审查的成功率。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-482">As part of this commitment, we are introducing Partner Center API and user interface enhancements that will add clarity and visibility into the customer vetting process as well as the ability to input more accurate data, which will drive improved customer vetting success.</span></span> 

<span data-ttu-id="6e8d9-483">**合作伙伴中心增强功能**</span><span class="sxs-lookup"><span data-stu-id="6e8d9-483">**Partner Center enhancements**</span></span> 

- <span data-ttu-id="6e8d9-484">新的 GET 和 POST 资格 API，可支持准确的数据输入并改进 Microsoft 的教育客户验证流程。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-484">New GET and POST Qualifications APIs to support accurate data entry and improve the Education customer validation process by Microsoft.</span></span> 

- <span data-ttu-id="6e8d9-485">用户界面增强功能，可支持准确的数据输入并改进 Microsoft 的教育客户验证流程。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-485">User interface enhancements to support accurate data entry and improve the Education customer validation process by Microsoft.</span></span> 

<span data-ttu-id="6e8d9-486">**弃用现有的 GET 和 PUT 资格 API**</span><span class="sxs-lookup"><span data-stu-id="6e8d9-486">**Deprecation of existing GET and PUT Qualification APIs**</span></span> 

<span data-ttu-id="6e8d9-487">现有的 GET 和 PUT 资格 API 将在 2021 年 2 月结束之前停用。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-487">The existing GET and PUT Qualification APIs will retire **before the end of February 2021**.</span></span> <span data-ttu-id="6e8d9-488">届时，你将需要过渡到新的 GET 和 POST 合作伙伴中心 API，才能购买教育产品/服务。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-488">At that time, you will need to have transitioned to the new GET and POST Partner Center APIs in order to be able to purchase Education offers.</span></span>  

<span data-ttu-id="6e8d9-489">测试：</span><span class="sxs-lookup"><span data-stu-id="6e8d9-489">**Testing**</span></span> 

<span data-ttu-id="6e8d9-490">为了更好地了解成功进行客户验证所需的 API 和数据输入，合作伙伴可测试这些增强功能。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-490">To gain a better understanding of the APIs and data entry required for successful customer validation, partners can test these enhancements.</span></span> <span data-ttu-id="6e8d9-491">要参加测试的合作伙伴应下载[合作伙伴中心教育客户测试指南](https://partner.microsoft.com/resources/detail/partner-center-edu-testing-guide-pdf)，了解如何做好准备、如何注册以及测试阶段应执行哪些操作。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-491">Partners who want to participate in the testing should download the [Partner Center Education customer testing guide](https://partner.microsoft.com/resources/detail/partner-center-edu-testing-guide-pdf) for directions on how to prepare, sign up, and for information on what to expect during the testing phase.</span></span>

<span data-ttu-id="6e8d9-492">**图书馆和博物馆客户**</span><span class="sxs-lookup"><span data-stu-id="6e8d9-492">**Library and Museum customers**</span></span> 

<span data-ttu-id="6e8d9-493">除了上述增强功能，我们还很高兴地宣布，我们将为图书馆和博物馆客户启用学术定价产品/服务，以扩大可与之交易 CSP 产品/服务的教育客户群。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-493">In addition to the above enhancements, we are excited to announce that we will enable Academic-priced offers for Library and Museum customers, expanding the Education customers with whom you can transact CSP offers.</span></span> 

<span data-ttu-id="6e8d9-494">Microsoft 保留审查任何客户或推荐客户是否属于合格教育用户的权利。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-494">Microsoft reserves the right to review the status of any customer or proposed customer as a qualified educational user.</span></span> <span data-ttu-id="6e8d9-495">有关完整详细信息，请参阅[学术合格教育用户要求](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7)。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-495">See the [Academic Qualified Education User Requirements](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7) for full details.</span></span> 

### <a name="next-stepsadditional-resources"></a><span data-ttu-id="6e8d9-496">后续步骤/其他资源</span><span class="sxs-lookup"><span data-stu-id="6e8d9-496">Next steps/additional resources</span></span>

- <span data-ttu-id="6e8d9-497">在操作就绪资源中查看新的合作伙伴中心用户界面和 API 更改：[合作伙伴中心教育客户验证流程增强功能](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/)</span><span class="sxs-lookup"><span data-stu-id="6e8d9-497">Review the new Partner Center User Interface, API changes, and Guide in the Operations Readiness resources:  [Partner Center Education customer validation](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/) process enhancements</span></span> 

- <span data-ttu-id="6e8d9-498">确保组织熟悉[学术合格教育用户要求](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7)。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-498">Ensure your organization is familiar with the [Academic Qualified Education User requirements](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7).</span></span> 

- <span data-ttu-id="6e8d9-499">请与组织内的相应团队和经销商共享此信息，以帮助他们为这些更改做好准备。</span><span class="sxs-lookup"><span data-stu-id="6e8d9-499">Share this information with the appropriate teams within your organization, and with your resellers, to help them prepare for these changes.</span></span> 

### <a name="change-log"></a><span data-ttu-id="6e8d9-500">更改日志</span><span class="sxs-lookup"><span data-stu-id="6e8d9-500">Change Log</span></span> 

<span data-ttu-id="6e8d9-501">2020 年 8 月 31 日：初始发布</span><span class="sxs-lookup"><span data-stu-id="6e8d9-501">_ August 31, 2020:  Original publication</span></span> 

- <span data-ttu-id="6e8d9-502">2020 年 9 月 25 日：添加了测试窗口更新</span><span class="sxs-lookup"><span data-stu-id="6e8d9-502">September 25, 2020:  Test window update added</span></span> 

- <span data-ttu-id="6e8d9-503">2020 年 10 月 4 日：提醒注册参加测试</span><span class="sxs-lookup"><span data-stu-id="6e8d9-503">October 4, 2020: Reminder to sign up for testing</span></span> 

- <span data-ttu-id="6e8d9-504">2020 年 11 月 10 日：提醒注册参加测试</span><span class="sxs-lookup"><span data-stu-id="6e8d9-504">November 10, 2020: Reminder to sign up for testing</span></span> 

- <span data-ttu-id="6e8d9-505">2020 年 12 月 3 日：API 更新上线</span><span class="sxs-lookup"><span data-stu-id="6e8d9-505">December 3, 2020: API updates live</span></span>