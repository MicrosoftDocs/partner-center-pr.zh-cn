...
本文讨论了 Microsoft 的付出的支出过程、付出的计划和 recoupment 政策，以及在何处查找付出的状态。

## <a name="where-to-find-upcoming-payouts"></a>在何处查找即将推出的付款

在 "合作伙伴中心" 中，选择屏幕右上角的 " **支出** " 图标：

:::image type="content" source="images/payouts/payout-overview.png" alt-text="说明合作伙伴中心门户右上方的支出图标。":::

> [!TIP]
> 并非所有帐户角色都有权访问付出的信息。 有关详细信息，请参阅 [角色和权限](payout-statement.md#roles-and-permissions)。
...
我们对我们的商业 marketplace 发布者付出的支出模型进行了以下更新：

从2020开始，我们正在更新付款策略，该策略与使用 Microsoft 企业协议的客户在 Microsoft AppSource 或 Azure Marketplace 中购买的产品相关。 如果客户从 Azure Marketplace 或 AppSource 使用其现有的 Microsoft 企业协议处理事务，则在5月 1 2020 日之后，我们将在下一次支出周期30天后发出付款。 客户使用信用卡的交易是不变的，并且在付出一定的额度之前，将继续有30天的保留期。 下表显示了有关付出计划的详细信息。

> [!NOTE]
> 如果客户未能支付费用，但我们已向你颁发了费用，请参阅下面的 [客户非支付过程](#process-for-customer-non-payment) 。

| 事件  | 日期 (UTC)  | 合作伙伴可见性：合作伙伴中心支出报表  |  合作伙伴可见性：合作伙伴中心分析\* |
| --- | --- | --- | --- |
| 事务或使用月份 | 8/1/2020 –8/31/2020 | 空值 | **使用情况报表**： (每隔四小时刷新一次显示的新消耗) <br>**订单报表**：暂缺 |
| 字词结束 (月)  | 2020/8/31 | 空值 | **使用情况报表**：显示的月结束消耗量<br>**订单报表**：暂缺 |
...
\* 可以在合作伙伴中心的 "分析" 部分访问 "使用情况" 和 "订单" 报表。</br>\** 支出日期为太平洋标准时间 (PST) 。
...
| 事件  | 日期 (UTC)  | 合作伙伴可见性：合作伙伴中心支出报表  |  合作伙伴可见性：合作伙伴中心分析\*  |
| --- | --- | --- | --- |
| 事务或使用月份 | 8/1/2019 - 8/31/2019 | 空值 | **使用情况报表**： (每隔四小时刷新一次显示的新消耗) <br>**订单报表**：暂缺 |
...
| 如果客户不向 Microsoft 付款 | 12/2/2020 –12/5/2020 | 无更改，如上所述 |
