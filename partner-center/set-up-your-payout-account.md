...
> [!NOTE]
> 有关如何以及何时支付产品/服务资金的详细信息，请参阅 [在商业市场中获得付款](marketplace-get-paid.md)。

## <a name="tax-forms"></a>纳税表单

在公司管理的"付款和税务"页中管理税务配置文件 **和税务** 合作伙伴中心。 组织的权限将确定你所看到的配置文件和信息。

### <a name="create-or-update-your-tax-profile"></a>创建或更新税务配置文件

首先，你需要创建一个税务配置文件并将其分配给你所参与的计划。 使用以下步骤在 合作伙伴中心 *创建或* 更新税务合作伙伴中心。 可以在仪表板中以电子方式完成并提交合作伙伴中心表单;在大多数情况下，无需打印和邮件任何表单。

> [!IMPORTANT]
> 不同的国家和地区具有不同的税务要求。 应付税款的确切金额取决于销售产品/服务所在的国家和地区。 请参阅 [Microsoft Azure 市场发布者协议](/legal/marketplace/msft-publisher-agreement)，以找出 Microsoft 代表你向哪个国家/地区缴纳销售和使用税。 在其他国家/地区中，根据你的注册位置，可能需要对销售的产品/服务缴纳销售和使用税，并直接支付给本地税收机构。 此外，你收到的应用销售收款还可以作为收入进行纳税。 我们强烈建议联系你所在国家或地区最能帮助你的相关机构，确定与自己的商业市场活动相关的正确税务信息。

1. 在 [合作伙伴中心"仪表板中](https://partner.microsoft.com/dashboard)，选择右上角的"设置"齿轮图标，然后选择"**帐户设置"。**
...
4. 选择现有的付款配置文件，或选择"创建新的付款配置文件"，为所选付款方式创建新配置文件。
...
3. 你的付款配置文件将与其状态一起列出。 找到要编辑的配置文件，然后选择 **最右边** 的"编辑"

> [!IMPORTANT]
> 更改付款帐户可能会推迟付款（最多一个付款周期）。 出现此推迟的原因是我们需要验证帐户更改，正如首次设置付款帐户时我们会进行验证。 帐户通过验证后，仍会收到全额款项；当前付款周期应得的任何付款将添加到下一个付款周期。 有关详细信息 [，请参阅在商业市场中](marketplace-get-paid.md)获取付款。
...
- [Microsoft Azure 市场发布者协议](/legal/marketplace/msft-publisher-agreement) - 需要副署的发行者协议的签名副本。
