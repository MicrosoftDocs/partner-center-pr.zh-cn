...
| 产品 | MPN： O365、DYNAMICS 365、企业移动性 + 安全性、Power BI 或 Microsoft Azure 销售给客户的产品 | 
| SKU | 产品 SKU | 
| 月份 | 报告使用情况和收入的月份 | 
...
| 月份 | 报告使用情况和收入的月份 | 
| IsAutoRenew | 指示订阅是 autorenew (是还是否)  | 
| CustomerName | 购买订阅的客户的名称 | 
...
### <a name="teams-monthly-usage-report"></a>**团队每月使用情况报表**
...
| AllUpParticipants | 每月的团队独特用户数 | 

### <a name="teams-usage-3p-apps-report"></a>**团队使用情况 w apps 报表**
...
| SurfaceFit | 定义 firmographics 的内部和外部数据点。 合适的评分使用 lookalike 模型来比较客户，并查看其是否适用于 Microsoft 云产品。 按季度更新适合评分。 | 
| SurfaceIntent | 与社交媒体和客户的联机行为相关的信号定义意向。 意向计分重叠在一起以定义分类。 意向评分每月更新一次。 | 
| O365Cluster | 标识客户电网购买 Office 365。 目标立即操作并评估群集，因为它们会产生更高的收益。 仅当 "立即行动" 和 "评估客户" 为目标时仍有容量时，才面向维护并为客户提供培训。 | 
| O365Fit | 定义 firmographics 的内部和外部数据点。 合适的评分使用 lookalike 模型来比较客户，并查看其是否适用于 Microsoft 云产品。 按季度更新适合评分。 | 
...
| 段 | 市场段 | 
| 子段 | 市场子细分市场 | 
| SMC 类型摘要 | 客户的分类：排名靠前的非托管用户群的客户是具有300多位员工的客户，而顶级非托管计算基础是在 Azure 三年中具有 USD10，000的客户，中型企业是拥有25名员工或更高版本的客户，小型企业是拥有少于25名员工的客户。 | 
| 顶级非托管计算基础 | 排名靠前的非托管客户-计算 | 
| 顶级非托管用户基 | 排名靠前的非托管客户-用户 | 
| IsNonProfit | 指示组织是否为非利润 (是还是否)  | 
| 激活数字销售-Microsoft 365-座位大小 >= 25 座位 (SalesPro 电网模型)  | 不含 Dynamics 365 的客户。 座位大小： 25 +。 合作伙伴应瞄准 Dynamics 365 SalesPro 的交叉销售目标。 | 
...
| 顶级非托管用户基 | 排名靠前的非托管客户-用户 | 
| IsNonProfit | 指示组织是否为非利润 (是还是否)  | 
| 迁移-EOL Windows Server-EOL Windows Server IB 与云上升电网 + 许可证 | 拥有 EOL 本地 Windows Server (的客户，即 EOL 版本或早期) 。 客户有5个或更多许可证。 具有电网分数的客户。 合作伙伴应面向此客户迁移到 Azure。 | 
| 迁移-EOL Windows Server-EOL Windows Server IB with Cloud 升高电网-<5 许可证 | 拥有 EOL 本地 Windows Server (的客户，即 EOL 版本或早期) 。 客户的许可证数少于5。 具有电网分数的客户。 合作伙伴应面向此客户迁移到 Azure。 | 
...
| 迁移-EOL SQL-EOL SQL Server IB 与云上升电网-<5 许可证 | 具有 EOL 本地 SQL Server 的客户 (即 EOL 版本或更早的) 。 具有少于5个许可证。 具有电网分数的客户。 合作伙伴应面向此客户迁移到 Azure。 | 
| 迁移-EOL SQL-EOL SQL Server IB，无需云上升电网 + 许可证 | 具有 EOL 本地 SQL Server 的客户 (即 EOL 版本或更早的) 。 客户有5个或更多许可证。 客户没有电网分数。 合作伙伴应面向此客户迁移到 Azure。 | 
| 迁移-EOL SQL-EOL SQL Server IB，无云上升电网-<5 许可证 | 具有 EOL 本地 SQL Server 的客户 (即 EOL 版本或更早的) 。 客户拥有少于5个许可证。 客户没有电网分数。 合作伙伴应面向此客户迁移到 Azure。 | 
| 迁移-迁移本地 Windows Server-最新的 Windows Server IB，具有云升高电网 + 许可证 | 具有当前本地 Windows Server (的客户（即，晚于 EOL) 的版本）。 客户有5个许可证。 客户具有电网分数。 合作伙伴应面向此客户迁移到 Azure。 | 
| 迁移-迁移本地 Windows Server-当前 Windows Server IB 与云升高电网-<5 许可证 | 具有当前本地 Windows Server (的客户（即，晚于 EOL) 的版本）。 客户拥有少于5个许可证。 客户具有适用于 Azure 的电网分数。 合作伙伴应面向此客户迁移到 Azure。 | 
...
| 迁移-迁移到 Azure SQL 或 SQL Vm-当前 SQL Server IB 与云上升电网-<5 许可证 | 当前本地 SQL Server 的客户 (即) 晚于 EOL 的版本。 客户拥有少于5个许可证。 客户具有电网分数。 合作伙伴应面向此客户迁移到 Azure。 | 
| 迁移-迁移到 Azure SQL 或 SQL Vm-当前 SQL Server IB，无需云上升电网 + 许可证 | 当前本地 SQL Server 的客户 (即) 晚于 EOL 的版本。 客户有5个许可证。 客户没有电网分数。 合作伙伴应面向此客户迁移到 Azure。 | 
| 迁移-迁移到 Azure SQL 或 SQL Vm-当前 SQL Server IB，无需云提升电网-<5 许可证 | 当前本地 SQL Server 的客户 (即) 晚于 EOL 的版本。 客户拥有少于5个许可证。 客户没有电网分数。 合作伙伴应面向此客户迁移到 Azure。 | 
| 迁移-OSS-迁移到开源莎士比亚 (OSS) DB | 具有以下任何竞争产品的现有客户： PostgreSQL、MySQL、MariaDB。 合作伙伴应面向此客户迁移到 Azure。 | 
| 迁移-OSS-Azure 上的 Linux | 具有 Linux 的现有客户。 合作伙伴应面向此客户迁移到 Azure。 | 
